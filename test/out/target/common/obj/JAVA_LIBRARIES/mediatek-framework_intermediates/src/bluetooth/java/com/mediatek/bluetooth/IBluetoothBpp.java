 ...
 * Original file: vendor/mediatek/proprietary/frameworks/base/bluetooth/java/com/mediatek/bluetooth/IBluetoothBpp.aidl
 */
package com.mediatek.bluetooth;
/** {@hide}
 */
public interface IBluetoothBpp extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.mediatek.bluetooth.IBluetoothBpp
{
private static final java.lang.String DESCRIPTOR = "com.mediatek.bluetooth.IBluetoothBpp";
...
/**
 * Cast an IBinder object into an com.mediatek.bluetooth.IBluetoothBpp interface,
 * generating a proxy if needed.
 */
public static com.mediatek.bluetooth.IBluetoothBpp asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.mediatek.bluetooth.IBluetoothBpp))) {
return ((com.mediatek.bluetooth.IBluetoothBpp)iin);
}
return new com.mediatek.bluetooth.IBluetoothBpp.Stub.Proxy(obj);
}
...
private static class Proxy implements com.mediatek.bluetooth.IBluetoothBpp
{
