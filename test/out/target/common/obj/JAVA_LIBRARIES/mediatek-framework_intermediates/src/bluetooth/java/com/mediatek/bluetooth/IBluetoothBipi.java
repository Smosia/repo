 ...
 * Original file: vendor/mediatek/proprietary/frameworks/base/bluetooth/java/com/mediatek/bluetooth/IBluetoothBipi.aidl
 */
package com.mediatek.bluetooth;
/** {@hide}
 */
public interface IBluetoothBipi extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.mediatek.bluetooth.IBluetoothBipi
{
private static final java.lang.String DESCRIPTOR = "com.mediatek.bluetooth.IBluetoothBipi";
...
/**
 * Cast an IBinder object into an com.mediatek.bluetooth.IBluetoothBipi interface,
 * generating a proxy if needed.
 */
public static com.mediatek.bluetooth.IBluetoothBipi asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.mediatek.bluetooth.IBluetoothBipi))) {
return ((com.mediatek.bluetooth.IBluetoothBipi)iin);
}
return new com.mediatek.bluetooth.IBluetoothBipi.Stub.Proxy(obj);
}
...
private static class Proxy implements com.mediatek.bluetooth.IBluetoothBipi
{
