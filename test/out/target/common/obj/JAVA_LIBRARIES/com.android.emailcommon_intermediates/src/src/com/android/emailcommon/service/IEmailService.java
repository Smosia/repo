...
case TRANSACTION_fetchMessage:
{
data.enforceInterface(DESCRIPTOR);
long _arg0;
_arg0 = data.readLong();
this.fetchMessage(_arg0);
return true;
}
case TRANSACTION_syncOof:
{
data.enforceInterface(DESCRIPTOR);
long _arg0;
_arg0 = data.readLong();
com.android.emailcommon.service.OofParams _arg1;
if ((0!=data.readInt())) {
_arg1 = com.android.emailcommon.service.OofParams.CREATOR.createFromParcel(data);
}
else {
_arg1 = null;
}
...
com.android.emailcommon.service.OofParams _result = this.syncOof(_arg0, _arg1, _arg2);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
@Override public void fetchMessage(long messageId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeLong(messageId);
mRemote.transact(Stub.TRANSACTION_fetchMessage, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
@Override public com.android.emailcommon.service.OofParams syncOof(long accountId, com.android.emailcommon.service.OofParams oofParams, boolean isGet) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.android.emailcommon.service.OofParams _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeLong(accountId);
if ((oofParams!=null)) {
_data.writeInt(1);
oofParams.writeToParcel(_data, 0);
}
else {
_data.writeInt(0);
}
_data.writeInt(((isGet)?(1):(0)));
mRemote.transact(Stub.TRANSACTION_syncOof, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.android.emailcommon.service.OofParams.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public void stopOof(long accountId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeLong(accountId);
mRemote.transact(Stub.TRANSACTION_stopOof, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_fetchMessage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_syncOof = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_stopOof = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
}
// Core email operations.
// Many of these functions return status codes. The valid status codes are defined in
// EmailServiceStatus.java
...
public void fetchMessage(long messageId) throws android.os.RemoteException;
//M: OOF feature add. @{

public com.android.emailcommon.service.OofParams syncOof(long accountId, com.android.emailcommon.service.OofParams oofParams, boolean isGet) throws android.os.RemoteException;
public void stopOof(long accountId) throws android.os.RemoteException;
}
