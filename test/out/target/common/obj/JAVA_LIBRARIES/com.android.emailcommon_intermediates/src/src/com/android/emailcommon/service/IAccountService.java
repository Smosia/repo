...
case TRANSACTION_notifySendingStarted:
{
...
int _arg1;
_arg1 = data.readInt();
this.notifySendingStarted(_arg0, _arg1);
return true;
}
case TRANSACTION_notifySendingFailed:
{
data.enforceInterface(DESCRIPTOR);
long _arg0;
_arg0 = data.readLong();
int _arg1;
_arg1 = data.readInt();
this.notifySendingFailed(_arg0, _arg1);
return true;
}
case TRANSACTION_notifySendingSucceeded:
{
data.enforceInterface(DESCRIPTOR);
long _arg0;
_arg0 = data.readLong();
int _arg1;
_arg1 = data.readInt();
this.notifySendingSucceeded(_arg0, _arg1);
return true;
}
...
@Override public void notifySendingStarted(long accountId, int messageCount) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeLong(accountId);
_data.writeInt(messageCount);
mRemote.transact(Stub.TRANSACTION_notifySendingStarted, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
}
@Override public void notifySendingFailed(long accountId, int messageCount) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeLong(accountId);
_data.writeInt(messageCount);
mRemote.transact(Stub.TRANSACTION_notifySendingFailed, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
}
@Override public void notifySendingSucceeded(long accountId, int messageCount) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeLong(accountId);
_data.writeInt(messageCount);
mRemote.transact(Stub.TRANSACTION_notifySendingSucceeded, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_notifySendingStarted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_notifySendingFailed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_notifySendingSucceeded = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
...
/** M: For Exchange sending notification @{ */
public void notifySendingStarted(long accountId, int messageCount) throws android.os.RemoteException;
public void notifySendingFailed(long accountId, int messageCount) throws android.os.RemoteException;
public void notifySendingSucceeded(long accountId, int messageCount) throws android.os.RemoteException;
/** @} */
