...
public  int read(char[] buffer) throws java.io.IOException { throw new RuntimeException("Stub!"); }
public abstract  int read(char[] buffer, int offset, int count) throws java.io.IOException;
