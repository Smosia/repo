...
public  java.lang.String getDefaultBrowserPackageName(int userId) { throw new RuntimeException("Stub!"); }
public  boolean setDefaultBrowserPackageName(java.lang.String packageName, int userId) { throw new RuntimeException("Stub!"); }
