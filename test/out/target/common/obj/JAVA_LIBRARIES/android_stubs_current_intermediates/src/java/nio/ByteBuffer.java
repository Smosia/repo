...
public static  java.nio.ByteBuffer wrap(byte[] array, int start, int byteCount) { throw new RuntimeException("Stub!"); }
...
public  java.nio.ByteBuffer get(byte[] dst, int dstOffset, int byteCount) { throw new RuntimeException("Stub!"); }
...
public  java.nio.ByteBuffer put(byte[] src, int srcOffset, int byteCount) { throw new RuntimeException("Stub!"); }
