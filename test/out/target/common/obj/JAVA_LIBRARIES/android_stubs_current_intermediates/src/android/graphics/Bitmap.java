...
public static  android.graphics.Bitmap createBitmap(android.util.DisplayMetrics display, int width, int height, android.graphics.Bitmap.Config config) { throw new RuntimeException("Stub!"); }
...
public static  android.graphics.Bitmap createBitmap(android.util.DisplayMetrics display, int[] colors, int offset, int stride, int width, int height, android.graphics.Bitmap.Config config) { throw new RuntimeException("Stub!"); }
...
public static  android.graphics.Bitmap createBitmap(android.util.DisplayMetrics display, int[] colors, int width, int height, android.graphics.Bitmap.Config config) { throw new RuntimeException("Stub!"); }
...
public final  boolean isPremultiplied() { throw new RuntimeException("Stub!"); }
public final  void setPremultiplied(boolean premultiplied) { throw new RuntimeException("Stub!"); }
...
public final  int getAllocationByteCount() { throw new RuntimeException("Stub!"); }
...
public final  boolean hasMipMap() { throw new RuntimeException("Stub!"); }
public final  void setHasMipMap(boolean hasMipMap) { throw new RuntimeException("Stub!"); }
