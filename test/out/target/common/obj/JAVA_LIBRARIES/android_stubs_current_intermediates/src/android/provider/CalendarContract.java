...
{
CalendarEntity() { throw new RuntimeException("Stub!"); }
...
public static final class Calendars
  implements android.provider.BaseColumns, android.provider.CalendarContract.SyncColumns, android.provider.CalendarContract.CalendarColumns
{
Calendars() { throw new RuntimeException("Stub!"); }
...
{
Attendees() { throw new RuntimeException("Stub!"); }
public static final  android.database.Cursor query(android.content.ContentResolver cr, long eventId, java.lang.String[] projection) { throw new RuntimeException("Stub!"); }
@java.lang.SuppressWarnings(value={"hiding"})
public static final android.net.Uri CONTENT_URI;
static { CONTENT_URI = null; }
}
...
{
EventsEntity() { throw new RuntimeException("Stub!"); }
...
{
Events() { throw new RuntimeException("Stub!"); }
public static final android.net.Uri CONTENT_EXCEPTION_URI;
@java.lang.SuppressWarnings(value={"hiding"})
public static final android.net.Uri CONTENT_URI;
static { CONTENT_EXCEPTION_URI = null; CONTENT_URI = null; }
}
...
{
Instances() { throw new RuntimeException("Stub!"); }
public static final  android.database.Cursor query(android.content.ContentResolver cr, java.lang.String[] projection, long begin, long end) { throw new RuntimeException("Stub!"); }
public static final  android.database.Cursor query(android.content.ContentResolver cr, java.lang.String[] projection, long begin, long end, java.lang.String searchQuery) { throw new RuntimeException("Stub!"); }
...
static { CONTENT_BY_DAY_URI = null; CONTENT_SEARCH_BY_DAY_URI = null; CONTENT_SEARCH_URI = null; CONTENT_URI = null; }
}
...
{
CalendarCache() { throw new RuntimeException("Stub!"); }
...
{
EventDays() { throw new RuntimeException("Stub!"); }
public static final  android.database.Cursor query(android.content.ContentResolver cr, int startDay, int numDays, java.lang.String[] projection) { throw new RuntimeException("Stub!"); }
public static final android.net.Uri CONTENT_URI;
static { CONTENT_URI = null; }
}
...
{
Reminders() { throw new RuntimeException("Stub!"); }
public static final  android.database.Cursor query(android.content.ContentResolver cr, long eventId, java.lang.String[] projection) { throw new RuntimeException("Stub!"); }
@java.lang.SuppressWarnings(value={"hiding"})
public static final android.net.Uri CONTENT_URI;
static { CONTENT_URI = null; }
...
{
CalendarAlerts() { throw new RuntimeException("Stub!"); }
@java.lang.SuppressWarnings(value={"hiding"})
public static final android.net.Uri CONTENT_URI;
public static final android.net.Uri CONTENT_URI_BY_INSTANCE;
static { CONTENT_URI = null; CONTENT_URI_BY_INSTANCE = null; }
}
...
{
Colors() { throw new RuntimeException("Stub!"); }
@java.lang.SuppressWarnings(value={"hiding"})
public static final android.net.Uri CONTENT_URI;
static { CONTENT_URI = null; }
}
...
{
ExtendedProperties() { throw new RuntimeException("Stub!"); }
public static final android.net.Uri CONTENT_URI;
static { CONTENT_URI = null; }
}
...
CalendarContract() { throw new RuntimeException("Stub!"); }
