...
{
MultihomePlainSocketFactory() { throw new RuntimeException("Stub!"); }
public static  org.apache.http.conn.MultihomePlainSocketFactory getSocketFactory() { throw new RuntimeException("Stub!"); }
...
public final  boolean isSecure(java.net.Socket sock) throws java.lang.IllegalArgumentException { throw new RuntimeException("Stub!"); }
