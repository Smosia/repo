...
{
public  BasicHttpContext() { throw new RuntimeException("Stub!"); }
public  BasicHttpContext(org.apache.http.protocol.HttpContext parentContext) { throw new RuntimeException("Stub!"); }
