...
case TRANSACTION_updateRecordState:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
int _arg1;
_arg1 = data.readInt();
this.updateRecordState(_arg0, _arg1);
return true;
}
case TRANSACTION_onStorageFull:
{
data.enforceInterface(DESCRIPTOR);
this.onStorageFull();
return true;
...
@Override public void updateRecordState(int state, int customValue) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
mRemote.transact(Stub.TRANSACTION_updateRecordState, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
}
@Override public void onStorageFull() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_onStorageFull, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_updateRecordState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_onStorageFull = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
}
...
public void updateRecordState(int state, int customValue) throws android.os.RemoteException;
public void onStorageFull() throws android.os.RemoteException;
}
