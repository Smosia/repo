...
case TRANSACTION_switchInputMethodFromWindowManager:
{
data.enforceInterface(DESCRIPTOR);
boolean _arg0;
_arg0 = (0!=data.readInt());
this.switchInputMethodFromWindowManager(_arg0);
return true;
}
case TRANSACTION_sendCharacterToCurClient:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
this.sendCharacterToCurClient(_arg0);
return true;
}
case TRANSACTION_refreshImeWindowVisibilityLocked:
{
data.enforceInterface(DESCRIPTOR);
...
@Override public void switchInputMethodFromWindowManager(boolean isForward) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(((isForward)?(1):(0)));
mRemote.transact(Stub.TRANSACTION_switchInputMethodFromWindowManager, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
}
@Override public void sendCharacterToCurClient(int unicode) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(unicode);
mRemote.transact(Stub.TRANSACTION_sendCharacterToCurClient, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
}
@Override public void refreshImeWindowVisibilityLocked() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_refreshImeWindowVisibilityLocked, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_switchInputMethodFromWindowManager = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_sendCharacterToCurClient = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_refreshImeWindowVisibilityLocked = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
}
// TODO: Use ParceledListSlice instead
...
public void switchInputMethodFromWindowManager(boolean isForward) throws android.os.RemoteException;
public void sendCharacterToCurClient(int unicode) throws android.os.RemoteException;
public void refreshImeWindowVisibilityLocked() throws android.os.RemoteException;
}
