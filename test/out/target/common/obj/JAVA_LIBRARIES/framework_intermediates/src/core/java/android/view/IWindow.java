...
this.resized(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7);
return true;
}
...
case TRANSACTION_onAnimationStarted:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
this.onAnimationStarted(_arg0);
return true;
}
case TRANSACTION_onAnimationStopped:
{
data.enforceInterface(DESCRIPTOR);
...
case TRANSACTION_enableLog:
{
data.enforceInterface(DESCRIPTOR);
boolean _arg0;
_arg0 = (0!=data.readInt());
this.enableLog(_arg0);
return true;
}
case TRANSACTION_dumpInputDispatchingStatus:
{
data.enforceInterface(DESCRIPTOR);
this.dumpInputDispatchingStatus();
return true;
}
}
...
@Override public void resized(android.graphics.Rect frame, android.graphics.Rect overscanInsets, android.graphics.Rect contentInsets, android.graphics.Rect visibleInsets, android.graphics.Rect stableInsets, android.graphics.Rect outsets, boolean reportDraw, android.content.res.Configuration newConfig) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
/**
     ...
     */
@Override public void onAnimationStarted(int remainingFrameCount) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(remainingFrameCount);
mRemote.transact(Stub.TRANSACTION_onAnimationStarted, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
/**
     ...
     */
@Override public void onAnimationStopped() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_onAnimationStopped, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
/**
     ...
     */
@Override public void enableLog(boolean enable) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(((enable)?(1):(0)));
mRemote.transact(Stub.TRANSACTION_enableLog, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
/**
     ...
     * @hide
     */
@Override public void dumpInputDispatchingStatus() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_dumpInputDispatchingStatus, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_onAnimationStarted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_onAnimationStopped = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_dispatchWindowShown = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_enableLog = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_dumpInputDispatchingStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
}
/**
     * ===== NOTICE =====
     * The first method must remain the first method. Scripts
...
/**
     ...
     *                            pass -1 to let it continue drawing
     */
public void onAnimationStarted(int remainingFrameCount) throws android.os.RemoteException;
/**
     * The window has ended animating. See {@link #onAnimationStarted}.
     */
public void onAnimationStopped() throws android.os.RemoteException;
/**
     * Called for non-application windows when the enter animation has completed.
     */
...
/**
     * M: Enable/Disable the log
     */
public void enableLog(boolean enable) throws android.os.RemoteException;
/**
     * M: Dump input dispatching status for ANR analysis. @{
     * @hide
     */
public void dumpInputDispatchingStatus() throws android.os.RemoteException;
}
