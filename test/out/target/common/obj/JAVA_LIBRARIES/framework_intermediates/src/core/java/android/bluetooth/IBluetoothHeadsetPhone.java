 ...
 * Original file: frameworks/base/core/java/android/bluetooth/IBluetoothHeadsetPhone.aidl
 */
...
case TRANSACTION_restrictDualTalk:
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.restrictDualTalk();
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
@Override public boolean restrictDualTalk() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_restrictDualTalk, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
static final int TRANSACTION_restrictDualTalk = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_updateBtHandsfreeAfterRadioTechnologyChange = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_cdmaSwapSecondCallState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_cdmaSetSecondCallState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
}
// Internal functions, not be made public
...
public boolean restrictDualTalk() throws android.os.RemoteException;
// Internal for phone app to call
