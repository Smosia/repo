...
/**
     ...
     * @hide
     */
@Override public void removeToken(android.os.IBinder token) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_removeToken = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
}
...
/**
     ...
     * @hide
     */
public void removeToken(android.os.IBinder token) throws android.os.RemoteException;
}
