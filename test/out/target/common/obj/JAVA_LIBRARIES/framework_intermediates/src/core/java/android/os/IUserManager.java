...
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.canAddMoreManagedProfiles();
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
case TRANSACTION_setSystemControlledUserRestriction:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
...
int _arg2;
_arg2 = data.readInt();
this.setSystemControlledUserRestriction(_arg0, _arg1, _arg2);
reply.writeNoException();
return true;
}
...
case TRANSACTION_getSwitchedUserId:
{
data.enforceInterface(DESCRIPTOR);
int _result = this.getSwitchedUserId();
reply.writeNoException();
reply.writeInt(_result);
return true;
}
...
@Override public boolean canAddMoreManagedProfiles() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public void setUserRestriction(java.lang.String key, boolean value, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void setSystemControlledUserRestriction(java.lang.String key, boolean value, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeInt(((value)?(1):(0)));
_data.writeInt(userId);
mRemote.transact(Stub.TRANSACTION_setSystemControlledUserRestriction, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public int getSwitchedUserId() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getSwitchedUserId, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
static final int TRANSACTION_setUserEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_removeUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_setUserName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_setUserIcon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_getUserIcon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_getUsers = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_getProfiles = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_canAddMoreManagedProfiles = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_getProfileParent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_getUserInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_getUserCreationTime = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_isRestricted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_getUserSerialNumber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_getUserHandle = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_getUserRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_hasUserRestriction = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_setUserRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_setUserRestriction = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_setSystemControlledUserRestriction = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_setApplicationRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_getApplicationRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_getApplicationRestrictionsForUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_removeRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_getSwitchedUserId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_setDefaultGuestRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_getDefaultGuestRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_markGuestForDeletion = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
}
/*
     * DO NOT MOVE - UserManager.h depends on the ordering of this function.
     */
...
public boolean canAddMoreManagedProfiles() throws android.os.RemoteException;
...
public void setUserRestriction(java.lang.String key, boolean value, int userId) throws android.os.RemoteException;
public void setSystemControlledUserRestriction(java.lang.String key, boolean value, int userId) throws android.os.RemoteException;
...
public int getSwitchedUserId() throws android.os.RemoteException;
