...
case TRANSACTION_showDefaultAccountStatus:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
this.showDefaultAccountStatus(_arg0);
reply.writeNoException();
return true;
}
case TRANSACTION_hideDefaultAccountStatus:
{
data.enforceInterface(DESCRIPTOR);
this.hideDefaultAccountStatus();
reply.writeNoException();
return true;
}
case TRANSACTION_reloadNavigationBar:
{
data.enforceInterface(DESCRIPTOR);
...
case TRANSACTION_removeNavigationBar:
{
data.enforceInterface(DESCRIPTOR);
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_appTransitionPending, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_appTransitionCancelled, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_appTransitionStarting, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_startAssist, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void showDefaultAccountStatus(int subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_showDefaultAccountStatus, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void hideDefaultAccountStatus() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_hideDefaultAccountStatus, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void reloadNavigationBar() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_reloadNavigationBar, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void removeNavigationBar() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_removeNavigationBar, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_setSystemUiVisibility = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_setWindowState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_showRecentApps = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_hideRecentApps = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_toggleRecentApps = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_preloadRecentApps = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_cancelPreloadRecentApps = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_appTransitionPending = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_appTransitionCancelled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_appTransitionStarting = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_startAssist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_showDefaultAccountStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_hideDefaultAccountStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_reloadNavigationBar = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_removeNavigationBar = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
}
...
/** M: Support [SIM Indicator] @ { */
public void showDefaultAccountStatus(int subId) throws android.os.RemoteException;
public void hideDefaultAccountStatus() throws android.os.RemoteException;
/** @ } *///add BUG_ID:JBLW-93 daizhiyi 20131123 (start)

public void reloadNavigationBar() throws android.os.RemoteException;
public void removeNavigationBar() throws android.os.RemoteException;
}
