...
case TRANSACTION_isTetheringChangeDone:
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.isTetheringChangeDone();
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
case TRANSACTION_setTetheringIpv6Enable:
{
data.enforceInterface(DESCRIPTOR);
boolean _arg0;
_arg0 = (0!=data.readInt());
this.setTetheringIpv6Enable(_arg0);
reply.writeNoException();
return true;
}
case TRANSACTION_getTetheringIpv6Enable:
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.getTetheringIpv6Enable();
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
case TRANSACTION_getNetworkIfCreated:
{
data.enforceInterface(DESCRIPTOR);
android.net.NetworkRequest _arg0;
if ((0!=data.readInt())) {
...
android.net.Network _result = this.getNetworkIfCreated(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
@Override public boolean isTetheringChangeDone() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isTetheringChangeDone, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
/**
     ...
     * @hide
     */
@Override public void setTetheringIpv6Enable(boolean enable) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(((enable)?(1):(0)));
mRemote.transact(Stub.TRANSACTION_setTetheringIpv6Enable, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
/**
     ...
     * @hide
     */
@Override public boolean getTetheringIpv6Enable() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getTetheringIpv6Enable, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
/**
     ...
     * @hide
     */
@Override public android.net.Network getNetworkIfCreated(android.net.NetworkRequest networkRequest) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.net.Network _result;
...
mRemote.transact(Stub.TRANSACTION_getNetworkIfCreated, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = android.net.Network.CREATOR.createFromParcel(_reply);
}
...
static final int TRANSACTION_getActiveNetworkInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_getActiveNetworkInfoForUid = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_getNetworkInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_getNetworkInfoForNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_getAllNetworkInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_getNetworkForType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_getAllNetworks = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_getDefaultNetworkCapabilitiesForUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
...
static final int TRANSACTION_reportNetworkConnectivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
...
static final int TRANSACTION_getProxyForNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_prepareVpn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_setVpnPackageAuthorization = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_establishVpn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_getVpnConfig = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_startLegacyVpn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_getLegacyVpnInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_getAllVpnInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_updateLockdownVpn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_checkMobileProvisioning = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_getMobileProvisioningUrl = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_setProvisioningNotificationVisible = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_setAirplaneMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_registerNetworkFactory = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_requestBandwidthUpdate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_unregisterNetworkFactory = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_registerNetworkAgent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_requestNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
static final int TRANSACTION_pendingRequestForNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
static final int TRANSACTION_releasePendingNetworkRequest = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_listenForNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
static final int TRANSACTION_pendingListenForNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
static final int TRANSACTION_releaseNetworkRequest = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
static final int TRANSACTION_setAcceptUnvalidated = (android.os.IBinder.FIRST_CALL_TRANSACTION + 57);
static final int TRANSACTION_getRestoreDefaultNetworkDelay = (android.os.IBinder.FIRST_CALL_TRANSACTION + 58);
static final int TRANSACTION_addVpnAddress = (android.os.IBinder.FIRST_CALL_TRANSACTION + 59);
static final int TRANSACTION_removeVpnAddress = (android.os.IBinder.FIRST_CALL_TRANSACTION + 60);
static final int TRANSACTION_setUnderlyingNetworksForVpn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 61);
static final int TRANSACTION_factoryReset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 62);
static final int TRANSACTION_getTetheredIfacePairs = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
static final int TRANSACTION_isTetheringChangeDone = (android.os.IBinder.FIRST_CALL_TRANSACTION + 64);
static final int TRANSACTION_setTetheringIpv6Enable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 65);
static final int TRANSACTION_getTetheringIpv6Enable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 66);
static final int TRANSACTION_getNetworkIfCreated = (android.os.IBinder.FIRST_CALL_TRANSACTION + 67);
static final int TRANSACTION_startNattKeepalive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 68);
static final int TRANSACTION_stopKeepalive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 69);
}
...
/** M: support Tether dediated APN feature  for OP03APNSettingExt*/
public boolean isTetheringChangeDone() throws android.os.RemoteException;
/**
     * M: ipv6 tethering
     * @hide
     */
public void setTetheringIpv6Enable(boolean enable) throws android.os.RemoteException;
/**
     * M: ipv6 tethering
     * @hide
     */
public boolean getTetheringIpv6Enable() throws android.os.RemoteException;
/**
     * M: check if network is created
     * @hide
     */
public android.net.Network getNetworkIfCreated(android.net.NetworkRequest networkRequest) throws android.os.RemoteException;
