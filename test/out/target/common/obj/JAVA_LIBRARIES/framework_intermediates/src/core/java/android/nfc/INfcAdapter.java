...
case TRANSACTION_getNfcAdapterGsmaExtrasInterface:
{
data.enforceInterface(DESCRIPTOR);
android.nfc.INfcAdapterGsmaExtras _result = this.getNfcAdapterGsmaExtrasInterface();
reply.writeNoException();
reply.writeStrongBinder((((_result!=null))?(_result.asBinder()):(null)));
return true;
}
case TRANSACTION_getModeFlag:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
int _result = this.getModeFlag(_arg0);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
case TRANSACTION_setModeFlag:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
@Override public android.nfc.INfcAdapterGsmaExtras getNfcAdapterGsmaExtrasInterface() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.nfc.INfcAdapterGsmaExtras _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getNfcAdapterGsmaExtrasInterface, _data, _reply, 0);
_reply.readException();
_result = android.nfc.INfcAdapterGsmaExtras.Stub.asInterface(_reply.readStrongBinder());
}
finally {
_reply.recycle();
_data.recycle();
...
@Override public int getModeFlag(int mode) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(mode);
mRemote.transact(Stub.TRANSACTION_getModeFlag, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
@Override public void setModeFlag(int mode, int flag) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeInt(mode);
_data.writeInt(flag);
mRemote.transact(Stub.TRANSACTION_setModeFlag, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_getNfcAdapterGsmaExtrasInterface = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_getModeFlag = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_setModeFlag = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
...
public android.nfc.INfcAdapterGsmaExtras getNfcAdapterGsmaExtrasInterface() throws android.os.RemoteException;
public int getModeFlag(int mode) throws android.os.RemoteException;
public void setModeFlag(int mode, int flag) throws android.os.RemoteException;
/// }
