...
case TRANSACTION_notifyCallStateForPhoneInfo:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
this.notifyCallStateForPhoneInfo(_arg0, _arg1, _arg2, _arg3, _arg4);
reply.writeNoException();
return true;
}
...
case TRANSACTION_notifyLteAccessStratumChanged:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
this.notifyLteAccessStratumChanged(_arg0);
reply.writeNoException();
return true;
}
case TRANSACTION_notifyPsNetworkTypeChanged:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
this.notifyPsNetworkTypeChanged(_arg0);
reply.writeNoException();
return true;
}
case TRANSACTION_notifySharedDefaultApnStateChanged:
{
data.enforceInterface(DESCRIPTOR);
boolean _arg0;
_arg0 = (0!=data.readInt());
this.notifySharedDefaultApnStateChanged(_arg0);
reply.writeNoException();
return true;
}
...
@Override public void notifyCallStateForPhoneInfo(int phoneId, int phoneType, int subId, int state, java.lang.String incomingNumber) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeInt(state);
_data.writeString(incomingNumber);
mRemote.transact(Stub.TRANSACTION_notifyCallStateForPhoneInfo, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void notifyLteAccessStratumChanged(java.lang.String state) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_notifyLteAccessStratumChanged, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void notifyPsNetworkTypeChanged(int nwType) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_notifyPsNetworkTypeChanged, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void notifySharedDefaultApnStateChanged(boolean isSharedDefaultApn) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(((isSharedDefaultApn)?(1):(0)));
mRemote.transact(Stub.TRANSACTION_notifySharedDefaultApnStateChanged, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_notifyCarrierNetworkChange, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_notifyCallStateForPhoneInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_notifyCallStateForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_notifyServiceStateForPhoneId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_notifySignalStrength = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_notifySignalStrengthForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_notifyMessageWaitingChangedForPhoneId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_notifyCallForwardingChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_notifyCallForwardingChangedForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_notifyDataActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_notifyDataActivityForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_notifyDataConnection = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_notifyDataConnectionForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_notifyDataConnectionFailed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_notifyDataConnectionFailedForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_notifyCellLocation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_notifyCellLocationForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_notifyOtaspChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_notifyCellInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
...
static final int TRANSACTION_notifyDataConnectionRealTimeInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_notifyVoLteServiceStateChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_notifyOemHookRawEventForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_notifyLteAccessStratumChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_notifyPsNetworkTypeChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_notifySharedDefaultApnStateChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_notifySubscriptionInfoChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_notifyCarrierNetworkChange = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
}
...
public void notifyCallStateForPhoneInfo(int phoneId, int phoneType, int subId, int state, java.lang.String incomingNumber) throws android.os.RemoteException;
/// @}
...
public void notifyLteAccessStratumChanged(java.lang.String state) throws android.os.RemoteException;
public void notifyPsNetworkTypeChanged(int nwType) throws android.os.RemoteException;
public void notifySharedDefaultApnStateChanged(boolean isSharedDefaultApn) throws android.os.RemoteException;
// M: [LTE][Low Power][UL traffic shaping] End
