...
case TRANSACTION_setImsCapability:
{
data.enforceInterface(DESCRIPTOR);
boolean _arg0;
...
this.setImsCapability(_arg0, _arg1, _arg2);
reply.writeNoException();
return true;
}
case TRANSACTION_getImsCapability:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
boolean _result = this.getImsCapability(_arg0);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
_data.writeInt(value);
_data.writeStrongBinder((((listener!=null))?(listener.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_setFeatureValue, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
/**
     ...
     * @return void.
     */
@Override public void setImsCapability(boolean volte, boolean vilte, boolean wfc) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(((volte)?(1):(0)));
_data.writeInt(((vilte)?(1):(0)));
_data.writeInt(((wfc)?(1):(0)));
mRemote.transact(Stub.TRANSACTION_setImsCapability, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
/**
     ...
     * @return boolean
     */
@Override public boolean getImsCapability(int capability) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
mRemote.transact(Stub.TRANSACTION_getImsCapability, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
static final int TRANSACTION_setImsCapability = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_getImsCapability = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
}
/**
     * Gets the value for ims service/capabilities parameters from the provisioned
     * value storage. Synchronous blocking call.
...
/**
     ...
     * @return void.
     */
public void setImsCapability(boolean volte, boolean vilte, boolean wfc) throws android.os.RemoteException;
/**
     * Gets the value for IMS capabilities.
     * @param capability.	 
     *
     * @return boolean
     */
public boolean getImsCapability(int capability) throws android.os.RemoteException;
}
