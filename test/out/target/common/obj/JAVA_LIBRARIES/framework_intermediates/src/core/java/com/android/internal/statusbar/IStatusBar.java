...
mRemote.transact(Stub.TRANSACTION_showDefaultAccountStatus, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_hideDefaultAccountStatus, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_reloadNavigationBar, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_removeNavigationBar, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_showDefaultAccountStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_hideDefaultAccountStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_reloadNavigationBar = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_removeNavigationBar = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
}
