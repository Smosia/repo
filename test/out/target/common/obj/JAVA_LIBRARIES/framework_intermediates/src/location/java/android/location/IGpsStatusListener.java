...
case TRANSACTION_onGnssSvStatusChanged:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
boolean[] _arg7;
_arg7 = data.createBooleanArray();
this.onGnssSvStatusChanged(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7);
return true;
}
...
@Override public void onGnssSvStatusChanged(int svCount, int[] prns, float[] snrs, float[] elevations, float[] azimuths, boolean[] ephemeris, boolean[] almanac, boolean[] usedInFix) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
_data.writeFloatArray(elevations);
_data.writeFloatArray(azimuths);
_data.writeBooleanArray(ephemeris);
_data.writeBooleanArray(almanac);
_data.writeBooleanArray(usedInFix);
mRemote.transact(Stub.TRANSACTION_onGnssSvStatusChanged, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_onGnssSvStatusChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_onNmeaReceived = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
}
...
public void onGnssSvStatusChanged(int svCount, int[] prns, float[] snrs, float[] elevations, float[] azimuths, boolean[] ephemeris, boolean[] almanac, boolean[] usedInFix) throws android.os.RemoteException;
