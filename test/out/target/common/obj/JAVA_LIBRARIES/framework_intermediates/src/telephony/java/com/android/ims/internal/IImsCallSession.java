...
case TRANSACTION_isIncomingCallMultiparty:
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.isIncomingCallMultiparty();
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
case TRANSACTION_sendDtmfbyTarget:
{
data.enforceInterface(DESCRIPTOR);
char _arg0;
_arg0 = (char)data.readInt();
...
this.sendDtmfbyTarget(_arg0, _arg1, _arg2);
reply.writeNoException();
return true;
}
}
...
/**
     ...
     * @hide
     */
@Override public boolean isIncomingCallMultiparty() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isIncomingCallMultiparty, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
/**
     ...
     * @hide
     */
@Override public void sendDtmfbyTarget(char c, android.os.Message result, android.os.Messenger target) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_sendDtmfbyTarget, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_isIncomingCallMultiparty = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_sendDtmfbyTarget = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
}
/**
     * Closes the object. This object is not usable after being closed.
     */
...
/**
     ...
     * @hide
     */
public void sendDtmfbyTarget(char c, android.os.Message result, android.os.Messenger target) throws android.os.RemoteException;
}
