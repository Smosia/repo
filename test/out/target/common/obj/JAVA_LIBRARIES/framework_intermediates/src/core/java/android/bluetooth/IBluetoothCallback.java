...
case TRANSACTION_onWholeChipReset:
{
data.enforceInterface(DESCRIPTOR);
this.onWholeChipReset();
reply.writeNoException();
return true;
}
}
...
@Override public void onWholeChipReset() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_onWholeChipReset, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_onWholeChipReset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
}
//void onRfcommChannelFound(int channel);
...
public void onWholeChipReset() throws android.os.RemoteException;
}
