...
case TRANSACTION_getSubscriptionInfo:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
android.telephony.SubscriptionInfo _result = this.getSubscriptionInfo(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
case TRANSACTION_getSubscriptionInfoForIccId:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
android.telephony.SubscriptionInfo _result = this.getSubscriptionInfoForIccId(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
case TRANSACTION_getSubIdUsingSlotId:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
int[] _result = this.getSubIdUsingSlotId(_arg0);
reply.writeNoException();
reply.writeIntArray(_result);
return true;
}
case TRANSACTION_getSubIdUsingPhoneId:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
int _result = this.getSubIdUsingPhoneId(_arg0);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
case TRANSACTION_setDefaultFallbackSubId:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
this.setDefaultFallbackSubId(_arg0);
reply.writeNoException();
return true;
}
case TRANSACTION_setDefaultDataSubIdWithoutCapabilitySwitch:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
this.setDefaultDataSubIdWithoutCapabilitySwitch(_arg0);
reply.writeNoException();
return true;
}
}
...
/**
     ...
     */
@Override public android.telephony.SubscriptionInfo getSubscriptionInfo(int subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.telephony.SubscriptionInfo _result;
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(subId);
mRemote.transact(Stub.TRANSACTION_getSubscriptionInfo, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = android.telephony.SubscriptionInfo.CREATOR.createFromParcel(_reply);
}
...
/**
     ...
     * @return SubscriptionInfo, maybe null if not found
     */
@Override public android.telephony.SubscriptionInfo getSubscriptionInfoForIccId(java.lang.String iccId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.telephony.SubscriptionInfo _result;
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(iccId);
mRemote.transact(Stub.TRANSACTION_getSubscriptionInfoForIccId, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = android.telephony.SubscriptionInfo.CREATOR.createFromParcel(_reply);
}
...
@Override public int[] getSubIdUsingSlotId(int slotId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int[] _result;
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(slotId);
mRemote.transact(Stub.TRANSACTION_getSubIdUsingSlotId, _data, _reply, 0);
_reply.readException();
_result = _reply.createIntArray();
}
finally {
...
@Override public int getSubIdUsingPhoneId(int phoneId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
mRemote.transact(Stub.TRANSACTION_getSubIdUsingPhoneId, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
@Override public void setDefaultFallbackSubId(int subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(subId);
mRemote.transact(Stub.TRANSACTION_setDefaultFallbackSubId, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void setDefaultDataSubIdWithoutCapabilitySwitch(int subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(subId);
mRemote.transact(Stub.TRANSACTION_setDefaultDataSubIdWithoutCapabilitySwitch, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_getSubscriptionInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_getSubscriptionInfoForIccId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_getSubIdUsingSlotId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_getSubIdUsingPhoneId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_setDefaultFallbackSubId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_setDefaultDataSubIdWithoutCapabilitySwitch = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
}
/**
     * @param callingPackage The package maing the call.
     * @return a list of all subscriptions in the database, this includes
...
/**
     ...
     * @return SubscriptionInfo, maybe null if not found
     */
public android.telephony.SubscriptionInfo getSubscriptionInfo(int subId) throws android.os.RemoteException;
/**
     * Get the SubscriptionInfo associated with the iccId
     * @param iccId the IccId of SIM card
     * @return SubscriptionInfo, maybe null if not found
     */
public android.telephony.SubscriptionInfo getSubscriptionInfoForIccId(java.lang.String iccId) throws android.os.RemoteException;
public int[] getSubIdUsingSlotId(int slotId) throws android.os.RemoteException;
public int getSubIdUsingPhoneId(int phoneId) throws android.os.RemoteException;
public void setDefaultFallbackSubId(int subId) throws android.os.RemoteException;
public void setDefaultDataSubIdWithoutCapabilitySwitch(int subId) throws android.os.RemoteException;
}
