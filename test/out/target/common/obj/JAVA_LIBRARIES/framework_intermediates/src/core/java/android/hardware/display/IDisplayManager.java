...
case TRANSACTION_isSinkEnabled:
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.isSinkEnabled();
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
case TRANSACTION_enableSink:
{
data.enforceInterface(DESCRIPTOR);
boolean _arg0;
_arg0 = (0!=data.readInt());
this.enableSink(_arg0);
reply.writeNoException();
return true;
}
case TRANSACTION_waitWifiDisplayConnection:
{
data.enforceInterface(DESCRIPTOR);
...
this.waitWifiDisplayConnection(_arg0);
reply.writeNoException();
return true;
}
case TRANSACTION_suspendWifiDisplay:
{
data.enforceInterface(DESCRIPTOR);
boolean _arg0;
_arg0 = (0!=data.readInt());
...
this.suspendWifiDisplay(_arg0, _arg1);
reply.writeNoException();
return true;
}
case TRANSACTION_sendUibcInputEvent:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
this.sendUibcInputEvent(_arg0);
reply.writeNoException();
return true;
}
}
...
@Override public boolean isSinkEnabled() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isSinkEnabled, _data, _reply, 0);
_reply.readException();
...
@Override public void enableSink(boolean enable) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_enableSink, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void waitWifiDisplayConnection(android.view.Surface surface) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_waitWifiDisplayConnection, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void suspendWifiDisplay(boolean suspend, android.view.Surface surface) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_suspendWifiDisplay, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void sendUibcInputEvent(java.lang.String input) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_sendUibcInputEvent, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_isSinkEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_enableSink = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_waitWifiDisplayConnection = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_suspendWifiDisplay = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_sendUibcInputEvent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
}
...
public boolean isSinkEnabled() throws android.os.RemoteException;
public void enableSink(boolean enable) throws android.os.RemoteException;
public void waitWifiDisplayConnection(android.view.Surface surface) throws android.os.RemoteException;
public void suspendWifiDisplay(boolean suspend, android.view.Surface surface) throws android.os.RemoteException;
public void sendUibcInputEvent(java.lang.String input) throws android.os.RemoteException;
}
