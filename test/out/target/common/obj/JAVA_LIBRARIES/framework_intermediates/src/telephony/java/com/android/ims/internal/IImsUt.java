...
case TRANSACTION_queryCallForwardInTimeSlot:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
int _result = this.queryCallForwardInTimeSlot(_arg0);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
case TRANSACTION_updateCallForwardInTimeSlot:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
int _result = this.updateCallForwardInTimeSlot(_arg0, _arg1, _arg2, _arg3, _arg4);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
...
/**
     ...
     */
@Override public int queryCallForwardInTimeSlot(int condition) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(condition);
mRemote.transact(Stub.TRANSACTION_queryCallForwardInTimeSlot, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
/**
     ...
     */
@Override public int updateCallForwardInTimeSlot(int action, int condition, java.lang.String number, int timeSeconds, long[] timeSlot) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
mRemote.transact(Stub.TRANSACTION_updateCallForwardInTimeSlot, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
static final int TRANSACTION_queryCallForwardInTimeSlot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_updateCallForwardInTimeSlot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
}
/**
     * Closes the object. This object is not usable after being closed.
     */
...
/**
     * Retrieves the configuration of the call forward in time slot.
     */
public int queryCallForwardInTimeSlot(int condition) throws android.os.RemoteException;
/**
     * Updates the configuration of the call forward in time slot.
     */
public int updateCallForwardInTimeSlot(int action, int condition, java.lang.String number, int timeSeconds, long[] timeSlot) throws android.os.RemoteException;
}
