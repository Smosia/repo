...
case TRANSACTION_getVolteCallCapablePhoneAccounts:
{
data.enforceInterface(DESCRIPTOR);
java.util.List<android.telecom.PhoneAccountHandle> _result = this.getVolteCallCapablePhoneAccounts();
reply.writeNoException();
reply.writeTypedList(_result);
return true;
}
case TRANSACTION_getVideoCallCapablePhoneAccounts:
{
data.enforceInterface(DESCRIPTOR);
java.util.List<android.telecom.PhoneAccountHandle> _result = this.getVideoCallCapablePhoneAccounts();
reply.writeNoException();
reply.writeTypedList(_result);
return true;
}
...
/**
     ...
     */
@Override public java.util.List<android.telecom.PhoneAccountHandle> getVolteCallCapablePhoneAccounts() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.util.List<android.telecom.PhoneAccountHandle> _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getVolteCallCapablePhoneAccounts, _data, _reply, 0);
_reply.readException();
_result = _reply.createTypedArrayList(android.telecom.PhoneAccountHandle.CREATOR);
}
finally {
...
/**
     ...
     */
@Override public java.util.List<android.telecom.PhoneAccountHandle> getVideoCallCapablePhoneAccounts() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.util.List<android.telecom.PhoneAccountHandle> _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getVideoCallCapablePhoneAccounts, _data, _reply, 0);
_reply.readException();
_result = _reply.createTypedArrayList(android.telecom.PhoneAccountHandle.CREATOR);
}
finally {
...
static final int TRANSACTION_getVolteCallCapablePhoneAccounts = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_getVideoCallCapablePhoneAccounts = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
}
/**
     * Brings the in-call screen to the foreground if there is an active call.
     *
...
/**
     * @see TelecomService#getVolteCallCapablePhoneAccounts
     */
public java.util.List<android.telecom.PhoneAccountHandle> getVolteCallCapablePhoneAccounts() throws android.os.RemoteException;
/**
     * @see TelecomService#getVideoCallCapablePhoneAccounts
     */
public java.util.List<android.telecom.PhoneAccountHandle> getVideoCallCapablePhoneAccounts() throws android.os.RemoteException;
}
