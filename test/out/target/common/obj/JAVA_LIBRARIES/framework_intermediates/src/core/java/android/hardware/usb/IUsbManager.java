...
@Override public void setCurrentFunction(java.lang.String function) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/* Sets whether USB data (for example, MTP exposed pictures) should be made
     ...
     * user information.
     */
@Override public void setUsbDataUnlocked(boolean unlock) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public android.hardware.usb.UsbPort[] getPorts() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
static final int TRANSACTION_setCurrentFunction = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_getCurrentState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_setUsbDataUnlocked = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_allowUsbDebugging = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_denyUsbDebugging = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_clearUsbDebuggingKeys = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
...
/* Sets the current USB function. */
public void setCurrentFunction(java.lang.String function) throws android.os.RemoteException;
/* Returns the current USB state. */
...
/* Sets whether USB data (for example, MTP exposed pictures) should be made
     ...
     * user information.
     */
public void setUsbDataUnlocked(boolean unlock) throws android.os.RemoteException;
/* Allow USB debugging from the attached host. If alwaysAllow is true, add the
     * the public key to list of host keys that the user has approved.
     */
