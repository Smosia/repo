...
case TRANSACTION_getKeyguardWallpaper:
{
data.enforceInterface(DESCRIPTOR);
...
android.os.ParcelFileDescriptor _result = this.getKeyguardWallpaper(_arg0, _arg1);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
this.setWallpaperComponentChecked(_arg0, _arg1);
reply.writeNoException();
return true;
}
...
case TRANSACTION_getWallpaperInfoWithIpo:
{
data.enforceInterface(DESCRIPTOR);
android.app.WallpaperInfo _result = this.getWallpaperInfoWithIpo();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
case TRANSACTION_resetWallpaper:
{
data.enforceInterface(DESCRIPTOR);
this.resetWallpaper();
reply.writeNoException();
...
case TRANSACTION_onVisibilityChanged:
{
data.enforceInterface(DESCRIPTOR);
boolean _arg0;
_arg0 = (0!=data.readInt());
this.onVisibilityChanged(_arg0);
reply.writeNoException();
return true;
}
}
...
/**
     ...
     */
@Override public android.os.ParcelFileDescriptor getKeyguardWallpaper(android.app.IWallpaperManagerCallback cb, android.os.Bundle outParams) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.os.ParcelFileDescriptor _result;
...
mRemote.transact(Stub.TRANSACTION_getKeyguardWallpaper, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = android.os.ParcelFileDescriptor.CREATOR.createFromParcel(_reply);
}
...
/**
     ...
     */
@Override public void setWallpaperComponentChecked(android.content.ComponentName name, java.lang.String callingPackage) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public android.app.WallpaperInfo getWallpaperInfoWithIpo() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.app.WallpaperInfo _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getWallpaperInfoWithIpo, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = android.app.WallpaperInfo.CREATOR.createFromParcel(_reply);
}
...
/**
     * Clear the wallpaper.
     */
@Override public void clearWallpaper(java.lang.String callingPackage) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     */
@Override public void resetWallpaper() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_resetWallpaper, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
/**
     ...
     */
@Override public void onVisibilityChanged(boolean isVisible) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_onVisibilityChanged, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_getKeyguardWallpaper = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_setWallpaperComponentChecked = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_setWallpaperComponent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_getWallpaper = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_getWallpaperInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_getWallpaperInfoWithIpo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_clearWallpaper = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_hasNamedWallpaper = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_setDimensionHints = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_getWidthHint = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_getHeightHint = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_setDisplayPadding = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_getName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_settingsRestored = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_isWallpaperSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_resetWallpaper = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_onVisibilityChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
}
/**
     * Set the wallpaper.
     */
...
/**
     * Get the keyguard wallpaper.
     */
public android.os.ParcelFileDescriptor getKeyguardWallpaper(android.app.IWallpaperManagerCallback cb, android.os.Bundle outParams) throws android.os.RemoteException;
//Add by zhaopenglin for keyguardwallpaper 20160303 end
/**
     * Set the live wallpaper.
     */
public void setWallpaperComponentChecked(android.content.ComponentName name, java.lang.String callingPackage) throws android.os.RemoteException;
/**
     * Set the live wallpaper.
     */
...
public android.app.WallpaperInfo getWallpaperInfoWithIpo() throws android.os.RemoteException;
/**
     * Clear the wallpaper.
     */
public void clearWallpaper(java.lang.String callingPackage) throws android.os.RemoteException;
/**
     * Return whether there is a wallpaper set with the given name.
     */
...
/**
     * Reset wallpaper, delete wallpaper and wallpaper_info.xml file
     */
public void resetWallpaper() throws android.os.RemoteException;
/**
     * [MTK LCA Memory Slim], for WMS tell WpMS the visible state changed of wallpaper
     */
public void onVisibilityChanged(boolean isVisible) throws android.os.RemoteException;
}
