...
case TRANSACTION_sendCharacter:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
this.sendCharacter(_arg0);
return true;
}
...
@Override public void sendCharacter(int unicode) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(unicode);
mRemote.transact(Stub.TRANSACTION_sendCharacter, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_sendCharacter = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_setUserActionNotificationSequenceNumber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
}
...
public void sendCharacter(int unicode) throws android.os.RemoteException;
