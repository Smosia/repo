...
case TRANSACTION_getDataActivityForSubscriber:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
int _result = this.getDataActivityForSubscriber(_arg0);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
...
case TRANSACTION_getDataStateForSubscriber:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
int _result = this.getDataStateForSubscriber(_arg0);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
...
boolean _result = this.setNetworkSelectionModeManual(_arg0, _arg1);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
case TRANSACTION_getIccAtr:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
java.lang.String _result = this.getIccAtr(_arg0);
reply.writeNoException();
reply.writeString(_result);
return true;
}
case TRANSACTION_iccOpenLogicalChannelWithSW:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
java.lang.String _arg1;
_arg1 = data.readString();
byte[] _result = this.iccOpenLogicalChannelWithSW(_arg0, _arg1);
reply.writeNoException();
reply.writeByteArray(_result);
return true;
}
case TRANSACTION_iccExchangeSimIOUsingSlot:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
java.lang.String _arg6;
_arg6 = data.readString();
byte[] _result = this.iccExchangeSimIOUsingSlot(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6);
reply.writeNoException();
reply.writeByteArray(_result);
return true;
}
case TRANSACTION_iccExchangeSimIOExUsingSlot:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
byte[] _result = this.iccExchangeSimIOExUsingSlot(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7, _arg8);
reply.writeNoException();
reply.writeByteArray(_result);
return true;
}
case TRANSACTION_iccOpenLogicalChannelUsingSlot:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
java.lang.String _arg1;
_arg1 = data.readString();
android.telephony.IccOpenLogicalChannelResponse _result = this.iccOpenLogicalChannelUsingSlot(_arg0, _arg1);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
case TRANSACTION_iccCloseLogicalChannelUsingSlot:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
int _arg1;
_arg1 = data.readInt();
boolean _result = this.iccCloseLogicalChannelUsingSlot(_arg0, _arg1);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
case TRANSACTION_iccTransmitApduLogicalChannelUsingSlot:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
java.lang.String _arg7;
_arg7 = data.readString();
java.lang.String _result = this.iccTransmitApduLogicalChannelUsingSlot(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7);
reply.writeNoException();
reply.writeString(_result);
return true;
}
case TRANSACTION_iccTransmitApduBasicChannelUsingSlot:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
java.lang.String _arg6;
_arg6 = data.readString();
java.lang.String _result = this.iccTransmitApduBasicChannelUsingSlot(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6);
reply.writeNoException();
reply.writeString(_result);
return true;
}
case TRANSACTION_setPolicyDataEnableForSubscriber:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
boolean _arg1;
_arg1 = (0!=data.readInt());
this.setPolicyDataEnableForSubscriber(_arg0, _arg1);
reply.writeNoException();
return true;
}
}
...
/**
     ...
     */
@Override public int getDataActivityForSubscriber(int subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(subId);
mRemote.transact(Stub.TRANSACTION_getDataActivityForSubscriber, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
/**
     ...
     */
@Override public int getDataStateForSubscriber(int subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(subId);
mRemote.transact(Stub.TRANSACTION_getDataStateForSubscriber, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
/**
     ...
     */
@Override public boolean setNetworkSelectionModeManual(int subId, com.android.internal.telephony.OperatorInfo operator) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public java.lang.String getIccAtr(int slotId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(slotId);
mRemote.transact(Stub.TRANSACTION_getIccAtr, _data, _reply, 0);
_reply.readException();
_result = _reply.readString();
}
finally {
...
@Override public byte[] iccOpenLogicalChannelWithSW(int slotId, java.lang.String AID) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
byte[] _result;
...
_data.writeInt(slotId);
_data.writeString(AID);
mRemote.transact(Stub.TRANSACTION_iccOpenLogicalChannelWithSW, _data, _reply, 0);
_reply.readException();
_result = _reply.createByteArray();
}
finally {
...
@Override public byte[] iccExchangeSimIOUsingSlot(int slotId, int fileID, int command, int p1, int p2, int p3, java.lang.String filePath) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
byte[] _result;
...
_data.writeInt(p3);
_data.writeString(filePath);
mRemote.transact(Stub.TRANSACTION_iccExchangeSimIOUsingSlot, _data, _reply, 0);
_reply.readException();
_result = _reply.createByteArray();
}
finally {
...
@Override public byte[] iccExchangeSimIOExUsingSlot(int slotId, int fileID, int command, int p1, int p2, int p3, java.lang.String filePath, java.lang.String data, java.lang.String pin2) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
byte[] _result;
...
mRemote.transact(Stub.TRANSACTION_iccExchangeSimIOExUsingSlot, _data, _reply, 0);
_reply.readException();
_result = _reply.createByteArray();
}
finally {
...
/**
     ...
     * @return an IccOpenLogicalChannelResponse object.
     */
@Override public android.telephony.IccOpenLogicalChannelResponse iccOpenLogicalChannelUsingSlot(int slotId, java.lang.String AID) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.telephony.IccOpenLogicalChannelResponse _result;
...
_data.writeInt(slotId);
_data.writeString(AID);
mRemote.transact(Stub.TRANSACTION_iccOpenLogicalChannelUsingSlot, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = android.telephony.IccOpenLogicalChannelResponse.CREATOR.createFromParcel(_reply);
}
...
/**
     ...
     * @return true if the channel was closed successfully.
     */
@Override public boolean iccCloseLogicalChannelUsingSlot(int slotId, int channel) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
_data.writeInt(slotId);
_data.writeInt(channel);
mRemote.transact(Stub.TRANSACTION_iccCloseLogicalChannelUsingSlot, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
/**
     ...
     *            the end. If an error occurs, an empty string is returned.
     */
@Override public java.lang.String iccTransmitApduLogicalChannelUsingSlot(int slotId, int channel, int cla, int instruction, int p1, int p2, int p3, java.lang.String data) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
_data.writeInt(p3);
_data.writeString(data);
mRemote.transact(Stub.TRANSACTION_iccTransmitApduLogicalChannelUsingSlot, _data, _reply, 0);
_reply.readException();
_result = _reply.readString();
}
finally {
...
@Override public java.lang.String iccTransmitApduBasicChannelUsingSlot(int slotId, int cla, int command, int p1, int p2, int p3, java.lang.String data) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
_data.writeInt(p3);
_data.writeString(data);
mRemote.transact(Stub.TRANSACTION_iccTransmitApduBasicChannelUsingSlot, _data, _reply, 0);
_reply.readException();
_result = _reply.readString();
}
finally {
...
@Override public void setPolicyDataEnableForSubscriber(int subId, boolean enabled) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_setPolicyDataEnableForSubscriber, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_getDataActivityForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_getDataState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_getDataStateForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_getActivePhoneType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_getActivePhoneTypeForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_getCdmaEriIconIndex = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_getCdmaEriIconIndexForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
static final int TRANSACTION_getCdmaEriIconMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
static final int TRANSACTION_getCdmaEriIconModeForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_getCdmaEriText = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
static final int TRANSACTION_getCdmaEriTextForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
static final int TRANSACTION_needsOtaServiceProvisioning = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
static final int TRANSACTION_setVoiceMailNumber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 57);
static final int TRANSACTION_getVoiceMessageCount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 58);
static final int TRANSACTION_getVoiceMessageCountForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 59);
static final int TRANSACTION_getNetworkType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 60);
static final int TRANSACTION_getNetworkTypeForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 61);
static final int TRANSACTION_getDataNetworkType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 62);
static final int TRANSACTION_getDataNetworkTypeForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
static final int TRANSACTION_getVoiceNetworkTypeForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 64);
static final int TRANSACTION_hasIccCard = (android.os.IBinder.FIRST_CALL_TRANSACTION + 65);
static final int TRANSACTION_hasIccCardUsingSlotId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 66);
static final int TRANSACTION_getLteOnCdmaMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 67);
static final int TRANSACTION_getLteOnCdmaModeForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 68);
static final int TRANSACTION_getAllCellInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 69);
static final int TRANSACTION_setCellInfoListRate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 70);
static final int TRANSACTION_getDefaultSim = (android.os.IBinder.FIRST_CALL_TRANSACTION + 71);
static final int TRANSACTION_iccOpenLogicalChannel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 72);
static final int TRANSACTION_iccCloseLogicalChannel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 73);
static final int TRANSACTION_iccTransmitApduLogicalChannel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 74);
static final int TRANSACTION_iccTransmitApduBasicChannel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 75);
static final int TRANSACTION_iccExchangeSimIO = (android.os.IBinder.FIRST_CALL_TRANSACTION + 76);
static final int TRANSACTION_sendEnvelopeWithStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 77);
static final int TRANSACTION_nvReadItem = (android.os.IBinder.FIRST_CALL_TRANSACTION + 78);
static final int TRANSACTION_nvWriteItem = (android.os.IBinder.FIRST_CALL_TRANSACTION + 79);
static final int TRANSACTION_nvWriteCdmaPrl = (android.os.IBinder.FIRST_CALL_TRANSACTION + 80);
static final int TRANSACTION_nvResetConfig = (android.os.IBinder.FIRST_CALL_TRANSACTION + 81);
static final int TRANSACTION_getCalculatedPreferredNetworkType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 82);
static final int TRANSACTION_getPreferredNetworkType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 83);
static final int TRANSACTION_getTetherApnRequired = (android.os.IBinder.FIRST_CALL_TRANSACTION + 84);
static final int TRANSACTION_setNetworkSelectionModeAutomatic = (android.os.IBinder.FIRST_CALL_TRANSACTION + 85);
static final int TRANSACTION_getCellNetworkScanResults = (android.os.IBinder.FIRST_CALL_TRANSACTION + 86);
static final int TRANSACTION_setNetworkSelectionModeManual = (android.os.IBinder.FIRST_CALL_TRANSACTION + 87);
static final int TRANSACTION_setPreferredNetworkType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 88);
static final int TRANSACTION_setDataEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 89);
static final int TRANSACTION_getDataEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 90);
static final int TRANSACTION_getPcscfAddress = (android.os.IBinder.FIRST_CALL_TRANSACTION + 91);
static final int TRANSACTION_setImsRegistrationState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 92);
static final int TRANSACTION_getCdmaMdn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 93);
static final int TRANSACTION_getCdmaMin = (android.os.IBinder.FIRST_CALL_TRANSACTION + 94);
static final int TRANSACTION_getCarrierPrivilegeStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 95);
static final int TRANSACTION_checkCarrierPrivilegesForPackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 96);
static final int TRANSACTION_checkCarrierPrivilegesForPackageAnyPhone = (android.os.IBinder.FIRST_CALL_TRANSACTION + 97);
static final int TRANSACTION_getCarrierPackageNamesForIntentAndPhone = (android.os.IBinder.FIRST_CALL_TRANSACTION + 98);
static final int TRANSACTION_setLine1NumberForDisplayForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 99);
static final int TRANSACTION_getLine1NumberForDisplay = (android.os.IBinder.FIRST_CALL_TRANSACTION + 100);
static final int TRANSACTION_getLine1AlphaTagForDisplay = (android.os.IBinder.FIRST_CALL_TRANSACTION + 101);
static final int TRANSACTION_getMergedSubscriberIds = (android.os.IBinder.FIRST_CALL_TRANSACTION + 102);
static final int TRANSACTION_setOperatorBrandOverride = (android.os.IBinder.FIRST_CALL_TRANSACTION + 103);
static final int TRANSACTION_setRoamingOverride = (android.os.IBinder.FIRST_CALL_TRANSACTION + 104);
static final int TRANSACTION_invokeOemRilRequestRaw = (android.os.IBinder.FIRST_CALL_TRANSACTION + 105);
static final int TRANSACTION_needMobileRadioShutdown = (android.os.IBinder.FIRST_CALL_TRANSACTION + 106);
static final int TRANSACTION_shutdownMobileRadios = (android.os.IBinder.FIRST_CALL_TRANSACTION + 107);
static final int TRANSACTION_setRadioCapability = (android.os.IBinder.FIRST_CALL_TRANSACTION + 108);
static final int TRANSACTION_getRadioAccessFamily = (android.os.IBinder.FIRST_CALL_TRANSACTION + 109);
static final int TRANSACTION_enableVideoCalling = (android.os.IBinder.FIRST_CALL_TRANSACTION + 110);
static final int TRANSACTION_isVideoCallingEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 111);
static final int TRANSACTION_canChangeDtmfToneLength = (android.os.IBinder.FIRST_CALL_TRANSACTION + 112);
static final int TRANSACTION_isWorldPhone = (android.os.IBinder.FIRST_CALL_TRANSACTION + 113);
static final int TRANSACTION_isTtyModeSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 114);
static final int TRANSACTION_isHearingAidCompatibilitySupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 115);
static final int TRANSACTION_isImsRegistered = (android.os.IBinder.FIRST_CALL_TRANSACTION + 116);
static final int TRANSACTION_isWifiCallingAvailable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 117);
static final int TRANSACTION_isVolteAvailable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 118);
static final int TRANSACTION_isVideoTelephonyAvailable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 119);
static final int TRANSACTION_getDeviceId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 120);
static final int TRANSACTION_getSubIdForPhoneAccount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 121);
static final int TRANSACTION_factoryReset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 122);
static final int TRANSACTION_getLocaleFromDefaultSim = (android.os.IBinder.FIRST_CALL_TRANSACTION + 123);
static final int TRANSACTION_getModemActivityInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 124);
static final int TRANSACTION_getIccAtr = (android.os.IBinder.FIRST_CALL_TRANSACTION + 125);
static final int TRANSACTION_iccOpenLogicalChannelWithSW = (android.os.IBinder.FIRST_CALL_TRANSACTION + 126);
static final int TRANSACTION_iccExchangeSimIOUsingSlot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 127);
static final int TRANSACTION_iccExchangeSimIOExUsingSlot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 128);
static final int TRANSACTION_iccOpenLogicalChannelUsingSlot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 129);
static final int TRANSACTION_iccCloseLogicalChannelUsingSlot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 130);
static final int TRANSACTION_iccTransmitApduLogicalChannelUsingSlot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 131);
static final int TRANSACTION_iccTransmitApduBasicChannelUsingSlot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 132);
static final int TRANSACTION_setPolicyDataEnableForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 133);
}
/**
     * Dial a number. This doesn't place the call. It displays
     * the Dialer screen.
...
/**
     * Returns the data activity for a subId.
     */
public int getDataActivityForSubscriber(int subId) throws android.os.RemoteException;
/**
     * Returns the data state.
     */
...
/**
     * Returns the data state for a subId.
     */
public int getDataStateForSubscriber(int subId) throws android.os.RemoteException;
/**
     * Returns the current active phone type as integer.
     * Returns TelephonyManager.PHONE_TYPE_CDMA if RILConstants.CDMA_PHONE
     * and TelephonyManager.PHONE_TYPE_GSM if RILConstants.GSM_PHONE
...
/**
     ...
     * @return true if the request suceeded.
     */
public boolean setNetworkSelectionModeManual(int subId, com.android.internal.telephony.OperatorInfo operator) throws android.os.RemoteException;
/**
     * Set the preferred network type.
     * Used for device configuration by some CDMA operators.
     *
...
public java.lang.String getIccAtr(int slotId) throws android.os.RemoteException;
public byte[] iccOpenLogicalChannelWithSW(int slotId, java.lang.String AID) throws android.os.RemoteException;
public byte[] iccExchangeSimIOUsingSlot(int slotId, int fileID, int command, int p1, int p2, int p3, java.lang.String filePath) throws android.os.RemoteException;
public byte[] iccExchangeSimIOExUsingSlot(int slotId, int fileID, int command, int p1, int p2, int p3, java.lang.String filePath, java.lang.String data, java.lang.String pin2) throws android.os.RemoteException;
/**
     * Opens a logical channel to the ICC card.
     *
     * Input parameters equivalent to TS 27.007 AT+CCHO command.
     ...
     * @return an IccOpenLogicalChannelResponse object.
     */
public android.telephony.IccOpenLogicalChannelResponse iccOpenLogicalChannelUsingSlot(int slotId, java.lang.String AID) throws android.os.RemoteException;
/**
     * Closes a previously opened logical channel to the ICC card.
     *
     * Input parameters equivalent to TS 27.007 AT+CCHC command.
     ...
     * @return true if the channel was closed successfully.
     */
public boolean iccCloseLogicalChannelUsingSlot(int slotId, int channel) throws android.os.RemoteException;
/**
     * Transmit an APDU to the ICC card over a logical channel.
     *
     * Input parameters equivalent to TS 27.007 AT+CGLA command.
     ...
     *            the end. If an error occurs, an empty string is returned.
     */
public java.lang.String iccTransmitApduLogicalChannelUsingSlot(int slotId, int channel, int cla, int instruction, int p1, int p2, int p3, java.lang.String data) throws android.os.RemoteException;
public java.lang.String iccTransmitApduBasicChannelUsingSlot(int slotId, int cla, int command, int p1, int p2, int p3, java.lang.String data) throws android.os.RemoteException;
public void setPolicyDataEnableForSubscriber(int subId, boolean enabled) throws android.os.RemoteException;
}
