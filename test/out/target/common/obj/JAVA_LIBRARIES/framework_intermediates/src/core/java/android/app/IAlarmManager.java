...
android.os.WorkSource _arg6;
if ((0!=data.readInt())) {
_arg6 = android.os.WorkSource.CREATOR.createFromParcel(data);
}
else {
_arg6 = null;
}
android.app.AlarmManager.AlarmClockInfo _arg7;
if ((0!=data.readInt())) {
_arg7 = android.app.AlarmManager.AlarmClockInfo.CREATOR.createFromParcel(data);
}
else {
_arg7 = null;
}
this.set(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7);
...
case TRANSACTION_cancelPoweroffAlarm:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
this.cancelPoweroffAlarm(_arg0);
reply.writeNoException();
return true;
}
case TRANSACTION_removeFromAms:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
this.removeFromAms(_arg0);
reply.writeNoException();
return true;
}
case TRANSACTION_lookForPackageFromAms:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
boolean _result = this.lookForPackageFromAms(_arg0);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
@Override public void set(int type, long triggerAtTime, long windowLength, long interval, int flags, android.app.PendingIntent operation, android.os.WorkSource workSource, android.app.AlarmManager.AlarmClockInfo alarmClock) throws android.os.RemoteException
{
...
@Override public void cancelPoweroffAlarm(java.lang.String name) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_cancelPoweroffAlarm, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void removeFromAms(java.lang.String packageName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_removeFromAms, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public boolean lookForPackageFromAms(java.lang.String packageName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(packageName);
mRemote.transact(Stub.TRANSACTION_lookForPackageFromAms, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
static final int TRANSACTION_cancelPoweroffAlarm = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_removeFromAms = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_lookForPackageFromAms = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
}
/** windowLength == 0 means exact; windowLength < 0 means the let the OS decide */
public void set(int type, long triggerAtTime, long windowLength, long interval, int flags, android.app.PendingIntent operation, android.os.WorkSource workSource, android.app.AlarmManager.AlarmClockInfo alarmClock) throws android.os.RemoteException;
...
public void cancelPoweroffAlarm(java.lang.String name) throws android.os.RemoteException;
public void removeFromAms(java.lang.String packageName) throws android.os.RemoteException;
public boolean lookForPackageFromAms(java.lang.String packageName) throws android.os.RemoteException;
}
