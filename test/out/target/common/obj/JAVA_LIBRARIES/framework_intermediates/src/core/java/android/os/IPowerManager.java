...
case TRANSACTION_startBacklight:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
this.startBacklight(_arg0);
reply.writeNoException();
return true;
}
case TRANSACTION_stopBacklight:
{
data.enforceInterface(DESCRIPTOR);
this.stopBacklight();
reply.writeNoException();
...
case TRANSACTION_wakeUpByReason:
{
data.enforceInterface(DESCRIPTOR);
long _arg0;
_arg0 = data.readLong();
int _arg1;
_arg1 = data.readInt();
this.wakeUpByReason(_arg0, _arg1);
reply.writeNoException();
return true;
}
...
@Override public void startBacklight(int msec) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(msec);
mRemote.transact(Stub.TRANSACTION_startBacklight, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void stopBacklight() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_stopBacklight, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void wakeUpByReason(long time, int reason) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeLong(time);
_data.writeInt(reason);
mRemote.transact(Stub.TRANSACTION_wakeUpByReason, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void setBacklightOffForWfd(boolean enable) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_startBacklight = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_stopBacklight = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_wakeUpByReason = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_nap = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_isInteractive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_isPowerSaveMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_setPowerSaveMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_isDeviceIdleMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
...
static final int TRANSACTION_setStayOnSetting = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_boostScreenBrightness = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_isScreenBrightnessBoosted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_setTemporaryScreenBrightnessSettingOverride = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_setTemporaryScreenAutoBrightnessAdjustmentSettingOverride = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_setBacklightOffForWfd = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
...
public void startBacklight(int msec) throws android.os.RemoteException;
public void stopBacklight() throws android.os.RemoteException;
public void wakeUpByReason(long time, int reason) throws android.os.RemoteException;
...
public void setBacklightOffForWfd(boolean enable) throws android.os.RemoteException;
// sets the attention light (used by phone app only)
