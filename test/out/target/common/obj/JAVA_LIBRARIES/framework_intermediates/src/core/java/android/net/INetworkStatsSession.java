...
case TRANSACTION_getMobileTotalBytes:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
long _arg2;
_arg2 = data.readLong();
long _result = this.getMobileTotalBytes(_arg0, _arg1, _arg2);
reply.writeNoException();
...
@Override public long getMobileTotalBytes(int subSim, long start_time, long end_time) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
long _result;
...
mRemote.transact(Stub.TRANSACTION_getMobileTotalBytes, _data, _reply, 0);
_reply.readException();
...
static final int TRANSACTION_getMobileTotalBytes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
}
/** Return device aggregated network layer usage summary for traffic that matches template. */
...
/**M: Return usage summary for sim slot. */
public long getMobileTotalBytes(int subSim, long start_time, long end_time) throws android.os.RemoteException;
}
