...
int _arg3;
_arg3 = data.readInt();
boolean _result = this.setPasskeyEx(_arg0, _arg1, _arg2, _arg3);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
mRemote.transact(Stub.TRANSACTION_sdpSearch, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
@Override public boolean setPasskeyEx(android.bluetooth.BluetoothDevice device, boolean accept, int len, int passkey) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
mRemote.transact(Stub.TRANSACTION_setPasskeyEx, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
mRemote.transact(Stub.TRANSACTION_getSimAccessPermission, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
_data.writeInt(value);
mRemote.transact(Stub.TRANSACTION_setSimAccessPermission, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
@Override public void dump(android.os.ParcelFileDescriptor fd) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_onLeServiceUp, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_sdpSearch = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
...
static final int TRANSACTION_setPasskeyEx = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_setPairingConfirmation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_getPhonebookAccessPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_setPhonebookAccessPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_getMessageAccessPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_setMessageAccessPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_getSimAccessPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_setSimAccessPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_sendConnectionStateChange = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_registerCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_unregisterCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_connectSocket = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_createSocketChannel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_configHciSnoopLog = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_factoryReset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_isMultiAdvertisementSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_isPeripheralModeSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_isOffloadedFilteringSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
static final int TRANSACTION_isOffloadedScanBatchingSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
static final int TRANSACTION_isActivityAndEnergyReportingSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_getActivityEnergyInfoFromController = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
static final int TRANSACTION_reportActivityInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
static final int TRANSACTION_dump = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
static final int TRANSACTION_onLeServiceUp = (android.os.IBinder.FIRST_CALL_TRANSACTION + 57);
static final int TRANSACTION_onBrEdrDown = (android.os.IBinder.FIRST_CALL_TRANSACTION + 58);
}
...
public boolean setPasskeyEx(android.bluetooth.BluetoothDevice device, boolean accept, int len, int passkey) throws android.os.RemoteException;
...
public void dump(android.os.ParcelFileDescriptor fd) throws android.os.RemoteException;
