...
if ((0!=data.readInt())) {
_arg1 = com.android.ims.ImsSuppServiceNotification.CREATOR.createFromParcel(data);
}
else {
_arg1 = null;
}
...
case TRANSACTION_callSessionPauInfoChanged:
{
data.enforceInterface(DESCRIPTOR);
com.android.ims.internal.IImsCallSession _arg0;
_arg0 = com.android.ims.internal.IImsCallSession.Stub.asInterface(data.readStrongBinder());
...
this.callSessionPauInfoChanged(_arg0, _arg1);
reply.writeNoException();
return true;
}
}
...
mRemote.transact(Stub.TRANSACTION_callSessionMultipartyStateChanged, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
/**
     ...
     */
@Override public void callSessionSuppServiceReceived(com.android.ims.internal.IImsCallSession session, com.android.ims.ImsSuppServiceNotification suppSrvNotification) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_callSessionSuppServiceReceived, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
/**
     ...
     * @hide
     */
@Override public void callSessionPauInfoChanged(com.android.ims.internal.IImsCallSession session, com.android.ims.ImsCallProfile profile) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_callSessionPauInfoChanged, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_callSessionMultipartyStateChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_callSessionSuppServiceReceived = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_callSessionPauInfoChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
}
/**
     * Notifies the result of the basic session operation (setup / terminate).
     */
...
/**
     * Notifies the supplementary service information for the current session.
     */
public void callSessionSuppServiceReceived(com.android.ims.internal.IImsCallSession session, com.android.ims.ImsSuppServiceNotification suppSrvNotification) throws android.os.RemoteException;
/// M: ALPS02256671. PAU update. @{
/**
     * Notifies of a change to the PAU information for this {@code ImsCallSession}.
     *
     ...
     * @hide
     */
public void callSessionPauInfoChanged(com.android.ims.internal.IImsCallSession session, com.android.ims.ImsCallProfile profile) throws android.os.RemoteException;
}
