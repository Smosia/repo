...
case TRANSACTION_removeAllNotifications:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
int _arg1;
_arg1 = data.readInt();
this.removeAllNotifications(_arg0, _arg1);
reply.writeNoException();
return true;
}
...
@Override public void removeAllNotifications(java.lang.String pkg, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeString(pkg);
_data.writeInt(userId);
mRemote.transact(Stub.TRANSACTION_removeAllNotifications, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_removeAllNotifications = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_cancelNotificationsFromListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_cancelNotificationFromListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_setNotificationsShownFromListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_getActiveNotificationsFromListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_requestHintsFromListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_getHintsFromListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_requestInterruptionFilterFromListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_getInterruptionFilterFromListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_setOnNotificationPostedTrimFromListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_setInterruptionFilter = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_getEffectsSuppressor = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_matchesCallFilter = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_isSystemConditionProviderEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_getZenMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_getZenModeConfig = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_setZenModeConfig = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_setZenMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_notifyConditions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_requestZenModeConditions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_isNotificationPolicyAccessGranted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_getNotificationPolicy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_setNotificationPolicy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_getPackagesRequestingNotificationPolicyAccess = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_isNotificationPolicyAccessGrantedForPackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_setNotificationPolicyAccessGranted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_getBackupPayload = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_applyRestore = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_getAppActiveNotifications = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
}
...
public void removeAllNotifications(java.lang.String pkg, int userId) throws android.os.RemoteException;
