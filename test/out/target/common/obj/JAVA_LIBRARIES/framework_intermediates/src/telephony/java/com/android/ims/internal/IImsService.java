...
case TRANSACTION_setCallIndication:
{
data.enforceInterface(DESCRIPTOR);
...
this.setCallIndication(_arg0, _arg1, _arg2, _arg3);
reply.writeNoException();
return true;
}
case TRANSACTION_getImsState:
{
data.enforceInterface(DESCRIPTOR);
int _result = this.getImsState();
reply.writeNoException();
reply.writeInt(_result);
return true;
}
case TRANSACTION_getImsRegInfo:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
boolean _result = this.getImsRegInfo(_arg0);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
case TRANSACTION_getImsExtInfo:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _result = this.getImsExtInfo();
reply.writeNoException();
reply.writeString(_result);
return true;
}
case TRANSACTION_hangupAllCall:
{
data.enforceInterface(DESCRIPTOR);
this.hangupAllCall();
reply.writeNoException();
...
case TRANSACTION_getRegistrationStatus:
{
data.enforceInterface(DESCRIPTOR);
int _result = this.getRegistrationStatus();
reply.writeNoException();
reply.writeInt(_result);
return true;
}
...
/**
     ...
     */
@Override public void setCallIndication(java.lang.String callId, java.lang.String callNum, int seqNum, boolean isAllow) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_setCallIndication, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
/**
     ...
     */
@Override public int getImsState() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getImsState, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
/**
     ...
     */
@Override public boolean getImsRegInfo(int phoneId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(phoneId);
mRemote.transact(Stub.TRANSACTION_getImsRegInfo, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
/**
     ...
     */
@Override public java.lang.String getImsExtInfo() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getImsExtInfo, _data, _reply, 0);
_reply.readException();
...
/**
     ...
     */
@Override public void hangupAllCall() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_hangupAllCall, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
/**
     ...
     */
@Override public int getRegistrationStatus() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getRegistrationStatus, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
static final int TRANSACTION_setCallIndication = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_getImsState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_getImsRegInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_getImsExtInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_hangupAllCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_getRegistrationStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
}
...
/**
     * call interface for allowing/refusing the incoming call indication send to App.
     */
public void setCallIndication(java.lang.String callId, java.lang.String callNum, int seqNum, boolean isAllow) throws android.os.RemoteException;
/**
     * Use to query ims enable/disable status.
     */
public int getImsState() throws android.os.RemoteException;
/**
     * Use to query ims registration information.
     */
public boolean getImsRegInfo(int phoneId) throws android.os.RemoteException;
/**
     * Use to query ims registration extension information.
     */
public java.lang.String getImsExtInfo() throws android.os.RemoteException;
/**
     * Use to hang up all calls.
     */
