 ...
 * Original file: frameworks/base/telephony/java/com/android/ims/internal/IImsUtListener.aidl
 */
...
case TRANSACTION_utConfigurationCallForwardInTimeSlotQueried:
{
data.enforceInterface(DESCRIPTOR);
com.android.ims.internal.IImsUt _arg0;
_arg0 = com.android.ims.internal.IImsUt.Stub.asInterface(data.readStrongBinder());
int _arg1;
_arg1 = data.readInt();
com.android.ims.ImsCallForwardInfoEx[] _arg2;
_arg2 = data.createTypedArray(com.android.ims.ImsCallForwardInfoEx.CREATOR);
this.utConfigurationCallForwardInTimeSlotQueried(_arg0, _arg1, _arg2);
reply.writeNoException();
return true;
}
}
...
/**
     ...
     */
@Override public void utConfigurationCallForwardInTimeSlotQueried(com.android.ims.internal.IImsUt ut, int id, com.android.ims.ImsCallForwardInfoEx[] cfInfo) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeInt(id);
_data.writeTypedArray(cfInfo, 0);
mRemote.transact(Stub.TRANSACTION_utConfigurationCallForwardInTimeSlotQueried, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_utConfigurationCallForwardInTimeSlotQueried = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
}
/**
     * Notifies the result of the supplementary service configuration udpate.
     */
...
/**
     * Notifies the status of the call forwarding in a time slot supplementary service.
     */
public void utConfigurationCallForwardInTimeSlotQueried(com.android.ims.internal.IImsUt ut, int id, com.android.ims.ImsCallForwardInfoEx[] cfInfo) throws android.os.RemoteException;
}
