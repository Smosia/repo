...
case TRANSACTION_getFocusAppPid:
{
data.enforceInterface(DESCRIPTOR);
int _result = this.getFocusAppPid();
reply.writeNoException();
...
@Override public int getFocusAppPid() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getFocusAppPid, _data, _reply, 0);
_reply.readException();
...
static final int TRANSACTION_getFocusAppPid = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
}
