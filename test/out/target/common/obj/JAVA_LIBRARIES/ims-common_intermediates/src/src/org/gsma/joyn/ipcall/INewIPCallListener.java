 ...
 * Original file: frameworks/opt/net/ims/src/org/gsma/joyn/ipcall/INewIPCallListener.aidl
 */
...
case TRANSACTION_onNewIPCall:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
this.onNewIPCall(_arg0);
...
@Override public void onNewIPCall(java.lang.String callId) throws android.os.RemoteException
{
...
mRemote.transact(Stub.TRANSACTION_onNewIPCall, _data, _reply, 0);
...
static final int TRANSACTION_onNewIPCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
}
public void onNewIPCall(java.lang.String callId) throws android.os.RemoteException;
}
