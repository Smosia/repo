 ...
 * Original file: frameworks/opt/net/ims/src/org/gsma/joyn/vsh/IVideoRenderer.aidl
 */
package org.gsma.joyn.vsh;
/**
 * Video renderer interface
 */
public interface IVideoRenderer extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements org.gsma.joyn.vsh.IVideoRenderer
{
private static final java.lang.String DESCRIPTOR = "org.gsma.joyn.vsh.IVideoRenderer";
...
/**
 * Cast an IBinder object into an org.gsma.joyn.vsh.IVideoRenderer interface,
 * generating a proxy if needed.
 */
public static org.gsma.joyn.vsh.IVideoRenderer asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof org.gsma.joyn.vsh.IVideoRenderer))) {
return ((org.gsma.joyn.vsh.IVideoRenderer)iin);
}
return new org.gsma.joyn.vsh.IVideoRenderer.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
org.gsma.joyn.vsh.IVideoRendererListener _arg0;
_arg0 = org.gsma.joyn.vsh.IVideoRendererListener.Stub.asInterface(data.readStrongBinder());
...
case TRANSACTION_setOrientationHeaderId:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
this.setOrientationHeaderId(_arg0);
reply.writeNoException();
return true;
}
}
...
private static class Proxy implements org.gsma.joyn.vsh.IVideoRenderer
{
...
@Override public void addEventListener(org.gsma.joyn.vsh.IVideoRendererListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void removeEventListener(org.gsma.joyn.vsh.IVideoRendererListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void setOrientationHeaderId(int headerId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_setOrientationHeaderId, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_setOrientationHeaderId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
}
...
public void addEventListener(org.gsma.joyn.vsh.IVideoRendererListener listener) throws android.os.RemoteException;
public void removeEventListener(org.gsma.joyn.vsh.IVideoRendererListener listener) throws android.os.RemoteException;
public void setOrientationHeaderId(int headerId) throws android.os.RemoteException;
}
