 ...
 * Original file: frameworks/opt/net/ims/src/org/gsma/joyn/session/IMultimediaSession.aidl
 */
...
@Override public boolean sendMessage(byte[] content) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
static final int TRANSACTION_abortSession = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
...
public boolean sendMessage(byte[] content) throws android.os.RemoteException;
}
