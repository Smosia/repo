 ...
 * Original file: frameworks/opt/net/ims/src/org/gsma/joyn/session/IMultimediaSessionService.aidl
 */
...
org.gsma.joyn.session.IMultimediaSessionListener _arg2;
_arg2 = org.gsma.joyn.session.IMultimediaSessionListener.Stub.asInterface(data.readStrongBinder());
org.gsma.joyn.session.IMultimediaSession _result = this.initiateSession(_arg0, _arg1, _arg2);
reply.writeNoException();
reply.writeStrongBinder((((_result!=null))?(_result.asBinder()):(null)));
return true;
}
...
boolean _result = this.sendMessage(_arg0, _arg1, _arg2);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
@Override public org.gsma.joyn.session.IMultimediaSession initiateSession(java.lang.String serviceId, java.lang.String contact, org.gsma.joyn.session.IMultimediaSessionListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
org.gsma.joyn.session.IMultimediaSession _result;
...
@Override public boolean sendMessage(java.lang.String serviceId, java.lang.String contact, byte[] content) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
public org.gsma.joyn.session.IMultimediaSession initiateSession(java.lang.String serviceId, java.lang.String contact, org.gsma.joyn.session.IMultimediaSessionListener listener) throws android.os.RemoteException;
public boolean sendMessage(java.lang.String serviceId, java.lang.String contact, byte[] content) throws android.os.RemoteException;
