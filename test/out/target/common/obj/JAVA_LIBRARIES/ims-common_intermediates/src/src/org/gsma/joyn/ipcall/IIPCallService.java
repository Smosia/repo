 ...
 * Original file: frameworks/opt/net/ims/src/org/gsma/joyn/ipcall/IIPCallService.aidl
 */
...
case TRANSACTION_initiateVisioCall:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
...
org.gsma.joyn.ipcall.IIPCallListener _arg3;
_arg3 = org.gsma.joyn.ipcall.IIPCallListener.Stub.asInterface(data.readStrongBinder());
org.gsma.joyn.ipcall.IIPCall _result = this.initiateVisioCall(_arg0, _arg1, _arg2, _arg3);
reply.writeNoException();
reply.writeStrongBinder((((_result!=null))?(_result.asBinder()):(null)));
return true;
}
...
@Override public org.gsma.joyn.ipcall.IIPCall initiateVisioCall(java.lang.String contact, org.gsma.joyn.ipcall.IIPCallPlayer player, org.gsma.joyn.ipcall.IIPCallRenderer renderer, org.gsma.joyn.ipcall.IIPCallListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
org.gsma.joyn.ipcall.IIPCall _result;
...
_data.writeStrongBinder((((renderer!=null))?(renderer.asBinder()):(null)));
_data.writeStrongBinder((((listener!=null))?(listener.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_initiateVisioCall, _data, _reply, 0);
_reply.readException();
_result = org.gsma.joyn.ipcall.IIPCall.Stub.asInterface(_reply.readStrongBinder());
}
finally {
...
static final int TRANSACTION_initiateVisioCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_addNewIPCallListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_removeNewIPCallListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_getServiceVersion = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
}
...
public org.gsma.joyn.ipcall.IIPCall initiateVisioCall(java.lang.String contact, org.gsma.joyn.ipcall.IIPCallPlayer player, org.gsma.joyn.ipcall.IIPCallRenderer renderer, org.gsma.joyn.ipcall.IIPCallListener listener) throws android.os.RemoteException;
