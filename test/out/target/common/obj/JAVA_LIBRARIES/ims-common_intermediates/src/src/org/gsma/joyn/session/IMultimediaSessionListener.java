 ...
 * Original file: frameworks/opt/net/ims/src/org/gsma/joyn/session/IMultimediaSessionListener.aidl
 */
...
@Override public void onNewMessage(byte[] content) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void onNewMessage(byte[] content) throws android.os.RemoteException;
}
