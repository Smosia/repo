 ...
 * Original file: frameworks/opt/net/ims/src/org/gsma/joyn/ft/IFileTransferListener.aidl
 */
...
case TRANSACTION_onTransferPaused:
{
data.enforceInterface(DESCRIPTOR);
...
case TRANSACTION_onTransferResumed:
{
data.enforceInterface(DESCRIPTOR);
...
this.onTransferResumed(_arg0, _arg1);
reply.writeNoException();
return true;
}
...
@Override public void onTransferPaused() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_onTransferPaused, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void onTransferResumed(java.lang.String oldFileTransferId, java.lang.String newFileTransferId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_onTransferResumed, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_onTransferPaused = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_onTransferResumed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_onTransferError = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_onTransferProgress = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_onFileTransferred = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
}
...
public void onTransferResumed(java.lang.String oldFileTransferId, java.lang.String newFileTransferId) throws android.os.RemoteException;
