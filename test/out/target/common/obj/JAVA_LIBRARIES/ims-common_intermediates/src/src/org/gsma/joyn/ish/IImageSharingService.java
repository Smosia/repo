 ...
 * Original file: frameworks/opt/net/ims/src/org/gsma/joyn/ish/IImageSharingService.aidl
 */
...
case TRANSACTION_getJoynAccountViaNumber:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
java.lang.String _result = this.getJoynAccountViaNumber(_arg0);
reply.writeNoException();
...
@Override public java.lang.String getJoynAccountViaNumber(java.lang.String number) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
mRemote.transact(Stub.TRANSACTION_getJoynAccountViaNumber, _data, _reply, 0);
_reply.readException();
...
static final int TRANSACTION_getJoynAccountViaNumber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_getImageSharing = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_shareImage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_addNewImageSharingListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_removeNewImageSharingListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
...
public java.lang.String getJoynAccountViaNumber(java.lang.String number) throws android.os.RemoteException;
