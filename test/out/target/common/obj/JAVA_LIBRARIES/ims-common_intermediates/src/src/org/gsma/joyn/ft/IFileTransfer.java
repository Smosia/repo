 ...
 * Original file: frameworks/opt/net/ims/src/org/gsma/joyn/ft/IFileTransfer.aidl
 */
...
case TRANSACTION_isHttpFileTransfer:
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.isHttpFileTransfer();
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
case TRANSACTION_getTransferDuration:
{
data.enforceInterface(DESCRIPTOR);
int _result = this.getTransferDuration();
reply.writeNoException();
reply.writeInt(_result);
return true;
}
...
case TRANSACTION_pauseTransfer:
{
data.enforceInterface(DESCRIPTOR);
this.pauseTransfer();
reply.writeNoException();
...
case TRANSACTION_resumeTransfer:
{
data.enforceInterface(DESCRIPTOR);
this.resumeTransfer();
reply.writeNoException();
...
@Override public boolean isHttpFileTransfer() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isHttpFileTransfer, _data, _reply, 0);
_reply.readException();
...
@Override public int getTransferDuration() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getTransferDuration, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
@Override public void pauseTransfer() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_pauseTransfer, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void resumeTransfer() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_resumeTransfer, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_isHttpFileTransfer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_getTransferDuration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_acceptInvitation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_rejectInvitation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_abortTransfer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_pauseTransfer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_resumeTransfer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_addEventListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_removeEventListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
}
