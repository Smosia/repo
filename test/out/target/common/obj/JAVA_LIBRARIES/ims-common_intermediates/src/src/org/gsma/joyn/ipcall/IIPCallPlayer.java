 ...
 * Original file: frameworks/opt/net/ims/src/org/gsma/joyn/ipcall/IIPCallPlayer.aidl
 */
package org.gsma.joyn.ipcall;
/**
 * IP call player interface
 */
public interface IIPCallPlayer extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements org.gsma.joyn.ipcall.IIPCallPlayer
{
private static final java.lang.String DESCRIPTOR = "org.gsma.joyn.ipcall.IIPCallPlayer";
...
/**
 * Cast an IBinder object into an org.gsma.joyn.ipcall.IIPCallPlayer interface,
 * generating a proxy if needed.
 */
public static org.gsma.joyn.ipcall.IIPCallPlayer asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof org.gsma.joyn.ipcall.IIPCallPlayer))) {
return ((org.gsma.joyn.ipcall.IIPCallPlayer)iin);
}
return new org.gsma.joyn.ipcall.IIPCallPlayer.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
org.gsma.joyn.ipcall.IIPCallPlayerListener _arg0;
_arg0 = org.gsma.joyn.ipcall.IIPCallPlayerListener.Stub.asInterface(data.readStrongBinder());
...
private static class Proxy implements org.gsma.joyn.ipcall.IIPCallPlayer
{
...
@Override public void addEventListener(org.gsma.joyn.ipcall.IIPCallPlayerListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void removeEventListener(org.gsma.joyn.ipcall.IIPCallPlayerListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void addEventListener(org.gsma.joyn.ipcall.IIPCallPlayerListener listener) throws android.os.RemoteException;
public void removeEventListener(org.gsma.joyn.ipcall.IIPCallPlayerListener listener) throws android.os.RemoteException;
}
