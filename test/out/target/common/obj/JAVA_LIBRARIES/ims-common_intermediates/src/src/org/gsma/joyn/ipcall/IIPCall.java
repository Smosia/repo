 ...
 * Original file: frameworks/opt/net/ims/src/org/gsma/joyn/ipcall/IIPCall.aidl
 */
...
case TRANSACTION_isVideo:
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.isVideo();
reply.writeNoException();
...
@Override public boolean isVideo() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isVideo, _data, _reply, 0);
_reply.readException();
...
static final int TRANSACTION_isVideo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_addVideo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_removeVideo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_isOnHold = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_holdCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_continueCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_addEventListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_removeEventListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
}
