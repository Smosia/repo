 ...
 * Original file: frameworks/opt/net/ims/src/org/gsma/joyn/vsh/IVideoRendererListener.aidl
 */
package org.gsma.joyn.vsh;
/**
 * Video renderer event listener interface
 */
public interface IVideoRendererListener extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements org.gsma.joyn.vsh.IVideoRendererListener
{
private static final java.lang.String DESCRIPTOR = "org.gsma.joyn.vsh.IVideoRendererListener";
...
/**
 * Cast an IBinder object into an org.gsma.joyn.vsh.IVideoRendererListener interface,
 * generating a proxy if needed.
 */
public static org.gsma.joyn.vsh.IVideoRendererListener asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof org.gsma.joyn.vsh.IVideoRendererListener))) {
return ((org.gsma.joyn.vsh.IVideoRendererListener)iin);
}
return new org.gsma.joyn.vsh.IVideoRendererListener.Stub.Proxy(obj);
}
...
case TRANSACTION_onRendererFailed:
{
data.enforceInterface(DESCRIPTOR);
this.onRendererFailed();
reply.writeNoException();
return true;
}
}
...
private static class Proxy implements org.gsma.joyn.vsh.IVideoRendererListener
{
...
@Override public void onRendererFailed() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_onRendererFailed, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_onRendererFailed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
}
