 ...
 * Original file: frameworks/opt/net/ims/src/org/gsma/joyn/ish/IImageSharing.aidl
 */
package org.gsma.joyn.ish;
/**
 * Image sharing interface
 */
public interface IImageSharing extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements org.gsma.joyn.ish.IImageSharing
{
private static final java.lang.String DESCRIPTOR = "org.gsma.joyn.ish.IImageSharing";
...
/**
 * Cast an IBinder object into an org.gsma.joyn.ish.IImageSharing interface,
 * generating a proxy if needed.
 */
public static org.gsma.joyn.ish.IImageSharing asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof org.gsma.joyn.ish.IImageSharing))) {
return ((org.gsma.joyn.ish.IImageSharing)iin);
}
return new org.gsma.joyn.ish.IImageSharing.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
org.gsma.joyn.ish.IImageSharingListener _arg0;
_arg0 = org.gsma.joyn.ish.IImageSharingListener.Stub.asInterface(data.readStrongBinder());
...
private static class Proxy implements org.gsma.joyn.ish.IImageSharing
{
...
@Override public void addEventListener(org.gsma.joyn.ish.IImageSharingListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void removeEventListener(org.gsma.joyn.ish.IImageSharingListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void addEventListener(org.gsma.joyn.ish.IImageSharingListener listener) throws android.os.RemoteException;
public void removeEventListener(org.gsma.joyn.ish.IImageSharingListener listener) throws android.os.RemoteException;
}
