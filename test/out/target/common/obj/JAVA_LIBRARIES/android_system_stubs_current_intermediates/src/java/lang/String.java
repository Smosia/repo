...
public  String(byte[] data, int offset, int byteCount) { throw new RuntimeException("Stub!"); }
@java.lang.Deprecated()
public  String(byte[] data, int high, int offset, int byteCount) { throw new RuntimeException("Stub!"); }
public  String(byte[] data, int offset, int byteCount, java.lang.String charsetName) throws java.io.UnsupportedEncodingException { throw new RuntimeException("Stub!"); }
...
public  String(byte[] data, int offset, int byteCount, java.nio.charset.Charset charset) { throw new RuntimeException("Stub!"); }
...
public  String(char[] data, int offset, int charCount) { throw new RuntimeException("Stub!"); }
...
public  String(java.lang.StringBuilder stringBuilder) { throw new RuntimeException("Stub!"); }
...
public native  java.lang.String concat(java.lang.String string);
