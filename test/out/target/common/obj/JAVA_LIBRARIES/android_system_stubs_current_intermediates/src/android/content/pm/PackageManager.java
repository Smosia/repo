...
public abstract  void updatePermissionFlags(java.lang.String permissionName, java.lang.String packageName, int flagMask, int flagValues, android.os.UserHandle user);
...
public abstract  void verifyIntentFilter(int verificationId, int verificationCode, java.util.List<java.lang.String> outFailedDomains);
