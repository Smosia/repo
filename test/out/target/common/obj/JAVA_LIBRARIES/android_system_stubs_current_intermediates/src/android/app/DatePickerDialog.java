...
public  DatePickerDialog(android.content.Context context, android.app.DatePickerDialog.OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth) { super((android.content.Context)null,0); throw new RuntimeException("Stub!"); }
public  DatePickerDialog(android.content.Context context, int theme, android.app.DatePickerDialog.OnDateSetListener listener, int year, int monthOfYear, int dayOfMonth) { super((android.content.Context)null,0); throw new RuntimeException("Stub!"); }
