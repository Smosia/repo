...
public  void requestLocationUpdates(android.location.LocationRequest request, android.location.LocationListener listener, android.os.Looper looper) { throw new RuntimeException("Stub!"); }
public  void requestLocationUpdates(android.location.LocationRequest request, android.app.PendingIntent intent) { throw new RuntimeException("Stub!"); }
...
public  boolean addGpsMeasurementListener(android.location.GpsMeasurementsEvent.Listener listener) { throw new RuntimeException("Stub!"); }
public  void removeGpsMeasurementListener(android.location.GpsMeasurementsEvent.Listener listener) { throw new RuntimeException("Stub!"); }
public  boolean addGpsNavigationMessageListener(android.location.GpsNavigationMessageEvent.Listener listener) { throw new RuntimeException("Stub!"); }
public  void removeGpsNavigationMessageListener(android.location.GpsNavigationMessageEvent.Listener listener) { throw new RuntimeException("Stub!"); }
