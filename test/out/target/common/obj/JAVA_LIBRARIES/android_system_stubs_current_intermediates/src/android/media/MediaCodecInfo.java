...
public final  boolean isFeatureSupported(java.lang.String name) { throw new RuntimeException("Stub!"); }
public final  boolean isFeatureRequired(java.lang.String name) { throw new RuntimeException("Stub!"); }
public final  boolean isFormatSupported(android.media.MediaFormat format) { throw new RuntimeException("Stub!"); }
