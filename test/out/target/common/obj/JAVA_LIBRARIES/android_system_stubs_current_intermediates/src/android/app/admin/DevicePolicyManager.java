...
public  java.lang.String getDeviceOwner() { throw new RuntimeException("Stub!"); }
public  java.lang.String getDeviceInitializerApp() { throw new RuntimeException("Stub!"); }
public  android.content.ComponentName getDeviceInitializerComponent() { throw new RuntimeException("Stub!"); }
@Deprecated
public  boolean setActiveProfileOwner(android.content.ComponentName admin, java.lang.String ownerName) throws java.lang.IllegalArgumentException { throw new RuntimeException("Stub!"); }
...
public  android.content.ComponentName getProfileOwner() throws java.lang.IllegalArgumentException { throw new RuntimeException("Stub!"); }
public  java.lang.String getProfileOwnerNameAsUser(int userId) throws java.lang.IllegalArgumentException { throw new RuntimeException("Stub!"); }
...
public  java.util.List<java.lang.String> getPermittedAccessibilityServices(int userId) { throw new RuntimeException("Stub!"); }
...
public  java.util.List<java.lang.String> getPermittedInputMethodsForCurrentUser() { throw new RuntimeException("Stub!"); }
@java.lang.Deprecated()
public  android.os.UserHandle createUser(android.content.ComponentName admin, java.lang.String name) { throw new RuntimeException("Stub!"); }
@java.lang.Deprecated()
public  android.os.UserHandle createAndInitializeUser(android.content.ComponentName admin, java.lang.String name, java.lang.String ownerName, android.content.ComponentName profileOwnerComponent, android.os.Bundle adminExtras) { throw new RuntimeException("Stub!"); }
...
public  void notifyPendingSystemUpdate(long updateReceivedTime) { throw new RuntimeException("Stub!"); }
