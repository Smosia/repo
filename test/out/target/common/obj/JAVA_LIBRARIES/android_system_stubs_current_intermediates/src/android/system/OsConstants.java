...
static { AF_INET = 0; AF_INET6 = 0; AF_UNIX = 0; AF_UNSPEC = 0; AI_ADDRCONFIG = 0; AI_ALL = 0; AI_CANONNAME = 0; AI_NUMERICHOST = 0; AI_NUMERICSERV = 0; AI_PASSIVE = 0; AI_V4MAPPED = 0; CAP_AUDIT_CONTROL = 0; CAP_AUDIT_WRITE = 0; CAP_BLOCK_SUSPEND = 0; CAP_CHOWN = 0; CAP_DAC_OVERRIDE = 0; CAP_DAC_READ_SEARCH = 0; CAP_FOWNER = 0; CAP_FSETID = 0; CAP_IPC_LOCK = 0; CAP_IPC_OWNER = 0; CAP_KILL = 0; CAP_LAST_CAP = 0; CAP_LEASE = 0; CAP_LINUX_IMMUTABLE = 0; CAP_MAC_ADMIN = 0; CAP_MAC_OVERRIDE = 0; CAP_MKNOD = 0; CAP_NET_ADMIN = 0; CAP_NET_BIND_SERVICE = 0; CAP_NET_BROADCAST = 0; CAP_NET_RAW = 0; CAP_SETFCAP = 0; CAP_SETGID = 0; CAP_SETPCAP = 0; CAP_SETUID = 0; CAP_SYSLOG = 0; CAP_SYS_ADMIN = 0; CAP_SYS_BOOT = 0; CAP_SYS_CHROOT = 0; CAP_SYS_MODULE = 0; CAP_SYS_NICE = 0; CAP_SYS_PACCT = 0; CAP_SYS_PTRACE = 0; CAP_SYS_RAWIO = 0; CAP_SYS_RESOURCE = 0; CAP_SYS_TIME = 0; CAP_SYS_TTY_CONFIG = 0; CAP_WAKE_ALARM = 0; E2BIG = 0; EACCES = 0; EADDRINUSE = 0; EADDRNOTAVAIL = 0; EAFNOSUPPORT = 0; EAGAIN = 0; EAI_AGAIN = 0; EAI_BADFLAGS = 0; EAI_FAIL = 0; EAI_FAMILY = 0; EAI_MEMORY = 0; EAI_NODATA = 0; EAI_NONAME = 0; EAI_OVERFLOW = 0; EAI_SERVICE = 0; EAI_SOCKTYPE = 0; EAI_SYSTEM = 0; EALREADY = 0; EBADF = 0; EBADMSG = 0; EBUSY = 0; ECANCELED = 0; ECHILD = 0; ECONNABORTED = 0; ECONNREFUSED = 0; ECONNRESET = 0; EDEADLK = 0; EDESTADDRREQ = 0; EDOM = 0; EDQUOT = 0; EEXIST = 0; EFAULT = 0; EFBIG = 0; EHOSTUNREACH = 0; EIDRM = 0; EILSEQ = 0; EINPROGRESS = 0; EINTR = 0; EINVAL = 0; EIO = 0; EISCONN = 0; EISDIR = 0; ELOOP = 0; EMFILE = 0; EMLINK = 0; EMSGSIZE = 0; EMULTIHOP = 0; ENAMETOOLONG = 0; ENETDOWN = 0; ENETRESET = 0; ENETUNREACH = 0; ENFILE = 0; ENOBUFS = 0; ENODATA = 0; ENODEV = 0; ENOENT = 0; ENOEXEC = 0; ENOLCK = 0; ENOLINK = 0; ENOMEM = 0; ENOMSG = 0; ENOPROTOOPT = 0; ENOSPC = 0; ENOSR = 0; ENOSTR = 0; ENOSYS = 0; ENOTCONN = 0; ENOTDIR = 0; ENOTEMPTY = 0; ENOTSOCK = 0; ENOTSUP = 0; ENOTTY = 0; ENXIO = 0; EOPNOTSUPP = 0; EOVERFLOW = 0; EPERM = 0; EPIPE = 0; EPROTO = 0; EPROTONOSUPPORT = 0; EPROTOTYPE = 0; ERANGE = 0; EROFS = 0; ESPIPE = 0; ESRCH = 0; ESTALE = 0; ETIME = 0; ETIMEDOUT = 0; ETXTBSY = 0; EXDEV = 0; EXIT_FAILURE = 0; EXIT_SUCCESS = 0; FD_CLOEXEC = 0; FIONREAD = 0; F_DUPFD = 0; F_GETFD = 0; F_GETFL = 0; F_GETLK = 0; F_GETLK64 = 0; F_GETOWN = 0; F_OK = 0; F_RDLCK = 0; F_SETFD = 0; F_SETFL = 0; F_SETLK = 0; F_SETLK64 = 0; F_SETLKW = 0; F_SETLKW64 = 0; F_SETOWN = 0; F_UNLCK = 0; F_WRLCK = 0; IFA_F_DADFAILED = 0; IFA_F_DEPRECATED = 0; IFA_F_HOMEADDRESS = 0; IFA_F_NODAD = 0; IFA_F_OPTIMISTIC = 0; IFA_F_PERMANENT = 0; IFA_F_SECONDARY = 0; IFA_F_TEMPORARY = 0; IFA_F_TENTATIVE = 0; IFF_ALLMULTI = 0; IFF_AUTOMEDIA = 0; IFF_BROADCAST = 0; IFF_DEBUG = 0; IFF_DYNAMIC = 0; IFF_LOOPBACK = 0; IFF_MASTER = 0; IFF_MULTICAST = 0; IFF_NOARP = 0; IFF_NOTRAILERS = 0; IFF_POINTOPOINT = 0; IFF_PORTSEL = 0; IFF_PROMISC = 0; IFF_RUNNING = 0; IFF_SLAVE = 0; IFF_UP = 0; IPPROTO_ICMP = 0; IPPROTO_ICMPV6 = 0; IPPROTO_IP = 0; IPPROTO_IPV6 = 0; IPPROTO_RAW = 0; IPPROTO_TCP = 0; IPPROTO_UDP = 0; IPV6_CHECKSUM = 0; IPV6_MULTICAST_HOPS = 0; IPV6_MULTICAST_IF = 0; IPV6_MULTICAST_LOOP = 0; IPV6_RECVDSTOPTS = 0; IPV6_RECVHOPLIMIT = 0; IPV6_RECVHOPOPTS = 0; IPV6_RECVPKTINFO = 0; IPV6_RECVRTHDR = 0; IPV6_RECVTCLASS = 0; IPV6_TCLASS = 0; IPV6_UNICAST_HOPS = 0; IPV6_V6ONLY = 0; IP_MULTICAST_IF = 0; IP_MULTICAST_LOOP = 0; IP_MULTICAST_TTL = 0; IP_TOS = 0; IP_TTL = 0; MAP_FIXED = 0; MAP_PRIVATE = 0; MAP_SHARED = 0; MCAST_BLOCK_SOURCE = 0; MCAST_JOIN_GROUP = 0; MCAST_JOIN_SOURCE_GROUP = 0; MCAST_LEAVE_GROUP = 0; MCAST_LEAVE_SOURCE_GROUP = 0; MCAST_UNBLOCK_SOURCE = 0; MCL_CURRENT = 0; MCL_FUTURE = 0; MSG_CTRUNC = 0; MSG_DONTROUTE = 0; MSG_EOR = 0; MSG_OOB = 0; MSG_PEEK = 0; MSG_TRUNC = 0; MSG_WAITALL = 0; MS_ASYNC = 0; MS_INVALIDATE = 0; MS_SYNC = 0; NI_DGRAM = 0; NI_NAMEREQD = 0; NI_NOFQDN = 0; NI_NUMERICHOST = 0; NI_NUMERICSERV = 0; O_ACCMODE = 0; O_APPEND = 0; O_CREAT = 0; O_EXCL = 0; O_NOCTTY = 0; O_NOFOLLOW = 0; O_NONBLOCK = 0; O_RDONLY = 0; O_RDWR = 0; O_SYNC = 0; O_TRUNC = 0; O_WRONLY = 0; POLLERR = 0; POLLHUP = 0; POLLIN = 0; POLLNVAL = 0; POLLOUT = 0; POLLPRI = 0; POLLRDBAND = 0; POLLRDNORM = 0; POLLWRBAND = 0; POLLWRNORM = 0; PROT_EXEC = 0; PROT_NONE = 0; PROT_READ = 0; PROT_WRITE = 0; PR_GET_DUMPABLE = 0; PR_SET_DUMPABLE = 0; PR_SET_NO_NEW_PRIVS = 0; RT_SCOPE_HOST = 0; RT_SCOPE_LINK = 0; RT_SCOPE_NOWHERE = 0; RT_SCOPE_SITE = 0; RT_SCOPE_UNIVERSE = 0; R_OK = 0; SEEK_CUR = 0; SEEK_END = 0; SEEK_SET = 0; SHUT_RD = 0; SHUT_RDWR = 0; SHUT_WR = 0; SIGABRT = 0; SIGALRM = 0; SIGBUS = 0; SIGCHLD = 0; SIGCONT = 0; SIGFPE = 0; SIGHUP = 0; SIGILL = 0; SIGINT = 0; SIGIO = 0; SIGKILL = 0; SIGPIPE = 0; SIGPROF = 0; SIGPWR = 0; SIGQUIT = 0; SIGRTMAX = 0; SIGRTMIN = 0; SIGSEGV = 0; SIGSTKFLT = 0; SIGSTOP = 0; SIGSYS = 0; SIGTERM = 0; SIGTRAP = 0; SIGTSTP = 0; SIGTTIN = 0; SIGTTOU = 0; SIGURG = 0; SIGUSR1 = 0; SIGUSR2 = 0; SIGVTALRM = 0; SIGWINCH = 0; SIGXCPU = 0; SIGXFSZ = 0; SIOCGIFADDR = 0; SIOCGIFBRDADDR = 0; SIOCGIFDSTADDR = 0; SIOCGIFNETMASK = 0; SOCK_DGRAM = 0; SOCK_RAW = 0; SOCK_SEQPACKET = 0; SOCK_STREAM = 0; SOL_SOCKET = 0; SO_BINDTODEVICE = 0; SO_BROADCAST = 0; SO_DEBUG = 0; SO_DONTROUTE = 0; SO_ERROR = 0; SO_KEEPALIVE = 0; SO_LINGER = 0; SO_OOBINLINE = 0; SO_PASSCRED = 0; SO_PEERCRED = 0; SO_RCVBUF = 0; SO_RCVLOWAT = 0; SO_RCVTIMEO = 0; SO_REUSEADDR = 0; SO_SNDBUF = 0; SO_SNDLOWAT = 0; SO_SNDTIMEO = 0; SO_TYPE = 0; STDERR_FILENO = 0; STDIN_FILENO = 0; STDOUT_FILENO = 0; ST_MANDLOCK = 0; ST_NOATIME = 0; ST_NODEV = 0; ST_NODIRATIME = 0; ST_NOEXEC = 0; ST_NOSUID = 0; ST_RDONLY = 0; ST_RELATIME = 0; ST_SYNCHRONOUS = 0; S_IFBLK = 0; S_IFCHR = 0; S_IFDIR = 0; S_IFIFO = 0; S_IFLNK = 0; S_IFMT = 0; S_IFREG = 0; S_IFSOCK = 0; S_IRGRP = 0; S_IROTH = 0; S_IRUSR = 0; S_IRWXG = 0; S_IRWXO = 0; S_IRWXU = 0; S_ISGID = 0; S_ISUID = 0; S_ISVTX = 0; S_IWGRP = 0; S_IWOTH = 0; S_IWUSR = 0; S_IXGRP = 0; S_IXOTH = 0; S_IXUSR = 0; TCP_NODELAY = 0; WCONTINUED = 0; WEXITED = 0; WNOHANG = 0; WNOWAIT = 0; WSTOPPED = 0; WUNTRACED = 0; W_OK = 0; X_OK = 0; _SC_2_CHAR_TERM = 0; _SC_2_C_BIND = 0; _SC_2_C_DEV = 0; _SC_2_C_VERSION = 0; _SC_2_FORT_DEV = 0; _SC_2_FORT_RUN = 0; _SC_2_LOCALEDEF = 0; _SC_2_SW_DEV = 0; _SC_2_UPE = 0; _SC_2_VERSION = 0; _SC_AIO_LISTIO_MAX = 0; _SC_AIO_MAX = 0; _SC_AIO_PRIO_DELTA_MAX = 0; _SC_ARG_MAX = 0; _SC_ASYNCHRONOUS_IO = 0; _SC_ATEXIT_MAX = 0; _SC_AVPHYS_PAGES = 0; _SC_BC_BASE_MAX = 0; _SC_BC_DIM_MAX = 0; _SC_BC_SCALE_MAX = 0; _SC_BC_STRING_MAX = 0; _SC_CHILD_MAX = 0; _SC_CLK_TCK = 0; _SC_COLL_WEIGHTS_MAX = 0; _SC_DELAYTIMER_MAX = 0; _SC_EXPR_NEST_MAX = 0; _SC_FSYNC = 0; _SC_GETGR_R_SIZE_MAX = 0; _SC_GETPW_R_SIZE_MAX = 0; _SC_IOV_MAX = 0; _SC_JOB_CONTROL = 0; _SC_LINE_MAX = 0; _SC_LOGIN_NAME_MAX = 0; _SC_MAPPED_FILES = 0; _SC_MEMLOCK = 0; _SC_MEMLOCK_RANGE = 0; _SC_MEMORY_PROTECTION = 0; _SC_MESSAGE_PASSING = 0; _SC_MQ_OPEN_MAX = 0; _SC_MQ_PRIO_MAX = 0; _SC_NGROUPS_MAX = 0; _SC_NPROCESSORS_CONF = 0; _SC_NPROCESSORS_ONLN = 0; _SC_OPEN_MAX = 0; _SC_PAGESIZE = 0; _SC_PAGE_SIZE = 0; _SC_PASS_MAX = 0; _SC_PHYS_PAGES = 0; _SC_PRIORITIZED_IO = 0; _SC_PRIORITY_SCHEDULING = 0; _SC_REALTIME_SIGNALS = 0; _SC_RE_DUP_MAX = 0; _SC_RTSIG_MAX = 0; _SC_SAVED_IDS = 0; _SC_SEMAPHORES = 0; _SC_SEM_NSEMS_MAX = 0; _SC_SEM_VALUE_MAX = 0; _SC_SHARED_MEMORY_OBJECTS = 0; _SC_SIGQUEUE_MAX = 0; _SC_STREAM_MAX = 0; _SC_SYNCHRONIZED_IO = 0; _SC_THREADS = 0; _SC_THREAD_ATTR_STACKADDR = 0; _SC_THREAD_ATTR_STACKSIZE = 0; _SC_THREAD_DESTRUCTOR_ITERATIONS = 0; _SC_THREAD_KEYS_MAX = 0; _SC_THREAD_PRIORITY_SCHEDULING = 0; _SC_THREAD_PRIO_INHERIT = 0; _SC_THREAD_PRIO_PROTECT = 0; _SC_THREAD_SAFE_FUNCTIONS = 0; _SC_THREAD_STACK_MIN = 0; _SC_THREAD_THREADS_MAX = 0; _SC_TIMERS = 0; _SC_TIMER_MAX = 0; _SC_TTY_NAME_MAX = 0; _SC_TZNAME_MAX = 0; _SC_VERSION = 0; _SC_XBS5_ILP32_OFF32 = 0; _SC_XBS5_ILP32_OFFBIG = 0; _SC_XBS5_LP64_OFF64 = 0; _SC_XBS5_LPBIG_OFFBIG = 0; _SC_XOPEN_CRYPT = 0; _SC_XOPEN_ENH_I18N = 0; _SC_XOPEN_LEGACY = 0; _SC_XOPEN_REALTIME = 0; _SC_XOPEN_REALTIME_THREADS = 0; _SC_XOPEN_SHM = 0; _SC_XOPEN_UNIX = 0; _SC_XOPEN_VERSION = 0; _SC_XOPEN_XCU_VERSION = 0; }
}
