...
public static  java.nio.CharBuffer wrap(char[] array, int start, int charCount) { throw new RuntimeException("Stub!"); }
public static  java.nio.CharBuffer wrap(java.lang.CharSequence chseq) { throw new RuntimeException("Stub!"); }
public static  java.nio.CharBuffer wrap(java.lang.CharSequence cs, int start, int end) { throw new RuntimeException("Stub!"); }
...
public  java.nio.CharBuffer get(char[] dst, int dstOffset, int charCount) { throw new RuntimeException("Stub!"); }
...
public  java.nio.CharBuffer put(char[] src, int srcOffset, int charCount) { throw new RuntimeException("Stub!"); }
