...
{
public abstract  void onTranslucentConversionComplete(boolean drawComplete);
}
...
public  void convertFromTranslucent() { throw new RuntimeException("Stub!"); }
public  boolean convertToTranslucent(android.app.Activity.TranslucentConversionListener callback, android.app.ActivityOptions options) { throw new RuntimeException("Stub!"); }
...
public  boolean isBackgroundVisibleBehind() { throw new RuntimeException("Stub!"); }
public  void onBackgroundVisibleBehindChanged(boolean visible) { throw new RuntimeException("Stub!"); }
