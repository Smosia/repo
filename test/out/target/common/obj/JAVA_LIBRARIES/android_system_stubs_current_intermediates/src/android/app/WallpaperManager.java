...
public  android.graphics.drawable.Drawable peekDrawableForKeyguard() { throw new RuntimeException("Stub!"); }
...
public  void setStreamForKeyguard(java.io.InputStream data) throws java.io.IOException { throw new RuntimeException("Stub!"); }
public  void setKeyguardResource(int resid) throws java.io.IOException { throw new RuntimeException("Stub!"); }
...
public  void setDisplayOffset(android.os.IBinder windowToken, int x, int y) { throw new RuntimeException("Stub!"); }
public  void clearWallpaper() { throw new RuntimeException("Stub!"); }
public  boolean setWallpaperComponent(android.content.ComponentName name) { throw new RuntimeException("Stub!"); }
