...
public synchronized  int read(byte[] buffer, int byteOffset, int byteCount) { throw new RuntimeException("Stub!"); }
public synchronized  void reset() { throw new RuntimeException("Stub!"); }
public synchronized  long skip(long byteCount) { throw new RuntimeException("Stub!"); }
