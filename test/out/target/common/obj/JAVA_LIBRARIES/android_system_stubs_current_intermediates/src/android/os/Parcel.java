...
public final  void writePersistableBundle(android.os.PersistableBundle val) { throw new RuntimeException("Stub!"); }
public final  void writeSize(android.util.Size val) { throw new RuntimeException("Stub!"); }
public final  void writeSizeF(android.util.SizeF val) { throw new RuntimeException("Stub!"); }
...
public final <T extends android.os.Parcelable> void writeTypedObject(T val, int parcelableFlags) { throw new RuntimeException("Stub!"); }
...
public final  android.os.PersistableBundle readPersistableBundle() { throw new RuntimeException("Stub!"); }
public final  android.os.PersistableBundle readPersistableBundle(java.lang.ClassLoader loader) { throw new RuntimeException("Stub!"); }
public final  android.util.Size readSize() { throw new RuntimeException("Stub!"); }
public final  android.util.SizeF readSizeF() { throw new RuntimeException("Stub!"); }
...
public final <T> T readTypedObject(android.os.Parcelable.Creator<T> c) { throw new RuntimeException("Stub!"); }
