...
public  void clearPhoneAccounts() { throw new RuntimeException("Stub!"); }
@Deprecated
...
public  void enablePhoneAccount(android.telecom.PhoneAccountHandle handle, boolean isEnabled) { throw new RuntimeException("Stub!"); }
