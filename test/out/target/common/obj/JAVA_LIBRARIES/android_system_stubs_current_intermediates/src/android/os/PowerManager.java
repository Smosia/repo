...
public  void userActivity(long when, int event, int flags) { throw new RuntimeException("Stub!"); }
public  boolean isScreenBrightnessBoosted() { throw new RuntimeException("Stub!"); }
