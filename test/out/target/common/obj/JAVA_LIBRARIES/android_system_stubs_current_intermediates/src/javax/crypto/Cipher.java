...
public final  void updateAAD(byte[] input) { throw new RuntimeException("Stub!"); }
public final  void updateAAD(byte[] input, int inputOffset, int inputLen) { throw new RuntimeException("Stub!"); }
public final  void updateAAD(java.nio.ByteBuffer input) { throw new RuntimeException("Stub!"); }
