...
{
ScriptIntrinsicConvolve5x5() { throw new RuntimeException("Stub!"); }
public static  android.renderscript.ScriptIntrinsicConvolve5x5 create(android.renderscript.RenderScript rs, android.renderscript.Element e) { throw new RuntimeException("Stub!"); }
