...
case TRANSACTION_sendObjectInfoChanged:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
this.sendObjectInfoChanged(_arg0);
reply.writeNoException();
return true;
}
}
...
@Override public void sendObjectInfoChanged(int objectHandle) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(objectHandle);
mRemote.transact(Stub.TRANSACTION_sendObjectInfoChanged, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_sendObjectInfoChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
}
...
public void sendObjectInfoChanged(int objectHandle) throws android.os.RemoteException;
}
