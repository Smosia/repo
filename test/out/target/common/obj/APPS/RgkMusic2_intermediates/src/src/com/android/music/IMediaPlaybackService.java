 ...
 * Original file: packages/apps/Ragentek/RgkMusic2/src/com/android/music/IMediaPlaybackService.aidl
 */
...
case TRANSACTION_canUseAsRingtone:
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.canUseAsRingtone();
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
@Override public boolean canUseAsRingtone() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_canUseAsRingtone, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
static final int TRANSACTION_getMIMEType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
...
static final int TRANSACTION_getAudioSessionId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_canUseAsRingtone = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
}
...
public boolean canUseAsRingtone() throws android.os.RemoteException;
}
