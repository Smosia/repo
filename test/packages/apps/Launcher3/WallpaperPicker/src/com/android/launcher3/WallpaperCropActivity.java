...
//add by lihuachun at 2015.10.9 start
import android.content.ContentResolver;
import android.provider.Settings;
import android.os.Environment;
import android.os.StatFs;
import java.io.File;
//end lihuachun at 2015.10.9
...
public class WallpaperCropActivity extends Activity {
    ...
    ///M.
	protected static boolean isKeyguardWallpaper = false;// add by wangjian for keyguard wallpaper
	protected static boolean setBothWallpaper = false;//add by wangjian 20150604
	private Dialog setDialog;//add by wangjian 20150604
    ...
    protected void onCreate(Bundle savedInstanceState) {
	 ...
	 if(getRomAvailMemory(getContentResolver())){
        ...
        // Add by wangjian for keyguard wallpaper begin
    ...
    protected void init() {
        ...
        setDialog = setWallpaperDialog();//add by wangjian 20150604
        ...
        actionBar.getCustomView().setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                    	//modify by wangjian 20150604 start
                        ...
                        */
                        ///M.
                        setDialog.show();
                        //modify by wangjian 20150604 end
                    }
                });
    ...
    // Add by wangjian for keyguard wallpaper feature begin
    ...
    // Add by wangjian for keyguard wallpaper feature end
    ...
    protected void cropImageAndSetWallpaper(
        ...
        // Modify by wangjian for keyguard wallpaper feature begin
        Point outSize = null;
        ...
        // Modify by wangjian for keyguard wallpaper feature end
    ...
    protected void cropImageAndSetWallpaper(Uri uri,
        ...
        if (isKeyguardWallpaper) {
        	defaultWallpaperSize = getDefaultKeyguardWallpaperSize(getResources(),
                    getWindowManager());
        } else {
        	defaultWallpaperSize = getDefaultWallpaperSize(getResources(),
                    getWindowManager());
        }
        // Modify by wangjian for keyguard wallpaper feature end
        // Get the crop
    ...
    private Dialog setWallpaperDialog() {
		...
		Dialog dialog = new AlertDialog.Builder(this,R.style.setwallpapertheme)//modify by wangjian for JWBLB-854 20150610
    ...
    private void setWallpaper(int id) {
		...
		switch (id) {
		case 0://home wallpaper
			isKeyguardWallpaper = false;
			cropImageAndSetWallpaper(uri, h, finishActivityWhenDone);
			Toast.makeText(WallpaperCropActivity.this,
					R.string.set_wallpaper_successfull, Toast.LENGTH_LONG).show();
			break;
		case 1://lock wallpaper
			isKeyguardWallpaper = true;
			cropImageAndSetWallpaper(uri, h , finishActivityWhenDone);
			Toast.makeText(WallpaperCropActivity.this,
					R.string.set_wallpaper_successfull, Toast.LENGTH_LONG).show();
			break;
		case 2://both
			setBothWallpaper = true;
			isKeyguardWallpaper = false;
			cropImageAndSetWallpaper(uri, h , finishActivityWhenDone);
			Toast.makeText(WallpaperCropActivity.this,
					R.string.set_wallpaper_successfull, Toast.LENGTH_LONG).show();
