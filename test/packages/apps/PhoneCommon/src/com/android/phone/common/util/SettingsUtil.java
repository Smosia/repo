...
public class SettingsUtil {
    ...
    public static void updateRingtoneName(
        ...
        if (type == RingtoneManager.TYPE_RINGTONE) {
            ...
            //add DWYQLSSMY-182 guowen 20160321 start
            if (!RingtoneManager.isRingtoneExist(context, ringtoneUri)) {
                ringtoneUri = RingtoneManager.getDefaultRingtoneUri(context, type);
            }
            //add DWYQLSSMY-182 guowen 20160321 end
        } else {
            ...
            if (TextUtils.isEmpty(uriString)) {
                ...
                //add DELSLMY-518 guowen 20160308 start
                if (!RingtoneManager.isRingtoneExist(context, ringtoneUri)) {
                    ringtoneUri = RingtoneManager.getDefaultRingtoneUri(context, type);
                }
                //add DELSLMY-518 guowen 20160308 end
            }
        }
        //modify guowen 20160304
        CharSequence summary = context.getString(R.string.ringtone_default);
        // Is it a silent ringtone?
        //modify DELSLMY-516 guowen 20160304
        if (ringtoneUri == null || Uri.parse("com.mediatek.uri.silent_notificaton").equals(ringtoneUri)) {
