...
*/
        ...
        if (d.dragSource != this) {
            ...
            if (dropTargetLayout != null && !d.cancelled) {
                ...
                boolean foundCell = mTargetCell[0] >= 0 && mTargetCell[1] >= 0 && resultSpan[0] > 0
                        && resultSpan[1] > 0;
				//add by wangjian for DWYLL-814 20150601 start
                if (screenId != -1) {
                	CellLayout parentLayout = getScreenWithId(screenId);
                	View child = parentLayout.getChildAt(mTargetCell[0], mTargetCell[1]);
                	CellLayout parentCell = getParentCellLayoutForView(cell);
					View child1 = parentCell.getChildAt(mTargetCell[0], mTargetCell[1]);
					if (child != null && child1 != null && hasMovedLayouts) foundCell = false;
                }
                //add by wangjian for DWYLL-814 20150601 end
                if (LauncherLog.DEBUG) {
   ...
   static private float squaredDistance(float[] point1, float[] point2) {
    ...
    public void onDropCompleted(final View target, final DragObject d,
        ...
        mDragOutline = null;
		// Add by wangjian for DWYYL-1864 begin
        if (mDragInfo != null) {
        ...
        // Add by wangjian for DWYYL-1864 end
        mDragInfo = null;
    }
