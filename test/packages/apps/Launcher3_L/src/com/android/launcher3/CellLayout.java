...
//add DELSLMY-196 by yeyu 20160309 start
import android.os.PowerManager;
import android.os.SystemClock;
import android.provider.Settings;
//add DELSLMY-196 by yeyu 20160309 end
...
public class CellLayout extends ViewGroup {
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mcontext=context;//add DELSLMY-196 by yeyu 20160309
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if((Settings.Global.getInt(mcontext.getContentResolver(),Settings.Global.BLACK_GESTURE_WAKE_F, 1) == 1)&&
                       (Settings.Global.getInt(mcontext.getContentResolver(),Settings.Global.BLACK_GESTURE_WAKE, 0) == 1))
                    doubleclick();
                //add DELSLMY-196 by yeyu 20160309 end
                break;
        }
