...
public class LauncherAppsCompatVL extends LauncherAppsCompat {
    ...
    public List<LauncherActivityInfoCompat> getActivityList(String packageName,
        ...
        for (LauncherActivityInfo info : list) {
        	//Modify BUG_ID:DWYQLSSMY-50 dushuaihui 20160317(start)
        	...
        	if(!((launcherActivityInfoCompatVL).getApplicationInfo().packageName).toString().endsWith("com.teletalk.salestrackerdata.salestrackerdata"))
        	{
                compatList.add(new LauncherActivityInfoCompatVL(info));
        	}
        	//Modify BUG_ID:DWYQLSSMY-50 dushuaihui 20160317(end)
        }
        return compatList;
    }
