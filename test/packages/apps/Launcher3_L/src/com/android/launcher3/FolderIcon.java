...
public class FolderIcon extends FrameLayout implements FolderListener {
    ...
    // Modify BUG_ID:DWYYL-1119 zhaopenglin 20150601(start)
    //private static final int NUM_ITEMS_IN_PREVIEW = 3;
    private static int NUM_ITEMS_IN_PREVIEW;
    private static final int NUM_COLUMN_IN_PREVIEW = 2;
    // Modify BUG_ID:DWYYL-1119 zhaopenglin 20150601(end)
    ...
    private void init() {
        ...
        if(getResources().getBoolean(R.bool.is_rect_folder)){
    ...
    public static class FolderRingAnimator {
		...
		public static int sAvailableIconSpace = -1;//Add BUG_ID:DWYYL-1119 zhaopenglin 20150601
        ...
        public FolderRingAnimator(Launcher launcher, FolderIcon folderIcon) {
            ...
            if (sStaticValuesDirty) {
                ...
                sAvailableIconSpace = res.getDimensionPixelSize(R.dimen.folder_available_icon_space);//Add BUG_ID:DWYYL-1119 zhaopenglin 20150601
                sSharedOuterRingDrawable = res.getDrawable(R.drawable.portal_ring_inner_nolip_holo);
    ...
    private PreviewItemDrawingParams computePreviewItemDrawingParams(int index,
		...
		//Modify BUG_ID:DWYYL-1119 zhaopenglin 20150601(start)
        boolean is_rect_folder=getResources().getBoolean(R.bool.is_rect_folder);
        float transY;
        float transX;
        float totalScale;
        ...
        if(!is_rect_folder){
	        ...
	        transY = topMarginY + scaledSize * row + itemPadding * row - 4;
	        totalScale = scale;
	        overlayAlpha = 0;
        }
