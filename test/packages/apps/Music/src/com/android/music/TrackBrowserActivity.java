...
//Not required
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        //DWLEBM-375 gulincheng start 20160419
        boolean value = false;
        try {
            ...
            ex.printStackTrace();
            MusicLogUtils.v(TAG, "ContentResolver query IllegalStateException");
        }
        return value;
        //DWLEBM-375 gulincheng end 20160419
    }
    ...
    static class TrackListAdapter extends SimpleCursorAdapter implements SectionIndexer {
        ...
        public void changeCursor(Cursor cursor) {
            ...
            // 20151209 gulincheng DSYYL-212 (start)
            if (cursor != mActivity.mTrackCursor && null != cursor) {
            // 20151209 gulincheng DSYYL-212 (end)
