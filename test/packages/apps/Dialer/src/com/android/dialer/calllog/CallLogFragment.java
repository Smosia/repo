...
public class CallLogFragment extends Fragment
    ...
    //add DWYSLM-1063 songqingming 20160601 (start)
    private boolean isStoped = true;
    //add DWYSLM-1063 songqingming 20160601 (end)
    ...
    public void fetchCalls() {
        ...
        if (isQueryMode()) {
            ...
            //add DWYSLM-1063 songqingming 20160601 (start)
            if (mRefreshDataRequired && !isStoped) {
                Log.d("sqm", "fetchCalls:---------------maybe rm notify");
    ...
    private void updateOnTransition(boolean onEntry) {
        ...
        if (mKeyguardManager != null && !mKeyguardManager.inKeyguardRestrictedInputMode()) {
            ...
            //modify DWLEBM-470 songqingming 20160426 (start)
            if (getActivity() != null) {
                CallLogNotificationsHelper.removeMissedCallNotifications(getActivity());
                CallLogNotificationsHelper.updateVoicemailNotifications(getActivity());
            }
            //modify DWLEBM-470 songqingming 20160426 (end)
        }
    }
