    ...
    private CallLogAsyncTaskListener mCallLogAsyncTaskListener = new CallLogAsyncTaskListener() {
        ...
        public void onGetCallDetails(PhoneCallDetails[] details) {
            ...
            if (!TextUtils.isEmpty(firstDetails.name)) {
                ...
                //add DWLEBM-47 songqingming 20160321 (start)
	        boolean isEmergency =  PhoneNumberUtils.isEmergencyNumber(displayNumberStr);
	        if(isEmergency ) {
		    Log.d(TAG, "onGetCallDetails change to emergency");					
		    mCallerName.setText(R.string.emergencycall);
	        } else {
		    Log.d(TAG, "onGetCallDetails name = " + displayNumberStr );		
		    mCallerName.setText(displayNumberStr);
	        }
	        //add DWLEBM-47 songqingming 20160321 (end)
                ...
                //add DWYSEM-141 songqingming 20160406 (start)
	        if(isEmergency ) {
		    Log.d(TAG, "onGetCallDetails: display emergency number");					
		    mCallerNumber.setText(displayNumberStr);
                    mCallerNumber.setVisibility(View.VISIBLE);
	        }
	        //add DWYSEM-141 songqingming 20160406 (end)
            }
