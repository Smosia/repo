...
//add DWLEBM-47 songqingming 20160321 (start)
import android.util.Log;
import android.telephony.PhoneNumberUtils;
//add DWLEBM-47 songqingming 20160321 (end)
...
public class PhoneCallDetailsHelper {
    ...
    public void setPhoneCallDetails(PhoneCallDetailsViews views, PhoneCallDetails details) {
        ...
        if (TextUtils.isEmpty(details.name)) {
            ...
            //add DWLEBM-47 songqingming 20160321 (start)
	    boolean isEmergency =  PhoneNumberUtils.isEmergencyNumber(displayNumber.toString());
	    if(isEmergency ) {
		Log.d(TAG, "setPhoneCallDetails change to emergency");					
		nameText = mResources.getString(R.string.emergencycall);
	    } else {
		Log.d(TAG, "setPhoneCallDetails name = " + displayNumber );		
		nameText = displayNumber;
	    }
	    //add DWLEBM-47 songqingming 20160321 (end)
        ...
        Log.d(TAG, "setPhoneCallDetails: displayNumber = " +displayNumber + " nameText = " + nameText );
