...
import com.mediatek.dialer.plugin.CallLogCommonExtension;
import com.mediatek.dialer.plugin.CallDetailCommonExtension;
// add black list end
                ...
                if (mCallDetailExtension == null) {
                    ...
                    if (mCallDetailExtension == null) {
                        ...
                        if (SystemProperties.getInt("ro.contact_blacklist_support", 0) == 1) {
                            mCallDetailExtension = new CallDetailCommonExtension();
                        } else {
            ...
            synchronized (ICallLogExtension.class) {
                if (mCallLogExtension == null) {
                    ...
                    if (mCallLogExtension == null) {
                        // add black list
                        if (SystemProperties.getInt("ro.contact_blacklist_support", 0) == 1) {
                            mCallLogExtension = new CallLogCommonExtension(mContext);
                        } else {
