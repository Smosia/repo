...
public class DialerFeatureOptions {
    ...
    public static boolean isCallLogAccountFilterEnabled() {
        ...
        //modify DWYJLSYM-63 songqingming 20160407 (start)
        //return false;
        return SystemProperties.get("ro.account_select_support").equals("1");
        //modify DWYJLSYM-63 songqingming 20160407 (end)
    }
