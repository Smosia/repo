...
public class CallLogCommonExtension extends DefaultCallLogExtension {
    private static final String TAG = "CallLogCommonExtension";
     ...
     */
    public CallLogCommonExtension(Context context) {
    ...
    public void createCallLogMenu(Activity activity, Menu menu,
        ...
        try {
            final Context cont = fCallLogActivity.getApplicationContext();
