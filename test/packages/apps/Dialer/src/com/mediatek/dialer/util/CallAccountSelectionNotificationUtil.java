...
public class CallAccountSelectionNotificationUtil {
    ...
    public void showNotification(boolean visible, Activity activity) {
        ...
        //add DWYQLSSMY-613 songqingming 20160407 (start)
        if (activity.getResources().getBoolean(R.bool.rm_default_sim_setting_notification)) {
            return;
        }
        //add DWYQLSSMY-613 songqingming 20160407 (end)
