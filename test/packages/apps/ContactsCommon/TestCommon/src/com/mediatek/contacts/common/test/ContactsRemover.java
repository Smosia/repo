...
public class ContactsRemover {
    ...
    public void removeAllContactsBothInSimAndDb() {
        ...
        Cursor c = cr.query(RawContacts.CONTENT_URI, new String[] { RawContacts.CONTACT_ID,
        ...
        Log.d(TAG, "[testDeleteAll]delete finished: " + timming() + ", total time: "
                    + mTotalTime);
    }
    ...
    private void actullyBatchDelete(List<Long> contactIdList) {
        ...
        whereBuilder.append(Contacts._ID +
                " IN (").append(TextUtils.join(",", questionMarks)).append(")");
    ...
    private class RawContactData {
        ...
        public String toString() {
            return "RawContactData(" + hashCode() + "): contact_id = " + mContactId + ", sim_id = "
                + mSimInfoId + ", index_in_sim = " + mIndexInSim + ", slot_id = " + mSlotId;
        }
