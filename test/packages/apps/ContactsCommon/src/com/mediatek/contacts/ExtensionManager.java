...
//add black list
import com.mediatek.contacts.plugin.ContactsCommonExtension;
import com.mediatek.contacts.plugin.QuickContactExtension;
import com.mediatek.contacts.ext.IQuickContactExtension;
...
public final class ExtensionManager {
    ...
    static {
       ...
       // sDefaulthPluginMap.put(IImportExportExtension.class, new DefaultImportExportExtension());
        ...
        //add black list
        if (SystemProperties.getInt("ro.contact_blacklist_support", 0) == 1) {
            sDefaulthPluginMap.put(IQuickContactExtension.class, new QuickContactExtension());
        } else {
            sDefaulthPluginMap.put(IQuickContactExtension.class, new DefaultQuickContactExtension());
        }
        //add black list end
    }
    ...
    public static void registerApplicationContext(Application application) {
        ...
        //add black list
        if (SystemProperties.getInt("ro.contact_blacklist_support", 0) == 1) {
            sDefaulthPluginMap.put(IOp01Extension.class, new ContactsCommonExtension(sContext));
        }
        //add black list end
    }
   ...
   //-------------------below are getXxxExtension() methonds-----------------//
    ...
    //add black list
    public static IQuickContactExtension getQuickContactExtension() {		
        IQuickContactExtension  extension = (IQuickContactExtension) getExtension(IQuickContactExtension.class);
        return extension;
    }
    //add black list end
