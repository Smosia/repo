...
public class ProfileAndContactsLoader extends CursorLoader {
  ...
  //show readonly contact start
    private int mReadOnlyContactCount = 0;
    public int setReadOnlyContactCount(int count) {
        return this.mReadOnlyContactCount = count;
    }
    
    public int getReadOnlyContactCount() {
        return this.mReadOnlyContactCount;
    }
