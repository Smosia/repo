...
public class PinnedHeaderListView extends AutoScrollListView
    ...
    public void setHeaderInvisible(int viewIndex, boolean animate) {
        ...
        if (mOnHeaderInvisibleListener != null) {
            mOnHeaderInvisibleListener.onHeaderInvisible();
        }
    ...
    //add DWYYL-863 songqingming 20150526 (start)
    private OnHeaderInvisibleListener mOnHeaderInvisibleListener;

    public void setOnHeaderInvisibleListener(OnHeaderInvisibleListener listener) {
        mOnHeaderInvisibleListener = listener;
    }

    public interface OnHeaderInvisibleListener {
