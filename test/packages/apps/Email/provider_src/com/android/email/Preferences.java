...
public class Preferences {
	...
	private static final String CONFIRM_DELETE_SIGNATURE = "confirm_delete_signature";
	//A}
    ...
    //A:ADD BUG ID :DWYSLM-131 liupeng 20160315{
	private static boolean mSignatureEnable = false;
	//A}
    @Deprecated
	...
	public boolean getConfirmDeleteSignature(Context context) {
		mSignatureEnable = context.getResources().getBoolean(R.bool.signature_enable);
        return mSharedPreferences.getBoolean(CONFIRM_DELETE_SIGNATURE, mSignatureEnable ? true : false);
    }

    public void setConfirmDeleteSignature(boolean set) {
        mSharedPreferences.edit().putBoolean(CONFIRM_DELETE_SIGNATURE, set).apply();
    }
