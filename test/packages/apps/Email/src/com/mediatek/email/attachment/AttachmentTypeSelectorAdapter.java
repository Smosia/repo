...
public class AttachmentTypeSelectorAdapter extends IconListAdapter {
    ...
    protected static List<IconListItem> getData(Context context) {
		...
		//add bug id DWYSEM-126 liupeng 20160331 (start)
        if (AttachmentHelper.isCalenderImporterAvailable(context)&&context.getResources().getBoolean(R.bool.is_mtk_calender)) {
            addItem(data, context.getString(R.string.attach_calender), ADD_CALENDAR);
        }
        //add bug id DWYSEM-126 liupeng 20160331 (end)
