...
public class VcsAppGuide {
    ...
    public boolean setVcsAppGuideVisibility(Activity activity, boolean isShow,
        ...
        //add to rm vcs guide icon songqingming 20160427 (start)
        if (activity.getResources().getBoolean(R.bool.config_rm_vcs_guide_dialog)) {
    	    Log.d(TAG, "[setVcsAppGuideVisibility]------not show dialog, direct return.");
    	    return false;
    	}
        //add to rm vcs guide icon songqingming 20160427 (end)
        if (isShow) {
