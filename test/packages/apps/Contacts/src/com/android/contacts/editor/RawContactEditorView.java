          ...
          /// @}
            ...
            if (AccountWithDataSetEx.isLocalPhone(type.accountType)) {
                ...
                if (getResources().getBoolean(R.bool.show_account_type_sim1_sim2)) {
                    int slot = SubInfoUtils.getSlotIdUsingSubId(mSubId);
                    if (slot == 0) {
                        mAccountHeaderTypeTextView.setText(mContext.getString(R.string.account_type_format, "SIM1"));
                    } else {
                	    mAccountHeaderTypeTextView.setText(mContext.getString(R.string.account_type_format, "SIM2"));
                    }
                }
