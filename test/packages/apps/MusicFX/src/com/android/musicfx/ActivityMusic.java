...
public class ActivityMusic extends Activity implements OnSeekBarChangeListener {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        TextView t1 = (TextView) findViewById(R.id.bBStrengthText);
        if (t1 != null) {t1.setSelected(true);}
        TextView t2 = (TextView) findViewById(R.id.vIStrengthText);
        if (t2 != null) {t2.setSelected(true);}
        TextView t3 = (TextView) findViewById(R.id.pRText);
