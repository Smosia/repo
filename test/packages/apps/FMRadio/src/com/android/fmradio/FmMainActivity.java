...
//A:DSYYLM-310 wanglin 20160122 start
...
//A:DSYYLM-310 wanglin 20160122 end
/// @}
...
//            }
        ...
        @Override
        public void onAnimationStart(Animation animation) {
        	//modify Bug_id:DWYSLM-381 wanglin 20160414
        	 if(getResources().getBoolean(R.bool.MiddleShadowSize_toast)){
    ...
    private void updateFavoriteStation() {
		...
		Toast.makeText(FmMainActivity.this, "Successfully removed from favourites", Toast.LENGTH_SHORT).show();
					//add	
            // Notify scroller
            if (mScroller != null) {
            ...
            if (FmStation.isStationExist(mContext, mCurrentStation)) {
				...
				//add Bug_id:DSYYLM-302 wanglin 20160122 (start) 
		Toast.makeText(FmMainActivity.this,"Successfully added to favourites" ,Toast.LENGTH_SHORT).show();
					//add	
            // Notify scroller
            } else {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        FMRadioCITActivity.mInCITMode =false;
        try {
	...
	//A:DSYYLM-310 wanglin 20160122 start
	  private void SelectFrequency() {
		...
		mTextStationValue.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View arg0) {

				// use builder first
				builder = new Builder(FmMainActivity.this);
				builder.setTitle(R.string.title_frequency);

				View view = LayoutInflater.from(FmMainActivity.this).inflate(
						R.layout.dialog, null);
				builder.setView(view);
				builder.setPositiveButton(R.string.btn_ok, null);
				builder.setNegativeButton(R.string.btn_cancel, null);

				// then create alertDialog,and set listener,so we can control
				// the behavior of buttons totally
				alertDialog = builder.create();
				alertDialog.show();

				// get edittext here, or it will get nothing.
				final EditText et = (EditText) alertDialog
						...
						.setOnClickListener(new View.OnClickListener() {
							...
							public void onClick(View v) {
								if (!et.getText().toString().equals("")) {
									// input hint logic, in xml we limit the
									// inputtype to numberDecimal
									if (Float.parseFloat(et.getText()
											.toString()) > 108.0
											|| Float.parseFloat(et.getText()
													//M:DWYSL-219 wanglin 20151130 (start)
													.toString()) < 87.5) {
													//M:DWYSL-219 wanglin 20151130 (end)
										doSomething();
									} else {
										int a = (int) (10 * Float.parseFloat(et.getText().toString()));
										tuneStation(a);
										alertDialog.dismiss();
									}
								}
