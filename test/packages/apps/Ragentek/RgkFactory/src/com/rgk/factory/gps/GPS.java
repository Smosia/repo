...
public class GPS extends Activity {
	...
	//modify BUG_ID:JLLBLS-52 xuemingwei 20150925 (start)
    final int MIN_SAT_NUM = 3; 
	//modify BUG_ID:JLLBLS-52 xuemingwei 20150925 (end)
	...
	// @}
        ...
        LinearLayout mLayout = (LinearLayout) findViewById(R.id.gps_layout);
    ...
    private void setLocationView(Location location) {
        ...
        if (location != null) {
            ...
            mTextView.setText(getResources().getString(R.string.is_locating));
        }
    }
    ...
    void bindView() {
        ...
        startButton = (Button) findViewById(R.id.gps_pass);
        startButton.setOnClickListener(new OnClickListener() {
            public void onClick(View arg0) {                
                SendBroadcast(Config.PASS);
            }
        });
        stopButton = (Button) findViewById(R.id.gps_fail);
