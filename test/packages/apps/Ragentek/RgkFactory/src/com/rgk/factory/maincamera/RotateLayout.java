...
public class RotateLayout extends ViewGroup implements Rotatable {
    ...
    public RotateLayout(Context context, AttributeSet attrs) {
        ...
        // is invisible.
        LogUtils.logD(TAG, "RotateLayout mState = " );
    ...
    protected void onLayout(
        ...
        LogUtils.logD(TAG, "onLayout mOrientation " + mOrientation);
        switch (mOrientation) {
            case 0:
            case 180:
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        int w = 0;
        int h = 0;
        LogUtils.logD(TAG, "onMeasure mOrientation " + mOrientation);
        switch(mOrientation) {
            case 0:
            case 180:
    ...
    public void setOrientation(int orientation, boolean animation) {
    	LogUtils.logD(TAG, "setOrientation(" + orientation + ", " + animation + ") mOrientation=" + mOrientation);
...
//        mOrientation = orientation;
    ...
    public int getOrientation() {
        LogUtils.logD(TAG, "getOrientation " );
        return mOrientation;
    }

    public void setOnSizeChangedListener(OnSizeChangedListener listener) {
        LogUtils.logD(TAG, "setOnSizeChangedListener " );
        mListener = listener;
    }

    @Override
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
    	LogUtils.logD(TAG, "onSizeChanged(" + w + ", " + h + ", " + oldh + ", " + oldh + ") " + this);
        if (mListener != null) {
