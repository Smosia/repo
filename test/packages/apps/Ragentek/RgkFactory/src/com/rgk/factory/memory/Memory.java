...
public class Memory extends Activity implements View.OnClickListener {
	...
	// @}
		...
		//NvRAMAgentHelper.writeVernoToNV(64*8+40,this.getTotalMemory());
		startMenoryTest();
    }
    ...
    private String getTotalMemory() {
    	...
    	try {
			...
			//modify by liuyangyang BUG_ID:JWBLB-136 20150518(start)
			initial_memory = Integer.valueOf(arrayOfString[1]).intValue();
			//modify by liuyangyang BUG_ID:JWBLB-136 20150518(end)
    	...
    	//modify by liuyangyang BUG_ID:JWBLB-136 20150518(start)
    	return Formatter.formatFileSize(getBaseContext(), initial_memory*1024);
    	//modify by liuyangyang BUG_ID:JWBLB-136 20150518(end)
    }
