...
import com.rgk.factory.KeyCodeReceiver;
public class MotherboardInfo extends Activity implements OnClickListener {
	public static final String TAG = "MotherboardInfo";
	TextView chip,board,imei1,imei2,psn,csn,blutooth_address,wifi_address,memory,lcd,camera,rf_calibrate,gps_calibrate;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (KeyCodeReceiver.customOrder) {
		setContentView(R.layout.motherboard_info_custom);		
		} else {
	...
	private void initTextView(){
		...
		csn = (TextView)findViewById(R.id.csn);		
	...
	private void setText(){
		...
		imei1.setText(getImei11());
		imei2.setText(getImei21());
		psn.setText(getPsn());
		csn.setText(getCsn());
	...
	public String getChip() {
		...
		//NvRAMAgentHelper.writeVernoToNV(64*11+40,result);
		return result;
	}
	...
	public String getImei11() {
		TelephonyManager tm1 = new TelephonyManager(this);
		return tm1.getDeviceId(0);
	}
	public String getImei21() {
		TelephonyManager tm1 = new TelephonyManager(this);
		return tm1.getDeviceId(1);
	}	
	public String getPsn() {
		//add BUG_ID:JWBLB-2034 xuemingwei 20150915 (start) 
		String sn = NvRAMAgentHelper.readNVSn();
	...
	public String getCsn() {
		String csn = NvRAMAgentHelper.readNVCsn();
		String psn = NvRAMAgentHelper.readNVSn();
		if(csn == null || csn.trim().length() == 0) {
			if(psn == null || psn.trim().length() == 0){
	...
	public String getBlutooth_address() {
		String mac = NvRAMAgentHelper.readNVBluetoothMac().toString();
		Log.i(TAG, "getBlutooth_address()->bluetoothmac="+mac);
		if(mac == null || mac.trim() == "" || mac.equals("00:00:00:00:00:00")) {
			mac = BluetoothAdapter.getDefaultAdapter().getAddress();
			Log.i(TAG, "getBlutooth_address()->bluetoothmac2="+mac);
		}
		return mac;
	}
	...
	public String getLcd() {
		...
		//NvRAMAgentHelper.writeVernoToNV(64*10+40,result);
		return result;
	}
	public StringBuilder getCamera() {
		...
		//NvRAMAgentHelper.writeVernoToNV(64*7+40,result.toString());
		return result;
	}
