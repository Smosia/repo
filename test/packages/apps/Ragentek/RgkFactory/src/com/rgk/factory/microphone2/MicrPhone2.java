...
package com.rgk.factory.microphone2;
...
public class MicrPhone2 extends Activity implements View.OnClickListener,MediaPlayer.OnCompletionListener {
    
	public static String TAG = "MicrPhone2";
	...
	private String	strTempFile	= "record2_";
	...
	// @}
        ...
        setTitle(R.string.Microphone2);
        setContentView(R.layout.microphone2);
        LinearLayout mLayout = (LinearLayout) findViewById(R.id.microphone2_layout);
        ...
        mRecord = (Button)findViewById(R.id.microphone2_info);
        mRecordTime = (TextView)findViewById(R.id.microphone2_time);
        mRecordTime.setVisibility(View.INVISIBLE);
        mPass = (Button)findViewById(R.id.microphone2_pass);      
        ((Button)findViewById(R.id.microphone2_pass)).setOnClickListener(this);
        ((Button)findViewById(R.id.microphone2_fail)).setOnClickListener(this);
        mRecord.setOnClickListener(this);
        
        file = new File("/sdcard/CitRecord2/");
        file.mkdir();
    }
	...
	public void onClick(View v) {
		int id = v.getId();
		switch(id){
			case R.id.microphone2_pass:
				SendBroadcast(Config.PASS);
				break;
			case R.id.microphone2_fail:
				SendBroadcast(Config.FAIL);
				break;
			case R.id.microphone2_info:
			    HandlerRecord();
				break;
		}	
	}
	...
	private void HandlerRecord() {
		...
		if(Text.equals(getResources().getString(R.string.start_record))){
			...
			try
			{
				...
				AudioSystem.setParameters("SET_MIC_CHOOSE=2"); //only use sub mic
