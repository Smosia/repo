...
public class FileInfoManager {
  ...
  //M BUG_ID:JWBLB-635 shasha.fang 20150603(start)
    public void clearShowFilesInfoList(FileInfoAdapter adapter) {
        if (mShowFilesInfoList != null && !mShowFilesInfoList.isEmpty()) {
            mShowFilesInfoList.clear();
            if (adapter != null) {
  ...
  //M BUG_ID:JWBLB-635 shasha.fang 20150603(end)
    public void updateShowFilesInfoList(FileInfo info) {
        mShowFilesInfoList.add(info);
    }
}
