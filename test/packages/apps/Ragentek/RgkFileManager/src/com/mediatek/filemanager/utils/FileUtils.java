...
//add  BUG_ID:JWYYL-12 zhaolei.ding 20141216 (end)
	...
	public static final int TAB_ON_BROWSE_ITEM = 2;
    ...
    public static String sizeToString(long size,Context context) {
    ...
    public static Uri tryContentMediaUri(Context context, Uri fileUri) {
        ...
        try {
            ...
            if (null != cursor && cursor.moveToNext()) {
				...
				// add bug id DWQBJ-163  liupeng  201512125 (start)
				         return  fileUri;
               ...
               //add bug id DWQBJ-163  liupeng  20151215  (end)           
		   } else {
                    // do-nothing
