...
public class WeatherWidget extends AppWidgetProvider {
	...
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,
        ...
        if (appWidgetIds == null) {
            Log.v("guocl", "appWidgetIds = null");
            newAppWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(
                    context, WeatherWidget.class));
        }

        Log.v("guocl", "appWidgetIds_length = " + newAppWidgetIds.length);
		
        for (int appWidgetId : appWidgetIds) {
        	Log.v("guocl", "appWidgetId_sub = " + appWidgetId);
	...
	public void onReceive(Context context, Intent intent) {
		...
		Log.i("guocl", "onReceive action = " + intent.getAction());
	...
	private void updateClock(
        ...
        if (newOptions != null &&
            ...
            localIntent4.setComponent(new ComponentName("com.android.deskclock", "com.android.deskclock.DeskClock"));
            ...
            localIntent5.setComponent(new ComponentName("com.android.calendar", "com.android.calendar.AllInOneActivity"));
            ...
            widget.setOnClickPendingIntent(R.id.widget_img, getWeatherActivityIntent(context));
        }
        ...
        ///@}
        Utils.setTimeFormat(widget, amPmFontSize/*0 no am/pm*/, R.id.the_clock);
        Utils.setClockSize(context, widget, ratio);
        
        appWidgetManager.updateAppWidget(appWidgetId, widget);
    }
	
	private PendingIntent getScrollPendingIntent(Context context, final int appWidgetId) {
        Intent intent = new Intent(context, UpdateWidgetService.class).
                setAction("com.weather.action.SCROLL").
