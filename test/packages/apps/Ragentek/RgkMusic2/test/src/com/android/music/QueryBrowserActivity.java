...
implements MusicUtils.Defs, ServiceConnection
{
    ...
    //add bug_id:DWYBL-1529 gaoxueyan 20150427 start
    @Override
    ...
    //add bug_id:DWYBL-1529 gaoxueyan 20150427 end
    @Override
    public void onPause() {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case USE_AS_RINGTONE: {
                ...
                MusicUtils.setRingtone(this, mTrackList.getSelectedItemId(), -1);
    ...
    static class QueryListAdapter extends SimpleCursorAdapter {
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            if (mimetype.equals("artist")) {
                ...
                iv.setImageResource(R.drawable.rgk_albumart_mp_unknown_list);
                String name = cursor.getString(cursor.getColumnIndexOrThrow(
                        MediaStore.Audio.Albums.ALBUM));
                String displayname = name;
                if (name == null || name.equals(MediaStore.UNKNOWN_STRING)) {
