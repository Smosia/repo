...
public class MusicPicker extends ListActivity
    ...
    //modif Bug_id:DWLLL-588 chenchunyong 20141128 (start)
    private AudioManager mAudioManager;
	//modif Bug_id:DWLLL-588 chenchunyong 20141128 (end)
    ...
    class TrackListAdapter extends SimpleCursorAdapter
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            if (secs == 0) {
				//Modify JWYYL-633 chenshu 20141224 start 
                //vh.duration.setText("");
				vh.duration.setText("0:00");
				//Modify JWYYL-633 chenshu 20141224 end
            } else {
