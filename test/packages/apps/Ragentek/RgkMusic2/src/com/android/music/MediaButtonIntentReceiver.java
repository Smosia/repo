...
public class MediaButtonIntentReceiver extends BroadcastReceiver {
    ...
    // A:JWLWEL-164 qinzhaojin {
    private static final String FM_PLAYBACK_STATUS = "fm_playback_status";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (AudioManager.ACTION_AUDIO_BECOMING_NOISY.equals(intentAction)) {
            ...
            MusicLogUtils.d(TAG, "keycode="+keycode+"*action="+action+"eventtime="+eventtime);
            /// M: AVRCP and Android Music AP supports the FF/REWIND
            ...
            switch (keycode) {
                ...
                case KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE:
					...
					if(Settings.Secure.getInt(context.getContentResolver(),"com.rgk.factory.headphonemic.stopFM", 0)!=0){
						break;
                    }
