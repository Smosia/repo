...
public class RenamePlaylist extends Activity
{
    ...
    /// @}
  //add bug_id:JSLEB-80 gaoxueyan 20141112 start
    private Handler handler;
    private InputMethodManager imm;
    //add bug_id:JSLEB-80 gaoxueyan 20141112 end
 ...
 //add bug_id:JSLEB-80 gaoxueyan 20141112 end    
    ...
    private void setSaveButton() {
        String typedname = mPlaylist.getText().toString().trim();//modify BUG_ID:JWBLB-711 gaoxueyan 20150602
        ...
        public void onClick(DialogInterface mDialogInterface, int button) {
            if (button == DialogInterface.BUTTON_POSITIVE) {
                ...
                if (name != null && name.length() > 0) {
                    ...
                    setResult(RESULT_OK);
                    //modify bug_id:DWYBL-384 gaoxueyan 20150408 start
                    if (mExistingId >= 0) {
                    Toast.makeText(RenamePlaylist.this, R.string.playlist_renamed_covered_message, Toast.LENGTH_SHORT).show();
                    }else{
                    Toast.makeText(RenamePlaylist.this, R.string.playlist_renamed_message, Toast.LENGTH_SHORT).show();
                    }
                  //modify bug_id:DWYBL-384 gaoxueyan 20150408 end
				   handler.removeCallbacksAndMessages(null);//bug_id:DWYBL-1498 gaoxueyan 20150429
                    finish();
                }
