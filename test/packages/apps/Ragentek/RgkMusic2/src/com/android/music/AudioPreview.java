...
public class AudioPreview extends Activity
	...
	//add gaoxueyan bugI:JWYYl-477 start
    private TextView mTextLine01;
    private TextView mTextLine02;
	//add gaoxueyan bugI:JWYYl-477 end
    ...
    public void onCreate(Bundle icicle) {
		...
		//add permission judgment start by gaoxueyan
        if (getApplicationContext()
                .checkSelfPermission(Manifest.permission.READ_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
                 
                   mPermissionGranted = false;
                 MusicLogUtils.d(TAG, "onCreate READ_EXTERNAL_STORAGE");
...
//add gaoxueyan bugI:JWYYl-477 start
	mTextLine01 = (TextView) findViewById(R.id.line01);
        mTextLine02 = (TextView) findViewById(R.id.line02);
//add gaoxueyan bugI:JWYYl-477 end
    ...
    private void showPostPrepareUI() {
		...
		//add gaoxueyan bugI:JWYYl-477 start
	    mTextLine02.setText(MusicUtils.makeTimeString(AudioPreview.this, mDuration / 1000));
		//add gaoxueyan bugI:JWYYl-477 end
        }
    ...
    class ProgressRefresher implements Runnable {
		...
		//add gaoxueyan bugI:JWYYl-477 start
		mTextLine01.setText(MusicUtils.makeTimeString(AudioPreview.this, 
                		(mPlayer.getCurrentPosition() > mDuration ? mDuration : mPlayer.getCurrentPosition()) / 1000));
		//add gaoxueyan bugI:JWYYl-477 end
            }
            mProgressRefresher.removeCallbacksAndMessages(null);
    ...
    private OnSeekBarChangeListener mSeekListener = new OnSeekBarChangeListener() {
		...
		//add gaoxueyan bugI:JWYYl-477 start
		mTextLine01.setText(MusicUtils.makeTimeString(AudioPreview.this, progress / 1000));
		//add gaoxueyan bugI:JWYYl-477 end
        }
	...
	//add gaoxueyan bugI:JWYYl-477 start
	mTextLine01.setText(MusicUtils.makeTimeString(AudioPreview.this , mPlayer.getCurrentPosition()  / 1000));
	//add gaoxueyan bugI:JWYYl-477 end
        mIsComplete = true;
        /// @}
    }
