        ...
        implements View.OnCreateContextMenuListener, MusicUtils.Defs, ServiceConnection, DialogInterface.OnClickListener
{
    ...
    public void onCreate(Bundle icicle)
    {
		...
		//A:gaoxueyan
        	Log.i("gxy", "media_picker_activity");
            setContentView(R.layout.media_picker_activity);
        } else {
        	Log.i("gxy", "media_picker_activity_nowplaying");
        ...
        //A:gaoxueyan
        nowplayingLayout = (RelativeLayout) findViewById(R.id.rgk_nowplaying_parent_layout);
    ...
    public void onServiceConnected(ComponentName name, IBinder service)
    {
       ...
       // MusicUtils.updateNowPlaying(this, mOrientation);
        MusicUtils.updateRgkNowPlaying(this, mOrientation);
    }
...
//                invalidateOptionsMenu();
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (mService != null) {
               // MusicUtils.updateNowPlaying(TrackBrowserActivity.this, mOrientation);
            	MusicUtils.updateRgkNowPlaying(TrackBrowserActivity.this, mOrientation);
            }
            /// @}
        }
    };
        ...
        switch (requestCode) {
            ...
            case REQUEST_SIM_SELECT:
                if (resultCode == RESULT_OK) {
                    ...
                    MusicUtils.setRingtone(this, mSelectedId, mSimId);
                }
                break;
            //add DWYSLM-227 guowen 20160407 end
    ...
    private void initAdapter() {
        ...
        if (mAdapter == null) {
            ...
            mAdapter = new TrackListAdapter(
                   ...
                   false&& mPlaylist != null &&//modify bug_id:JWYYY-201 gaoxueyan 20141217 
    ...
    private void setRingtone() {
        ...
        if(SystemProperties.get("ro.mtk_multisim_ringtone").equals("1") && simInfos > 1) {
            ...
            if (parent!=null) {
                parent.startActivityForResult(intent, REQUEST_SIM_SELECT);
            } else {
