...
public class InCallActivity extends Activity implements FragmentDisplayManager {
    ...
    private final String DB_SMART_SWITCH = "smart_switch";
    private final SensorCallback mSensorCallback = new SensorCallback(){
        ...
        public void onCalling() {
            if(getSmartSwitchState()){
                Log.d(TAG,"onCalling - Smart Switch is enable in SmartMotion.");
                AudioManager audioManager = (AudioManager) getApplicationContext().getSystemService(Context.AUDIO_SERVICE);
                if (audioManager.isSpeakerphoneOn()) {
                    Log.d(TAG,"onCalling - Close speaker for Smart Switch.");
    ...
    private boolean getSmartSwitchState() {
        return Settings.System.getInt(getContentResolver(), DB_SMART_SWITCH, -1) == 1;
    }
    //A: kuangyunfeng 20160112(end)
    ...
    protected void onPause() {
        ...
        //A: kuangyunfeng 20160112(start)
        if(mSensorListener != null) {
            Log.d(TAG, "Set sensor disable for Smart Switch.");
        ...
        super.onPause();
        //add JWBLB-2170 songqingming 20151118 (start)
        if (mPostCharDialogfragment != null) {
            mPostCharDialogfragment.dismiss();
            mPostCharDialogfragment = null;
        }
        //add JWBLB-2170 songqingming 20151118 (end)
    }
