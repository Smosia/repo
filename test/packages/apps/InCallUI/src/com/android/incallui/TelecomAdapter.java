...
///@}
    ...
    void startVoiceRecording(int slot, String number, boolean isConference) {
        if (mInCallService != null) {
            ...
            mSampleStart = System.currentTimeMillis();
            //add JLYLB-190 songqingming 20151117 (end)
            mInCallService.startVoiceRecording(slot, number, isConference);
        } else {
            Log.e(this, "error startVoiceRecording, mInCallService is null");
        }
    }
    ...
    void setSortedBackgroudCallList(List<String> backgroundCallList) {
        if (mInCallService != null) {
            mInCallService.setSortedBackgroudCallList(backgroundCallList);
        } else {
            Log.e(this, "error setSortedBackgroudCallList, mInCallService is null");
        }
    }
