...
public class AnhourlaterDownload extends Activity {
	...
	public void onClick(View v){
		...
		case R.id.anhour_download_sys_cancel://ȡ��			
   			this.finish();
			break;
		}
	}*/
