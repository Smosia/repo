	...
	protected void onCreate(Bundle savedInstanceState) {
	 ...
	 private void initSystem() {
		 ...
		 if(upinfo!=null){
		        ...
		        String packInfo="";
            //modify BUG_ID:JWBLB-684 dushuaihui 20150529(start)
			if(upinfo.getSize().trim().indexOf("B")>-1){
            //modify BUG_ID:JWBLB-684 dushuaihui 20150529(end)
             ...
             if(ActivityUtils.getParameter(getApplicationContext(), "packInfoANDversionInfo").equals("")){
                 ActivityUtils.setParameter(getApplicationContext(), "packInfoANDversionInfo", packInfo);
             }
