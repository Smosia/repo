...
public class AppStorageSettings extends AppInfoWithHeader
    ...
    protected boolean refreshUi() {
        ...
        refreshButtons();
        //A:DWYQLSSMY-687 xiangkezhu 20160419 start
        if("com.android.providers.media".equals(mAppEntry.info.packageName)){
            mClearDataButton.setVisibility(View.GONE);
            mClearCacheButton.setVisibility(View.GONE);
        }
        //A:DWYQLSSMY-687 xiangkezhu 20160419 end
        return true;
    }
