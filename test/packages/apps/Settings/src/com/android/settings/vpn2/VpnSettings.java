...
public class VpnSettings extends SettingsPreferenceFragment implements
    ...
    private boolean mUnlocking = false;//add BUG_ID:DELSLMY-747 dushuaihui 20160310
    ...
    public void onResume() {
        ...
        //add BUG_ID:DELSLMY-747 dushuaihui 20160310(start)
        ...
        mUnlocking = false;
        //add BUG_ID:DELSLMY-747 dushuaihui 20160310(end)
    }
    ...
    public boolean handleMessage(Message message) {
        ...
        //add BUG_ID:DWYSLM-307 dushuaihui 20160331(start)
        if(getActivity() == null){
            return true;
        }
        //add BUG_ID:DWYSLM-307 dushuaihui 20160331(end)
