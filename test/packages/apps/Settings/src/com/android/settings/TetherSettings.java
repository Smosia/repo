...
public class TetherSettings extends SettingsPreferenceFragment
    ...
    private void updateUsbState(String[] available, String[] tethered,
        ...
        if (usbTethered) {
            ...
            //M:DWYQLSSMY-759 xiangkezhu 20160422(start)
            //mUsbTether.setEnabled(true);
            //mUsbTether.setChecked(true);
            /// M: set usb tethering to false @{
            String summary;
            if(usbAvailable){
                Log.d(TAG, "usb is alailable");
                mUsbTether.setEnabled(true);
                mUsbTether.setChecked(true);
                /// M: set usb tethering to false @{
                summary = getString(R.string.usb_tethering_active_subtext);
            }else{
                Log.d(TAG, "usb is not alailable");
                mUsbTether.setEnabled(false);
                mUsbTether.setChecked(false);
                /// M: set usb tethering to false @{
                summary = getString(R.string.usb_tethering_unavailable_subtext);
            ...
            //M:DWYQLSSMY-759 xiangkezhu 20160422(end)
