    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(BluetoothDevice.ACTION_PAIRING_REQUEST)) {
            ...
            if (powerManager.isScreenOn() &&
				...
				//A:DWYQLSSMY-86 luoran 20160331 {
				if (powerManager != null) {
                    PowerManager.WakeLock mWakeLock = powerManager.newWakeLock(PowerManager.ACQUIRE_CAUSES_WAKEUP
                            | PowerManager.SCREEN_BRIGHT_WAKE_LOCK, "BluetoothPairingRequest");
