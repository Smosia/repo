                            ...
                            case CALLS_PICK:
                                ...
                                if (CdmaUtils.isCdmaCardCompetionForCalls(context, value)
                                    ...
                                    if (TelecomManager.from(context).isInCall()) {
                                     ...
                                     //modify BUG_ID:DWYSLM-1032 dushuaihui 20160525(start)
                                    if(phoneAccountsList != null && phoneAccountsList.size() == 1){
                                        setUserSelectedOutgoingPhoneAccount(phoneAccountsList.get(value));
                                    }else{
