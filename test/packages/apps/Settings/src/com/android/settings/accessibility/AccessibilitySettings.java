...
public class AccessibilitySettings extends SettingsPreferenceFragment implements DialogCreatable,
    ...
    //A: JWBLL-2453 liuhao 20150720 {
    private static final String NAVIBAR_PREFERENCE_SCREEN =
            "navibar_option_preference_screen";
    //A: }
    ...
    private void initializeAllPreferences() {
        ...
        if(getActivity().getResources().getBoolean(R.bool.disable_speak_password)){
        ...
        if (!config_HasNavibarInDisplay) {
            ...
            if (!hasNavibar) {
                mSystemsCategory.removePreference(mNavibarPreferenceScreen);
            }
        }
        //A: }
    }
