...
/****************************************
History:
1.gangzhou@ragentek 20160316 BUG_ID:DELSLMY-843
	Description: modify startup action
****************************************/
...
public class WallpaperTypeSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    private void populateWallpaperTypes() {
        ...
        for (ResolveInfo info : rList) {
			...
			//add BUG_ID:DELSLMY-843 gang.zhou 20160316 (start)
		if( info.activityInfo.name.equals("com.android.launcher3.WallpaperTypeActivity")){

			 info.activityInfo.name="com.android.launcher3.WallpaperItemPickerActivity";
			}
		//add BUG_ID:DELSLMY-843 gang.zhou 20160316 (end)
