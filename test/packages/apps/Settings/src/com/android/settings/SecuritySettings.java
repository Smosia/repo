...
//A DWYSLM-686 yeyu 20160427 start
...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    //A DWYSLM-686 yeyu 20160427 start
    private static final String KEY_UNLOCK_SET_OR_REVERIELOCK="unlock_set_or_reverieLock";
    ...
    private  PreferenceScreen root;//A DWYSLM-686 yeyu 20160427
    ...
    private static int getResIdForLockUnlockScreen(Context context,
        ...
        //A DWYSLM-686 yeyu 20160427 start
        if(context.getResources().getBoolean(R.bool.rgks_config)){
           if (preferences.getBoolean("start",false)){
               resid=R.xml.security_settings_reverie;
          	}
             }
        //A DWYSLM-686 yeyu 20160427 end
        return resid;
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        //A DWYSLM-686 yeyu 20160427 start
        preferences=getActivity().getSharedPreferences("configl",0);
        ...
        //A DWYSLM-686 yeyu 20160427 start
	  if(getActivity().getResources().getBoolean(R.bool.rgks_config)){
        Intent reverieIntent=new Intent();
        ComponentName componentName = new ComponentName(
                               "com.reverie.lockscreen", "com.reverie.lockscreen.LockService");
        reverieIntent.setComponent(componentName);
        if(resid==R.xml.security_settings_lockscreen||resid==R.xml.security_settings_chooser){
        getActivity().stopService(reverieIntent);
             }
	 }
        //A DWYSLM-686 yeyu 20160427 end
    ...
    private void addPluginEntrance(PreferenceGroup deviceAdminCategory) {
        ...
        //A: DWYQLSSMY-394 liuhuaizhi 20160329 (start)
        if(getResources().getBoolean(R.bool.remove_app_permissions)) {
        //A: DWYQLSSMY-394 liuhuaizhi 20160329 (end)        	
