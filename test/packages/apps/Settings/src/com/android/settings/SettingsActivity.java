...
import com.android.settings.deviceinfo.CyPrivateVolumeSettings;
import com.android.settings.deviceinfo.CyStorageRamPreference;
import com.android.settings.deviceinfo.CyStorageSettings;
...
import android.content.SharedPreferences;//add      BUG_ID:DWYSLM-686     yeyu  20160427
...
public class SettingsActivity extends Activity
   ...
   //add      BUG_ID:DWYSLM-686     yeyu  20160427
   ...
   //add      BUG_ID:DWYSLM-686     yeyu  20160427
    ...
    private static final String[] ENTRY_FRAGMENTS = {
            ...
            CyStorageSettings.class.getName(),
            PrivateVolumeForget.class.getName(),
            CyPrivateVolumeSettings.class.getName(),
    ...
    protected void onCreate(Bundle savedState) {
        ...
        //A by shubin DELSLMY-30 20160314 {
        if(initialFragmentName !=null && initialFragmentName.equals("com.android.settings.deviceinfo.StorageSettings")
        		&& getApplication().getResources().getBoolean(R.bool.cystorage_config)){
        	initialFragmentName="com.android.settings.deviceinfo.CyStorageSettings";
        	showDetails();
        	
        }
        if(initialFragmentName !=null && initialFragmentName.equals("com.android.settings.deviceinfo.PrivateVolumeSettings")
        		&& getApplication().getResources().getBoolean(R.bool.cystorage_config)){
        	initialFragmentName="com.android.settings.deviceinfo.CyPrivateVolumeSettings";
        ...
        params.height = 90;
        btn = new Button(this);
        btn.setBackgroundResource(R.drawable.clean_btn);
        /**
        btn.setOnTouchListener(new OnTouchListener() {
        	...
        	public boolean onTouch(View arg0, MotionEvent arg1) {
        		...
        		if(arg1.getAction()== MotionEvent.ACTION_DOWN){
        			arg0.setBackgroundResource(R.drawable.clean_btn_two);
        			
        		}else if (arg1.getAction()== MotionEvent.ACTION_UP){
        			arg0.setBackgroundResource(R.drawable.clean_btn);
        ...
        */
        //btn.setBackground(getResources().getDrawable(R.drawable.clean_btn));
        btn.setOnClickListener(new OnClickListener() {
        	
        	@Override
        	public void onClick(View arg0) {
        		// TODO Auto-generated method stub
        		//Intent intent = new Intent("clean.click");
        ...
        if(initialFragmentName=="com.android.settings.deviceinfo.CyStorageSettings"){
            ...
            if (buttonBar != null) {
                ...
                skipButton.setOnClickListener(new OnClickListener() {
                    public void onClick(View v) {
                       ...
                       //A DWYSLM-686 yeyu 20160427 end
                        if(getResources().getBoolean(R.bool.rgks_config)){
                        preferences=getSharedPreferences("configl",0);
    ...
    private void killProcesses(){
    	new AsyncTask<Void, Void, String>(){
			...
			protected void onPostExecute(String result) {
				...
				if ((afKill - bfKill) >= 0) {
					Toast.makeText(getApplication(), R.string.cy_toast_free_mem_none,
					...
					Toast.makeText(
							...
							getApplicationContext().getString(R.string.cy_toast_free_mem)
    ...
    private String formatFileSize(long size) {
		return Formatter.formatFileSize(getApplicationContext(), size);
	}
        ...
        mAm = (ActivityManager) getSystemService(Context.ACTIVITY_SERVICE);
 		...
 		try {
 			...
 			long[] pswap = ActivityManagerNative.getDefault().getProcessPswap(
 					pids);
 			float zramAdjust = (float) (updateTotalRamSize())
 					/ (float) (updateTotalRamSize() + Process.getZramExtraTotalSize());
 			for (int i = 0; i < processes.size(); i++) {
    ...
    public long updateTotalRamSize() {
		...
		//Log.d(TAG, " data = " + data + ", ceilData = " + Math.ceil(data));
		mtotalSize = (long) (Math.ceil(data) * 1024 * 1024 * 1024);
		//Log.d(TAG, "[updateTotalRamSize] totalSize = " + totalSize);
		return mtotalSize;
	} 
    ...
    private void updateTilesList(List<DashboardCategory> target) {
         ...
         if(getResources().getBoolean(R.bool.rgk_develop_settings_all_show)){
        ...
        for (int i = 0; i < size; i++) {
            ...
            while (n >= 0) {
                ...
                if (id == R.id.operator_settings || id == R.id.manufacturer_settings) {
                    ...
                    //A: DWYQLSSMY-414 kuangyunfeng 20160330(start)
                    if(getResources().getBoolean(R.bool.remove_power_settings)){
                        category.removeTile(n);
                    } else {
                    //A: DWYQLSSMY-414 kuangyunfeng 20160330(end)
                    Intent intent = new Intent(
				...
				//add      BUG_ID:JWLWEL-123     xieshanlin  20150204(start)
                else if(id == R.id.gesture_wake_settings) {
				    if(!"1".equals(SystemProperties.get("ro.rgk_app_wake_gesture"))) {
				        removeTile = true;
				    }
			    }
				//add      BUG_ID:JWLWEL-123     xieshanlin  20150204( end )
                //guocl  emergency_assistant (START)
                else if(id == R.id.emergency_assistant) {
                    if(getResources().getBoolean(R.bool.config_emergency_assistant)) {
                        removeTile = true;
                    }
                }
                //guocl  emergency_assistant (END)
