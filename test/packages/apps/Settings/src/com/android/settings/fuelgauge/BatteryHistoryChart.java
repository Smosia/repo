...
public class BatteryHistoryChart extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        //M:  DELSLM-1414 huangerhui 20160314 start{
        mTextPaint.setStrokeWidth(mThinLineWidth-6);
        mBatteryGoodPaint.setStrokeWidth(mThinLineWidth-6);
        mBatteryWarnPaint.setStrokeWidth(mThinLineWidth-6);
        mBatteryCriticalPaint.setStrokeWidth(mThinLineWidth-6);
        mChargingPaint.setStrokeWidth(mLineWidth-6);
        mScreenOnPaint.setStrokeWidth(mLineWidth-6);
        mGpsOnPaint.setStrokeWidth(mLineWidth-6);
        mCameraOnPaint.setStrokeWidth(mLineWidth-6);
        mFlashlightOnPaint.setStrokeWidth(mLineWidth-6);
        mWifiRunningPaint.setStrokeWidth(mLineWidth-6);
        mCpuRunningPaint.setStrokeWidth(mLineWidth-6);
    ...
    void drawChart(Canvas canvas, int width, int height) {
        ...
        if (mHavePhoneSignal) {
            ...
            mPhoneSignalChart.draw(canvas, top+6, mLineWidth-6);
            //M end}
        }
