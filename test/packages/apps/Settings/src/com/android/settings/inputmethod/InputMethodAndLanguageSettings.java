...
public class InputMethodAndLanguageSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        //M:DELSLM-288 guoshuai 20160203(start)
        //PreferenceCategory pointerSettingsCategory =
        //    (PreferenceCategory) findPreference("pointer_settings_category");
        PreferenceCategory pointerSettingsCategory = null;
        //M:DELSLM-288 guoshuai 20160203(end)
        mInputMethodExts = new InputMethodExts(activity, mShowsOnlyFullImeAndKeyboardList,
                voiceCategory, pointerSettingsCategory);
        //DELSLM-196 liuhuaizhi 20160129(start)
        if (getResources().getBoolean(R.bool.remove_pointer)) {
            Preference pointerSpeed = findPreference("pointer_speed");

            if (pointerSpeed != null) {
                pointerSettingsCategory.removePreference(pointerSpeed);
            }
        }
        //DELSLM-196 liuhuaizhi 20160129(end)
