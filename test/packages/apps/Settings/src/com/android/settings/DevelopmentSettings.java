...
public class DevelopmentSettings extends SettingsPreferenceFragment
    ...
    //A: DWYSLM-165 yeyu 20160319 {
    private static final String DEBUG_INPUT_CATEGORY_KEY = "debug_input_category";
    ...
    private static final String PROC_STATS_KEY = "proc_stats";
    private static final String MEDIA_CATEGORY_KEY = "media_category";
...
//A: BUG_ID:DWLEBM-45 lihuachun0311(start)
	private boolean mAllowDevelopSettingEnabled;
//A: BUG_ID:DWLEBM-45 lihuachun0311(end)
    @Override
...
//A: BUG_ID:DWLEBM-45 lihuachun0311(start)
 mAllowDevelopSettingEnabled = getActivity().getResources().getBoolean(
            R.bool.config_allow_develop_setting_enabled);
 //A: BUG_ID:DWLEBM-45 lihuachun0311(end)
        ...
        /// M: usb preference change
        //add BUG_ID:DWYSLM-165 yeyu 20160319 (start)
        if (!getActivity().getResources().getBoolean(R.bool.rgk_develop_settings_all_show)) {
            final boolean isShowAllDebug =
             ...
             if (!isShowAllDebug) {
                ...
                if (mBtHciSnoopLog != null) {
                    getPreferenceScreen().removePreference(mBtHciSnoopLog);
                }
                Preference procStats = (Preference) findPreference(PROC_STATS_KEY);
                if (procStats != null) {
                    getPreferenceScreen().removePreference(procStats);
                }
                PreferenceScreen mRunning =(PreferenceScreen) findPreference(RUNNING_APPS);
                if (mRunning != null) {
                    getPreferenceScreen().removePreference(mRunning);
                }
                
                if (debugDebuggingCategory != null) {
                    if (mClearAdbKeys != null) {
                        debugDebuggingCategory.removePreference(mClearAdbKeys);
                    }
                if (mMockLocationAppPref != null) {
                    debugDebuggingCategory.removePreference(mMockLocationAppPref);
                        }
                    ...
                    if (mDebugAppPref != null) {
                        debugDebuggingCategory.removePreference(mDebugAppPref);
                    }
                    if (mWaitForDebugger != null) {
                        debugDebuggingCategory.removePreference(mWaitForDebugger);
                    }
                    if (mVerifyAppsOverUsb != null) {
                        debugDebuggingCategory.removePreference(mVerifyAppsOverUsb);
                    }
                    if (mWifiDisplayCertification != null) {
                        debugDebuggingCategory.removePreference(mWifiDisplayCertification);
                    }
                    if (mDebugViewAttributes != null) {
                        debugDebuggingCategory.removePreference(mDebugViewAttributes);
                    }
                    if (mWifiVerboseLogging != null) {
                        debugDebuggingCategory.removePreference(mWifiVerboseLogging);
                    }
                    if (mWifiAggressiveHandover != null) {
                        debugDebuggingCategory.removePreference(mWifiAggressiveHandover);
                    }
                    if (mWifiAllowScansWithTraffic != null) {
                        debugDebuggingCategory.removePreference(mWifiAllowScansWithTraffic);
                    }
                    if (mLogdSize != null) {
                        debugDebuggingCategory.removePreference(mLogdSize);
                    }
                    
                }
                PreferenceCategory debugInputCategory = (PreferenceCategory) findPreference(DEBUG_INPUT_CATEGORY_KEY);
                if (debugInputCategory != null) {
                    getPreferenceScreen().removePreference(debugInputCategory);
                }
                PreferenceCategory debugDrawingCategory = (PreferenceCategory) findPreference(DEBUG_DRAWING_CATEGORY_KEY);
                if (debugDrawingCategory != null) {
                    getPreferenceScreen().removePreference(debugDrawingCategory);
                }
                PreferenceCategory debugHwDrawingCategory = (PreferenceCategory) findPreference(DEBUG_HW_DRAWING_CATEGORY_KEY);
                if (debugHwDrawingCategory != null) {
                    getPreferenceScreen().removePreference(debugHwDrawingCategory);
                }
                PreferenceCategory debugMonitoringCategory = (PreferenceCategory) findPreference(DEBUG_MONITORING_CATEGORY_KEY);
                if (debugMonitoringCategory != null) {
                    getPreferenceScreen().removePreference(debugMonitoringCategory);
                }
                PreferenceCategory debugNetworkCategory = (PreferenceCategory) findPreference(DEBUG_NETWORKING_CATEGORY_KEY);
                if (debugNetworkCategory != null) {
                    getPreferenceScreen().removePreference(debugNetworkCategory);
                }
                PreferenceCategory debugApplicationsCategory = (PreferenceCategory) findPreference(DEBUG_APPLICATIONS_CATEGORY_KEY);
                if (debugApplicationsCategory != null) {
                    getPreferenceScreen().removePreference(debugApplicationsCategory);
                }
                final PreferenceGroup mediaCategory = (PreferenceGroup) findPreference(MEDIA_CATEGORY_KEY);
                if (mediaCategory != null) {
                    getPreferenceScreen().removePreference(mediaCategory);
                }
        ...
        //add BUG_ID:DWYSLM-165 yeyu 20160319 (end)
 ...
 if (mAllowDevelopSettingEnabled) {//<!--add BUG_ID:DWLEBM-45 lihuachun 20160311-->
		...
		}//<!--add BUG_ID:DWLEBM-45 lihuachun 20160311-->
        mSwitchBar.show();
        /// M: usb preference change
