...
public class SeekBarVolumizer implements OnSeekBarChangeListener, Handler.Callback {
    ...
    public SeekBarVolumizer(Context context, int streamType, Uri defaultUri,
        ...
        // system
        if (mProfileIsActive||mStreamType==AudioManager.STREAM_ALARM) {
        ...
        if (!isSamplePlaying()) {
            ...
            if (mRingtone != null) {
                try {
                    ...
                    Uri defaultUri;
                    if (mStreamType == AudioProfileManager.STREAM_RING) {
                        defaultUri = mProfileManager.getRingtoneUri(mKey,AudioProfileManager.TYPE_RINGTONE);
                    } else if (mStreamType == AudioProfileManager.STREAM_NOTIFICATION) {
                        defaultUri = mProfileManager.getRingtoneUri(mKey,AudioProfileManager.TYPE_NOTIFICATION);
                    } else {
                        defaultUri = Settings.System.DEFAULT_ALARM_ALERT_URI;
                    }
