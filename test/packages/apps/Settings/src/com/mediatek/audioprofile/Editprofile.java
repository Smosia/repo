...
import com.android.settings.messagenotification.MessageNotificationRingtone;
import com.android.settings.messagenotification.SlotListEntrance; 
...
public class Editprofile extends SettingsPreferenceFragment {
    ...
    //Add, JWLW-1141, zhangzixiao, 20140326, Start
    public static final String KEY_CATEGORY_MESSAGE_NOTIFICATIONS = "message_notifications";
    public static final String KEY_CATEGORY_MESSAGE_NOTIFICATION = "message_notification";
    public static final String KEY_MESSAGE_RINGTONE = "pref_key_message_ringtone";
    public static final String KEY_MESSAGE_NOTIFICATIONS_RINGTONE="message_notifications_ringtone";
    //Add, JWLW-1141, zhangzixiao, 20140326, End
	...
	//Add, JWLW-1141, zhangzixiao, 20140326, Start
    private Preference mMessageNotificationsPref;
    private Preference mMessageNotificationPref;
    //Add, JWLW-1141, zhangzixiao, 20140326, End
	...
	//Add, JWLW-1141, zhangzixiao, 20140326, Start
	//mMessageNotificationsPref = findPreference(KEY_CATEGORY_MESSAGE_NOTIFICATIONS);
    mMessageNotificationsPref = findPreference(KEY_MESSAGE_NOTIFICATIONS_RINGTONE);
	mMessageNotificationPref = findPreference(KEY_CATEGORY_MESSAGE_NOTIFICATION);
	if(mIsSilentMode || mIsMeetingMode) {
	    parent.removePreference(mMessageNotificationsPref);
	    parent.removePreference(mMessageNotificationPref);
	} else if(AudioProfileManager.isSmsDualRingtoneSupport()) {
	    parent.removePreference(mMessageNotificationPref);
	} else if(AudioProfileManager.isSmsSingleRingtoneSupport()) {
	    parent.removePreference(mMessageNotificationsPref);
	    MessageNotificationRingtone msgRingtone = 
			(MessageNotificationRingtone) findPreference(KEY_MESSAGE_RINGTONE);
	    msgRingtone.setKey(mKey);
	    msgRingtone.setSimId(-1);
	} else {
	    parent.removePreference(mMessageNotificationsPref);
	    parent.removePreference(mMessageNotificationPref);
	}
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
		...
		//Add, JWLW-1141, zhangzixiao, 20140326, Start	
        }else if((preference.getKey()).equals("message_notifications_ringtone")) {	    Bundle bundle = new Bundle();
			//bundle.putString("title", mSIMSelectorTitle);
			bundle.putString("profileKey", mKey);
			startFragment(this, SlotListEntrance.class.getName(), -1, -1, bundle);
		//Add, JWLW-1141, zhangzixiao, 20140326, End	
		}
