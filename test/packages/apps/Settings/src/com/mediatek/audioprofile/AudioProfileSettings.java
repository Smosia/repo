...
public class AudioProfileSettings extends SettingsPreferenceFragment implements
    ...
    private void updatePreferenceHierarchy() {
        ...
        if (profileKeys.size() == AudioProfileManager.PREDEFINED_PROFILES_COUNT) {
            //modify DWLEBM-99 guowen 20160323 start
            ...
            //modify DWLEBM-99 guowen 20160323 end
    ...
    public void onClick(DialogInterface dialogInterface, int button) {
        ...
        case DIALOG_NAME:
            String title = mEditText == null ? "" : String.valueOf(mEditText
                    .getText());
            //modify DWYSLM-591 guowen 20160414 start
            //if (title.length() == 0) {
            if (title.length() == 0 || title.trim().equals("")) {
            //modify DWYSLM-591 guowen 20160414 end
        ...
        case DIALOG_RESET:
            ...
            boolean flag = mContext.getResources().getBoolean(com.android.internal.R.bool.def_music_plus_enabled);
            audioManager.setParameters(flag ? SoundEnhancement.SET_MUSIC_PLUS_ENABLED : SoundEnhancement.SET_MUSIC_PLUS_DISABLED);
            boolean flagBes =mContext.getResources().getBoolean(com.android.internal.R.bool.def_bes_loudness_enabled);
            audioManager.setParameters(flagBes ? SoundEnhancement.SET_BESLOUDNESS_ENABLED : SoundEnhancement.SET_BESLOUDNESS_DISABLED);
            boolean flagLossless =mContext.getResources().getBoolean(com.android.internal.R.bool.def_Lossless_BT_enabled);
            audioManager.setParameters(flagLossless ? SoundEnhancement.SET_LOSSLESSBT_ENABLED : SoundEnhancement.SET_LOSSLESSBT_DISABLED);
            mContext.sendBroadcast(new Intent("com.rgk.android.ResetZenModeSettings"));
            ...
            Settings.Secure.putString(getContentResolver(), Settings.Secure.ENABLED_NOTIFICATION_LISTENERS, "");
