...
public class TimerRingService extends Service implements AudioManager.OnAudioFocusChangeListener {
    ...
    //add BUG_ID:DELSLM-486 liqiang 20160224 (start)
    private Context context;
    //add BUG_ID:DELSLM-486 liqiang 20160224 (end)
    ...
    private void startAlarm(MediaPlayer player)
        ...
        if (audioManager.getStreamVolume(AudioManager.STREAM_ALARM) != 0) {
            ...
            audioManager.requestAudioFocus(
            		audioListener, AudioManager.STREAM_ALARM, AudioManager.AUDIOFOCUS_GAIN_TRANSIENT);
            player.start();
        }
    }
    ...
    private  AudioManager.OnAudioFocusChangeListener audioListener = new AudioManager.OnAudioFocusChangeListener() {
        public void onAudioFocusChange(int focusChange) {
		    ...
		    stop(context);
			//AlarmStateManager.setSnoozeState(mContext, mAlarmInstance,true);
            }
        }
    };
    //add BUG_ID:DELSLM-486 liqiang 20160224 (end)
