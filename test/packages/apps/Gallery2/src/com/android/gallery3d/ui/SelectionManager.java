...
public class SelectionManager {
    ...
    private boolean isFromActionSetAs;
    public void setFromActionSetAs(boolean isFromActionSetAs) {
        this.isFromActionSetAs = isFromActionSetAs;
    }
    ...
    public void toggle(Path path) {
        ...
        if (count == getTotalCount()) {
          // modify DWYBL-337 xiaoshun 20150401 (start)
          // selectAll();
          if(isFromActionSetAs && count == 1){
              isFromActionSetAs = false;
            } else{
            selectAll();
          }
            // modify DWYBL-337 xiaoshun 20150401 (end)
        }
