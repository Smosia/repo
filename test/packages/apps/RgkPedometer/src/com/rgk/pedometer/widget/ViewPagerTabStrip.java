...
public class ViewPagerTabStrip extends LinearLayout {
    ...
    public ViewPagerTabStrip(Context context, AttributeSet attrs) {
        ...
        int backgroundColor = 0x00FAFAFA;//0xff0fc6dc;
        ...
        mCirclePaint.setColor(0xff6ce1fa);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (childCount > 0) {
            ...
            float cx = selectedLeft + tabWidth / 2.0f;
            float cy = height / 2.0f + 5;
            // Log.d("sqm", "cx="+cx+",cy="+cy+",radius="+radius+"height="+height);
