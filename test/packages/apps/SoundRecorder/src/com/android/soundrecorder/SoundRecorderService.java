...
public class SoundRecorderService extends Service implements Player.PlayerListener,
     ...
     ******/
    public static  String mFilePathToScan = null;
    ...
    public void onScanCompleted(String path, Uri uri) {
        ...
        //modify Bug_id:DSYYLM-13 wanglin 20160107 (start)
        //String title = simpleDateFormat.format(date);
        String title = new File(path).getName();
        //modify Bug_id:DSYYLM-13 wanglin 20160107 (end)
        ...
        mToastHandler = new Handler() {
            public void handleMessage(android.os.Message msg) {
                ...
                switch (msg.what) {
      		    ...
      		    Toast.makeText(SoundRecorderService.this,getResources().getString(R.string.save_path)
    ...
    public boolean record(RecordParams params, int fileSizeLimit) {
        if (STATE_RECORDING == mCurrentState) {
            ...
            if (isCurrentFileEndWithTmp()) {
                ...
                //modify   BUG_ID:JWLWKK-216  xieshanlin  20140314(start)
				saveRecord();
				/*******
                file.delete();
                 *******/
				//modify   BUG_ID:JWLWKK-216  xieshanlin  20140314(end)
            }
            if (!isStorageMounted()) {
    ...
    private void receiveBroadcast(Context context, Intent intent) {
        ...
        if (Intent.ACTION_MEDIA_EJECT.equals(action)
            ...
            storeRecordParamsSettings();
            //modify   BUG_ID:DELSLMY-857  wanglin  20160311(start)
            if ((STATE_RECORDING == mCurrentState) || (STATE_PAUSE_RECORDING == mCurrentState)) {
                stopRecord();
            } else if (STATE_PLAYING == mCurrentState) {
                stopPlay();
            ...
            //modify   BUG_ID:DELSLMY-857  wanglin  20160311(end)
        }
    }
    ...
    public boolean isListener(OnStateChangedListener listener) {
    	//A:BUG_ID:DWLEBM-170 wanglin 20160413
    	if (mOnStateChangedListener ==null || listener ==null) {
			return false;
		}
    	//A:BUG_ID:DWLEBM-170 wanglin 20160413
  ...
  //bug_idDSYYLM-214 wanglin 20160113 start
