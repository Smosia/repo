    ...
    public void onCallStateChanged(Call call, int oldState, int newState) {
        ...
        if (newState == CallState.ACTIVE
                && (oldState == CallState.DIALING || oldState == CallState.CONNECTING
                        || (mContext.getResources().getBoolean(R.bool.incoming_connected_vibrate) && oldState == CallState.RINGING)) //add for DWYSLM-177 by songqingming
        ...
        //@}
            ...
            if (audioManager.getStreamVolume(AudioManager.STREAM_RING) > 0) {
                ...
                if (SystemProperties.get("ro.mtk_multisim_ringtone").equals("1")) {
                    ...
                    //modify DWYQLSSMY-766 guowen 20160426 start
                    Log.d(this, "before ringtoneUri: "+ringtoneUri);
                    if(ringtoneUri == null){
                        ringtoneUri = Uri.parse("com.mediatek.uri.silent_notificaton");
                    }else if (-1==RingtoneManager.validRingtoneUri(mContext,ringtoneUri,RingtoneManager.TYPE_RINGTONE)) {
                        ringtoneUri = RingtoneManager.getDefaultRingtoneUri(mContext, RingtoneManager.TYPE_RINGTONE);
                    }
                    //modify DWYQLSSMY-766 guowen 20160426 end
