...
public final class TelephonyUtil {
    ...
    /// M: Add for CTS
    private static final String CTS_PACKAGE_NAME = "com.android.cts.telecom";

    private static final String CTS_CALL_SERVICE_CLASS_NAME =
            "android.telecom.cts.CtsConnectionService";
    /// @}
     ...
     * @return
     */
    static boolean isCtsComponentName(ComponentName componentName) {
        final ComponentName ctsComponentName = new ComponentName(
                CTS_PACKAGE_NAME, CTS_CALL_SERVICE_CLASS_NAME);
        return ctsComponentName.equals(componentName);
    }
