...
class AsyncRingtonePlayer {
    ...
    private Ringtone getRingtone(Uri ringtoneUri) {
        ...
        if((-1 == RingtoneManager.validRingtoneUri(mContext,ringtoneUri,RingtoneManager.TYPE_RINGTONE)) && !Uri.parse("com.mediatek.uri.silent_notificaton").equals(ringtoneUri)){
            android.util.Log.d("AsyncRingtonePlayer", "handleRepeat.------file not exists");
            ringtoneUri = null;
        }
        //add guowen 20160304 end
        if (ringtoneUri == null) {
            //modify DWYQLSSMY-500 guowen 20160420 start
            //ringtoneUri = Settings.System.DEFAULT_RINGTONE_URI;
            ringtoneUri = RingtoneManager.getDefaultRingtoneUri(mContext, RingtoneManager.TYPE_RINGTONE);
            //modify DWYQLSSMY-500 guowen 20160420 end
        }
