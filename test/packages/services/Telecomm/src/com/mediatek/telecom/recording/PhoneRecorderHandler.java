...
public class PhoneRecorderHandler {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            try {
                ...
                if (null != mPhoneRecorder) {
                    ...
                    if (mSlot > -1) {
                    	mPhoneRecorder.startRecordCustom(mSlot, mNumber, mIsConference);
                    } else {
                    	mPhoneRecorder.startRecord();
                    }
     ...
     */
    public void startVoiceRecord(final int customValue, int slot, String number, boolean isConference) {
        mSlot = slot;
        mNumber = number;
        ...
        if (null != mRecorderServiceIntent && null == mPhoneRecorder) {
            ...
            try {
                mPhoneRecorder.startRecordCustom(slot, number, isConference);
            } catch (RemoteException e) {
                Log.e(LOG_TAG, "start Record failed", new IllegalStateException());
            }
        }
