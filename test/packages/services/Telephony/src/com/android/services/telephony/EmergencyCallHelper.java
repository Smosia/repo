...
public class EmergencyCallHelper {
    ...
    private static final int MSG_START_EXIT_AIRPLANE_MODE = 4;
    private static final int MSG_SET_RADIO_TECHNOLOGY_TIMEOUT = 5;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_RETRY_TIMEOUT:
                    onRetryTimeout();
                    break;
                case MSG_START_EXIT_AIRPLANE_MODE:
                    SomeArgs args2 = (SomeArgs) msg.obj;
                    EmergencyCallHelper.Callback callback2 =
                            (EmergencyCallHelper.Callback) args2.arg1;
                    args2.recycle();
                    startExitAirplaneModeInternal(callback2);
                    break;
                case MSG_SET_RADIO_TECHNOLOGY_TIMEOUT:
                    Log.d(EmergencyCallHelper.this, "MSG_SET_RADIO_TECHNOLOGY_TIMEOUT");
                    onComplete(true);
                    cleanup();
                    break;
                default:
    ...
    private static final long SET_RADIO_TECHNOLOGY_TIMEOUT_MILLIS = 30000;
    private Phone mRegisterPhone;
    ...
    private void startSequenceInternal(Phone phone, Callback callback) {
        ...
        mPhone = phone;
        mRegisterPhone = ((com.android.internal.telephony.PhoneProxy) phone).getActivePhone();
        Log.d(this, "mPhone:" + mPhone + ", mRegisterPhone:" + mRegisterPhone);
        /// @}
        mCallback = callback;
    ...
    private void onServiceStateChanged(ServiceState state) {
        ...
        Log.d(this, "onServiceStateChanged(), phonetype:" + mPhone.getPhoneType());
        if (mPhone.getPhoneType() != mRegisterPhone.getPhoneType()) {
    ...
    private void cleanup() {
        Log.d(this, "cleanup(), mRegisterReceiver:" + mRegisterReceiver);
        ...
        mRegisterPhone = null;
        mHandler.removeMessages(MSG_SET_RADIO_TECHNOLOGY_TIMEOUT);
    ...
    private void registerForServiceStateChanged() {
        ...
        mRegisterPhone = ((com.android.internal.telephony.PhoneProxy) mPhone).getActivePhone();
        mRegisterPhone.registerForServiceStateChanged(mHandler, MSG_SERVICE_STATE_CHANGED, null);
    }
    ...
    private void unregisterForServiceStateChanged() {
        ...
        if (mRegisterPhone != null) {
            mRegisterPhone.unregisterForServiceStateChanged(mHandler);  // Safe even if unnecessary
        }
    ...
    public void startExitAirplaneModeSequence(Callback callback) {
        Log.d(this, "startExitAirplaneModeSequence");
        SomeArgs args = SomeArgs.obtain();
        args.arg1 = callback;
        mHandler.obtainMessage(MSG_START_EXIT_AIRPLANE_MODE, args).sendToTarget();
    }

    private void startExitAirplaneModeInternal(Callback callback) {
        cleanup();
        mCallback = callback;
        ...
        intent.putExtra("forceChanged", true);
        mContext.sendBroadcastAsUser(intent, UserHandle.ALL);
        mHandler.sendEmptyMessageDelayed(MSG_SET_RADIO_TECHNOLOGY_TIMEOUT,
                SET_RADIO_TECHNOLOGY_TIMEOUT_MILLIS);
    }
    ...
    private class MyBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Log.d(EmergencyCallHelper.this, "Received ACTION_SET_RADIO_TECHNOLOGY_DONE");
            onComplete(true);
            cleanup();
        }
    }
