...
public class MobileNetworkSettings extends PreferenceActivity implements
        ...
        if (preference == mButtonPreferredNetworkMode) {
            ...
            if (buttonNetworkMode != settingsNetworkMode) {
                ...
                switch (buttonNetworkMode) {
                    ...
                    case Phone.NT_MODE_CDMA_NO_EVDO:
                    case Phone.NT_MODE_LTE_CDMA_AND_EVDO:
                    case Phone.NT_MODE_WCDMA_ONLY://add BUG_ID:DELSLMY-66 dushuaihui 20160303
                        // This is one of the modes we recognize
                        modemNetworkMode = buttonNetworkMode;
                        break;
                    default:
    ...
    private void UpdateEnabledNetworksValueAndSummary(int NetworkMode) {
        ...
        switch (NetworkMode) {
            case Phone.NT_MODE_WCDMA_ONLY:
                ...
                break;
                //add BUG_ID:DELSLMY-66 dushuaihui 20160303(end)
            case Phone.NT_MODE_GSM_UMTS:
            case Phone.NT_MODE_WCDMA_PREF:
                if (!mIsGlobalCdma) {
                    mButtonEnabledNetworks.setValue(
    ...
    private void onCreateMTK(PreferenceScreen prefSet) {
        ...
        if (FeatureOption.isMtkLteSupport()
                && (FeatureOption.isMtkSvlteSupport() || FeatureOption.isMtkSrlteSupport())
                && (TelephonyUtilsEx.isCDMAPhone(mPhone) || TelephonyUtilsEx.isCTRoaming(mPhone)
