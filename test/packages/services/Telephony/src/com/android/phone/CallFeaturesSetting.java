...
public class CallFeaturesSetting extends PreferenceActivity
    ...
    private void initUi() {
        ...
        if (!getResources().getBoolean(R.bool.auto_call_record_support)) {
            prefSet.removePreference(mAutoCallRecord);
        } else {
    ...
    private int getAutoCallRecordValue() {
        int autoRecordValue = Settings.Global.getInt(getContentResolver(),
    ...
    public void onPause() {
        ...
        /// M: WFC @{
        ExtensionManager.getCallFeaturesSettingExt()
                .onCallFeatureSettingsEvent(DefaultCallFeaturesSettingExt.PAUSE);
        /// @}
    }
