...
public class TelephonyProvider extends ContentProvider
{
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private void createCarriersTable(SQLiteDatabase db, String tableName) {
            ...
            //modify BUG_ID:DWYQLSSB-70 dushuaihui 20160525(start)
            String protocol = mContext.getResources().getString(R.string.def_carriers_protocol);
            String roaming_protocol = mContext.getResources().getString(R.string.def_carriers_roaming_protocol);
            String columns = "(_id INTEGER PRIMARY KEY,"
                    ...
                    + "csdnum TEXT DEFAULT '',"
                    + "protocol TEXT DEFAULT " + protocol + ","
                    + "roaming_protocol TEXT DEFAULT " + roaming_protocol + ",";
            //modify BUG_ID:DWYQLSSB-70 dushuaihui 20160525(end)
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            if (oldVersion < (6 << 16 | 6)) {
                ...
                String roaming_protocol = mContext.getResources().getString(R.string.def_carriers_roaming_protocol);
                db.execSQL("ALTER TABLE " + CARRIERS_TABLE +
                        " ADD COLUMN protocol TEXT DEFAULT " + protocol + ";");
                db.execSQL("ALTER TABLE " + CARRIERS_TABLE +
                        " ADD COLUMN roaming_protocol TEXT DEFAULT " + roaming_protocol + ";");
                //modify BUG_ID:DWYQLSSB-70 dushuaihui 20160525(start)
                oldVersion = 6 << 16 | 6;
            }
            // Modified by M [start]
