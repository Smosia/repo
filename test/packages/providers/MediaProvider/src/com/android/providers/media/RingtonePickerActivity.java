...
public final class RingtonePickerActivity extends AlertActivity implements
    ...
    //add DWLEBM-317 guowen 20160419 start
    private boolean mGetFocus = false;
    //add DWLEBM-317 guowen 20160419 end
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Add EWLLLN-465 chenshu 20160325 start----------------------
        if (!intent.getBooleanExtra("never_show_defalut", false)) {
        //Add EWLLLN-465 chenshu 20160325 end------------------------
    ...
    public void onPrepareListView(ListView listView) {
        ...
        if (mHasSilentItem) {
            ...
            //modify DELSLMY-558 guowen 20160311
            if (mExistingUri == null || Uri.parse("com.mediatek.uri.silent_notificaton").equals(mExistingUri)) {
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        if (positiveResult) {
            ...
            if (mClickedPos == mDefaultRingtonePos) {
                ...
                //modify DELSLMY-558 guowen 20160311 start
                //uri = null;
                if (RingtoneManager.TYPE_RINGTONE == mType) {
                    uri = Uri.parse("com.mediatek.uri.silent_notificaton");
                } else {
                    uri = null;
                }
                //modify DELSLMY-558 guowen 20160311 end
            } else {
    ...
    public void run() {
        ...
        if (ringtone != null) {
            ...
            //add DWLEBM-317 guowen 20160419 start
            int result=audioManager.requestAudioFocus(mAudioFocusListener, AudioManager.STREAM_RING, AudioManager.AUDIOFOCUS_GAIN_TRANSIENT);
    ...
    private void stopAnyPlayingRingtone() {
        ...
        //add DWLEBM-317 guowen 20160419 start
        if (mGetFocus && (null != audioManager) ) {
            if (AudioManager.AUDIOFOCUS_REQUEST_GRANTED == audioManager.abandonAudioFocus(mAudioFocusListener)) {
    ...
    protected void onResume() {
        ...
        //modify DELSLMY-828 guowen 20160311 start
        //if ((mClickedPos >= mStaticItemCount || (mHasSilentItem && mClickedPos == 1)) && (null != mExistingUri)) {
        if ((mClickedPos >= mStaticItemCount || (mClickedPos == 1) || 
            (mHasSilentItem && mClickedPos == (mHasMoreRingtonesItem ? 2 : 1))) && (null != mExistingUri)) {
        //modify DELSLMY-828 guowen 20160311 end
