...
public class MediaScannerService extends Service implements Runnable
{
    ...
    public void run()
    {
        ...
        /// M: add log to mark the service handle was created
        MtkLog.v(TAG, "service handle finish created");
    ...
    private BroadcastReceiver mUnmountReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            synchronized (this) {
                ...
                /// M: add handle for the service handle didn't startup @{
                if (mServiceHandler == null) {
                    MtkLog.d(TAG, "service Handle was null, skip the delay scan.");
                    return;
                }
                /// @}
