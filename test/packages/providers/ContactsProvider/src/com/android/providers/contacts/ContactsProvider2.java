            ...
            case PHONE_LOOKUP: {
                ...
                if (uri.getBooleanQueryParameter(PhoneLookup.QUERY_PARAMETER_SIP_ADDRESS, false)) {
                    ...
                    try {
                        ...
                        //add for positivo JWLW-84 songqingming 20130916 (start)
                        ...
                        //add for positivo JWLW-84 songqingming 20130916 (end)
                        ...
                        if (android.os.SystemProperties.getInt("ro.rgk_brazil_number_match", 0) == 1 || isBrazilConfig) {
                            ...
                            while (cursor.moveToNext()) {
                                ...
                                Log.d("test", "number="+normalizedNumber+",oldNumber="+oldNumber+",equal="+equal);
                                if (equal) {
                        ...
                        //modify for positivo JWLW-84 songqingming 20130916 (start)
                        /*
                        if (!foundResult) {
                        ...
                        */
                        ...
                        //modify for positivo JWLW-84 songqingming 20130916 (end)
                    }
                }
                break;
            }
