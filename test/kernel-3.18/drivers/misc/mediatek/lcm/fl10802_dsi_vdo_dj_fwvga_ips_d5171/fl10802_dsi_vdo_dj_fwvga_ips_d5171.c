...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		*/
		 ...
		 params->dsi.horizontal_sync_active = 18;//---6
		 params->dsi.horizontal_backporch =50;//33;//--30
		 params->dsi.horizontal_frontporch =50;//33;//--30
...
LCM_DRIVER fl10802_dsi_vdo_dj_fwvga_ips_d5171_lcm_drv = 
{
  .name = "fl10802_dsi_vdo_dj_fwvga_ips_d5171",
