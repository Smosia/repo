...
#define GC0310_TEST_PATTERN_CHECKSUM (0x320db133)		//(0x9a7e2324)

kal_bool GC0310_night_mode_enable = KAL_FALSE;
kal_uint16 GC0310_CurStatus_AWB = 0;
kal_bool run_test_pattern=0;
...
UINT32 GC0310SetTestPatternMode(kal_bool bEnable)
{
	...
	if(bEnable)
	{
		...
		GC0310_write_cmos_sensor(0x48,0x00);   //add
		GC0310_write_cmos_sensor(0x4f,0x00); 
		GC0310_write_cmos_sensor(0xfe,0x00); 
		...
		GC0310_write_cmos_sensor(0x0a,0x45);   //add 
		...
		GC0310_write_cmos_sensor(0xfe,0x00);      //add
		GC0310_write_cmos_sensor(0x26,0x00); 
		GC0310_write_cmos_sensor(0x2a,0x00);
		GC0310_write_cmos_sensor(0x2b,0x00); 
		GC0310_write_cmos_sensor(0x2c,0x00); 
		GC0310_write_cmos_sensor(0x2d,0x00); 
		GC0310_write_cmos_sensor(0x2e,0x00); 
		GC0310_write_cmos_sensor(0x2f,0x00);
		GC0310_write_cmos_sensor(0x30,0x00);
		GC0310_write_cmos_sensor(0x31,0x00);

		GC0310_write_cmos_sensor(0x9b,0x00);
		GC0310_write_cmos_sensor(0xdd,0x00);

		GC0310_write_cmos_sensor(0xfe,0x00);
		GC0310_write_cmos_sensor(0x4c,0x04);  //  input test  image
		
		GC0310_write_cmos_sensor(0xfe,0x00);*/
		/*GC0310_write_cmos_sensor(0xfe,0x00);                         
		GC0310_write_cmos_sensor(0x4f,0x00); //aec                   
		GC0310_write_cmos_sensor(0xfe,0x01);                         
		GC0310_write_cmos_sensor(0x0a,0x45);                         
		GC0310_write_cmos_sensor(0xfe,0x00);                         
		GC0310_write_cmos_sensor(0x48,0x00);                         
		GC0310_write_cmos_sensor(0x03,0x03);                         
		GC0310_write_cmos_sensor(0x04,0x50);                         
		GC0310_write_cmos_sensor(0x18,0x1a); //0a//[4]double reset   
		GC0310_write_cmos_sensor(0x40,0x08); //08                    
		GC0310_write_cmos_sensor(0x41,0x00);                         
		GC0310_write_cmos_sensor(0x42,0x00);                         
		GC0310_write_cmos_sensor(0x70,0x50);                         
		GC0310_write_cmos_sensor(0x71,0x20);                         
		GC0310_write_cmos_sensor(0x72,0x40);                         
		GC0310_write_cmos_sensor(0x77,0x40);                         
		GC0310_write_cmos_sensor(0x78,0x40);                         
		...
		GC0310_write_cmos_sensor(0xd0,0x40); //YCP                   
		GC0310_write_cmos_sensor(0xd1,0x20);                         
		GC0310_write_cmos_sensor(0xd2,0x20);                         
		                                   
		GC0310_write_cmos_sensor(0x26,0x00); //blk                   
		GC0310_write_cmos_sensor(0x2a,0x00); //offset ratio          
		GC0310_write_cmos_sensor(0x2b,0x00);                         
		GC0310_write_cmos_sensor(0x2c,0x00);                         
		GC0310_write_cmos_sensor(0x2d,0x00);                         
		GC0310_write_cmos_sensor(0x2e,0x00); //dark current ratio    
		GC0310_write_cmos_sensor(0x2f,0x00);                         
		GC0310_write_cmos_sensor(0x30,0x00);                         
		GC0310_write_cmos_sensor(0x31,0x00);                         
		                                   
		GC0310_write_cmos_sensor(0x9b,0x00); //asde_y_offset         
		GC0310_write_cmos_sensor(0xdd,0x00); //edge_sa               
		                                   
		GC0310_write_cmos_sensor(0xfe,0x00);                         
		GC0310_write_cmos_sensor(0x4c,0x04); //input_test_image  */   
		
		GC0310_write_cmos_sensor(0xfe , 0x00);
		GC0310_write_cmos_sensor(0x4f , 0x00); //aec
		GC0310_write_cmos_sensor(0x03 , 0x04);
		GC0310_write_cmos_sensor(0x04 , 0x18);
		GC0310_write_cmos_sensor(0x40 , 0x48); //08
		GC0310_write_cmos_sensor(0x41 , 0x00);
		GC0310_write_cmos_sensor(0x42 , 0x00);
		GC0310_write_cmos_sensor(0x70 , 0x50);
		GC0310_write_cmos_sensor(0x71 , 0x20);
...
void GC0310_Sensor_Init(void)
{
    ...
    GC0310_write_cmos_sensor(0x79,0x5f); 
        ...
        ///////////////////   DNDD  /////////////////////
        ///////////////////////////////////////////////// 
    GC0310_write_cmos_sensor(0x82,0x0f); 
    ...
    GC0310_write_cmos_sensor(0x92,0x03); //03
    GC0310_write_cmos_sensor(0x93,0x06); //03
	...
	GC0310_write_cmos_sensor(0xBF, 0x01);
	GC0310_write_cmos_sensor(0xc0, 0x0e);
	GC0310_write_cmos_sensor(0xc1, 0x29);
	GC0310_write_cmos_sensor(0xc2, 0x44);
	GC0310_write_cmos_sensor(0xc3, 0x5c);
	GC0310_write_cmos_sensor(0xc4, 0x6f);
	GC0310_write_cmos_sensor(0xc5, 0x82);
    ...
    GC0310_write_cmos_sensor(0x0c,0x00); //20
    GC0310_write_cmos_sensor(0x12,0x52);
    GC0310_write_cmos_sensor(0x13,0x36); //38
    ...
    GC0310_write_cmos_sensor(0x5b,0x02);  // 02 to 82 to 02
    ...
    GC0310_write_cmos_sensor(0x6b,0x00); 
    GC0310_write_cmos_sensor(0x6c,0x00);   // 00 to 0c
    GC0310_write_cmos_sensor(0x6d,0x02); 
    GC0310_write_cmos_sensor(0x6e,0x00);  // f0 to 00
    GC0310_write_cmos_sensor(0x6f,0x00); 
    GC0310_write_cmos_sensor(0x76,0x80); 
    GC0310_write_cmos_sensor(0x78,0xaf); 
    GC0310_write_cmos_sensor(0x79,0x75);
    GC0310_write_cmos_sensor(0x7a,0x40);
    GC0310_write_cmos_sensor(0x7b,0x70);
    GC0310_write_cmos_sensor(0x7c,0x0c); //0c to 08 8.11
         
    GC0310_write_cmos_sensor(0xa4,0x00); 
    GC0310_write_cmos_sensor(0xa5,0x00);
    GC0310_write_cmos_sensor(0x90,0x00); 
    GC0310_write_cmos_sensor(0x91,0x00);
    GC0310_write_cmos_sensor(0xa6,0xba); 
    GC0310_write_cmos_sensor(0xa7,0xa2); 
    GC0310_write_cmos_sensor(0x92,0xff); 
    GC0310_write_cmos_sensor(0x93,0xe3); 
    GC0310_write_cmos_sensor(0xa9,0xc1); 
    GC0310_write_cmos_sensor(0xaa,0x85); 
    GC0310_write_cmos_sensor(0x95,0x1f); 
    GC0310_write_cmos_sensor(0x96,0x00); 
    GC0310_write_cmos_sensor(0xab,0xa5); 
    GC0310_write_cmos_sensor(0xac,0x84);
    GC0310_write_cmos_sensor(0x97,0x59); 
    GC0310_write_cmos_sensor(0x98,0x1f); 
    GC0310_write_cmos_sensor(0xae,0xc7);   // b7 to d0
    GC0310_write_cmos_sensor(0xaf,0xa5); 
    GC0310_write_cmos_sensor(0x9a,0x59);
    GC0310_write_cmos_sensor(0x9b,0x1f); 
        
    GC0310_write_cmos_sensor(0xb0,0xe2);  // c8 to c0
    GC0310_write_cmos_sensor(0xb1,0x83);   // 97 to a8
    GC0310_write_cmos_sensor(0x9c,0x74); 
    GC0310_write_cmos_sensor(0x9d,0x59); 
    GC0310_write_cmos_sensor(0xb3,0x00); 
    GC0310_write_cmos_sensor(0xb4,0x00);
    GC0310_write_cmos_sensor(0x9f,0x00);
    GC0310_write_cmos_sensor(0xa0,0x00); 
    ...
    GC0310_write_cmos_sensor(0xa3,0x00);
    ...
    GC0310_write_cmos_sensor(0xb7,0x00);
    GC0310_write_cmos_sensor(0x8f,0x00);
    GC0310_write_cmos_sensor(0xb8,0xe7);
    GC0310_write_cmos_sensor(0xb9,0x6d);
...
GC0310_write_cmos_sensor(0x91, 0x00);
GC0310_write_cmos_sensor(0x92, 0xff);
GC0310_write_cmos_sensor(0x93, 0xdf);
GC0310_write_cmos_sensor(0x95, 0x1d);
GC0310_write_cmos_sensor(0x96, 0x01);
GC0310_write_cmos_sensor(0x97, 0x49);
GC0310_write_cmos_sensor(0x98, 0x16);
GC0310_write_cmos_sensor(0x9a, 0x49);
GC0310_write_cmos_sensor(0x9b, 0x20);
GC0310_write_cmos_sensor(0x9c, 0x8b);
GC0310_write_cmos_sensor(0x9d, 0x4b);
GC0310_write_cmos_sensor(0x9f, 0x00);
GC0310_write_cmos_sensor(0xa0, 0x00);
GC0310_write_cmos_sensor(0xa1, 0x00);
GC0310_write_cmos_sensor(0xa2, 0x00);
...
GC0310_write_cmos_sensor(0x88, 0x00);
GC0310_write_cmos_sensor(0x89, 0x00);
GC0310_write_cmos_sensor(0xa4, 0x01);
GC0310_write_cmos_sensor(0xa5, 0x01);
GC0310_write_cmos_sensor(0xa6, 0xbb);
GC0310_write_cmos_sensor(0xa7, 0x9f);
GC0310_write_cmos_sensor(0xa9, 0xc4);
GC0310_write_cmos_sensor(0xaa, 0xa8);
GC0310_write_cmos_sensor(0xab, 0xa9);
GC0310_write_cmos_sensor(0xac, 0x8a);
GC0310_write_cmos_sensor(0xae, 0xbf);
GC0310_write_cmos_sensor(0xaf, 0xab);
GC0310_write_cmos_sensor(0xb0, 0xc0);
GC0310_write_cmos_sensor(0xb1, 0x94);
GC0310_write_cmos_sensor(0xb3, 0x00);
GC0310_write_cmos_sensor(0xb4, 0x00);
GC0310_write_cmos_sensor(0xb5, 0x00);
GC0310_write_cmos_sensor(0xb6, 0x00);
...
GC0310_write_cmos_sensor(0xb7, 0x00);
GC0310_write_cmos_sensor(0x8f, 0x00);
GC0310_write_cmos_sensor(0xb8, 0xc3);
GC0310_write_cmos_sensor(0xb9, 0xa5);
    ...
    GC0310_write_cmos_sensor(0xd1,0x04);
    GC0310_write_cmos_sensor(0xd2,0x0a);
    GC0310_write_cmos_sensor(0xd3,0xfa);
    GC0310_write_cmos_sensor(0xd4,0x38);
    GC0310_write_cmos_sensor(0xd5,0xf2);
    ...
    GC0310_write_cmos_sensor(0xc4,0x55); 
    GC0310_write_cmos_sensor(0xc5,0x35); 
    GC0310_write_cmos_sensor(0xc6,0x30); 
    GC0310_write_cmos_sensor(0xc7,0x18); 
...
BOOL GC0310_set_param_banding(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_FLICKER_MODE_50HZ:
			...
			GC0310_write_cmos_sensor(0x27,0x01); //30fps
			GC0310_write_cmos_sensor(0x28,0xce);  
			GC0310_write_cmos_sensor(0x29,0x06); //15fps   436
			GC0310_write_cmos_sensor(0x2a,0x04); 
			GC0310_write_cmos_sensor(0x2b,0x09); //10fps 604
			GC0310_write_cmos_sensor(0x2c,0xa0); 
...
BOOL GC0310_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:	
			GC0310_write_cmos_sensor(0xfe, 0x01);
			GC0310_write_cmos_sensor(0x13, 0x36);//35  38
			GC0310_write_cmos_sensor(0xfe, 0x00);
		break;
...
UINT32 GC0310_MIPI_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
