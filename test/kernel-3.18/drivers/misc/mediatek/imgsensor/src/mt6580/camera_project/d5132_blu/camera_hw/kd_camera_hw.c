	...
	if (On) {
		...
		if ((currSensorName && (0 == strcmp(currSensorName, "imx135mipiraw"))) ||
			...
			mdelay(20);
						 ...
						 ||(pinSetIdx==1 && currSensorName && (0 == strcmp(SENSOR_DRVNAME_SUB_OV8858_MIPI_RAW,currSensorName)))||(pinSetIdx==1 &&currSensorName && (0 == strcmp(SENSOR_DRVNAME_SUB_QTOV8858_MIPI_RAW,currSensorName)))){
	            if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
								mtkcam_gpio_set(pinSetIdx, CAMPDN,
										pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
