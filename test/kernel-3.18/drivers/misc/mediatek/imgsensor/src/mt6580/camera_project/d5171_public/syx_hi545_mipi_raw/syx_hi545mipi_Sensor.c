...
#include "syx_hi545mipi_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = SYX_HI545_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h

    .checksum_value = 0xd823fac5,        //checksum value for Camera Auto Test, 0x40aeb1f5
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    kal_uint8 i = 0;
    kal_uint8 retry = 2;
   printk("[kangjun.li] the current value is %d\n",gpio_get_value(12));
