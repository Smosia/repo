...
#include "sub_hi553mipi_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "SUB_HI553_camera_sensor"
#define LOG_1 //LOG_INF("SUB_HI553,MIPI 2LANE\n")
...
extern int main_sub;
//#define SUB_HI553MIPI_I2C_ID  0x40
#define write_cmos_sensor(addr, para) iWriteReg((u16) addr , (u32) para , 2, 0x50)

static imgsensor_info_struct imgsensor_info = {
    	.sensor_id = SUB_HI553_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
static imgsensor_struct imgsensor = {
    ...
    .i2c_write_id = 0x50,//record current sensor's i2c write id
};
...
/*static void write_sub_hi553_sensor(kal_uint32 addr, kal_uint32 para)
{
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	...
	kal_uint8 i = 0;
	kal_uint8 retry = 4;
	printk("sub_hi553 [get_imgsensor_id] ");
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
            ...
            *sensor_id = return_sensor_id()-1;
             ...
             printk("xiaofei_sub_hi553 i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
				if (*sensor_id == imgsensor_info.sensor_id) {				
                                        printk("sub_hi553 i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
					return ERROR_NONE;
				}	
				retry--;
			} while(retry > 0);
...
printk("@xiaofei_open ");
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            ...
            printk("@xiaofei_sub_hi553 i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,sensor_id);
            if (sensor_id == imgsensor_info.sensor_id) {
                //LOG_INF("sub_hi553 i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,sensor_id);
                break;
            }
            //LOG_INF("sub_hi553 Read sensor id fail, write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id,sensor_id);
            retry--;
        } while(retry > 0);
        i++;
        if (sensor_id == imgsensor_info.sensor_id)
