...
static imgsensor_info_struct imgsensor_info = {
    ...
    .mipi_settle_delay_mode = 1,//0,MIPI_SETTLEDELAY_AUTO; 1,MIPI_SETTLEDELAY_MANNUAL change
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_R,//sensor output first pixel color//B
...
//	LOG_INF("E");
	...
	write_cmos_sensor(0x15,0x00);
	write_cmos_sensor(0x16,0xc1);*/
	write_cmos_sensor(0x17,0x14);//17
	//write_cmos_sensor(0x18,0x02);
	write_cmos_sensor(0x19,0x0b);
	write_cmos_sensor(0x1b,0x49); //48
	write_cmos_sensor(0x1c,0x12);
