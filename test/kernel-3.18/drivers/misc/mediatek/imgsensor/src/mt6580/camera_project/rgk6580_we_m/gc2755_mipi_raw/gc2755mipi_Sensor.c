...
static imgsensor_info_struct imgsensor_info = {
    ...
    .checksum_value = 0x47b2e15c,					//0xd700d28b,        //checksum value for Camera Auto Test

    .pre = {
        .pclk = 36000000,                //record different mode's pclk
        .linelength = 1626,                //record different mode's linelength
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0xf7,0x19); //pll enable
	write_cmos_sensor(0xf8,0x05); //Pll mode 2
	write_cmos_sensor(0xf9,0x0e); //[0] pll enable
	...
	write_cmos_sensor(0x06,0x02);
	write_cmos_sensor(0x07,0x00);
	write_cmos_sensor(0x08,0x58);
	...
	write_cmos_sensor(0x94, 0x0c);//08
