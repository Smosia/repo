...
#include "sub_hi545mipi_Sensor.h"

extern void kdSetI2CSpeed(u32 i2cSpeed);  

/****************************Modify Following Strings for Debug****************************/
#define DEBUG_TAG   "[V28]"
#define PFX "[SUB_HI545]"DEBUG_TAG
#define LOG_1 LOG_INF("SUB_HI545,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = SUB_HI545_2LANE_MIPI_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
UINT32 SUB_HI545_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
    /* To Do : Check Sensor status here */
    if (pfFunc!=NULL)
        *pfFunc=&sensor_func;
    return ERROR_NONE;
}    /*    SUB_HI545_MIPI_RAW_SensorInit    */
