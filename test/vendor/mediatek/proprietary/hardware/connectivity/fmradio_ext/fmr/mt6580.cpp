...
int MT6580_open_dev(const char *pname, int *fd)
{
	int ret = 0;
...
void MT6580_init(struct fm_cbk_tbl *cbk_tbl)
{
	//Basic functions.
	cbk_tbl->open_dev = MT6580_open_dev;
	...
	//cbk_tbl->stop_scan = MT6580_stop_scan;
