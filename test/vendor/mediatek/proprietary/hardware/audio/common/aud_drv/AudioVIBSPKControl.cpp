...
void AudioVIBSPKControl::setVibSpkHz(int32_t freq)
{
        ALOGD("setVibSpkHz freq=%d",freq);
        if (freq < 150 || freq > 200)
            return;
        setParameters(mSampleRate, freq, mModFreq, mDeltaFreq);
}
