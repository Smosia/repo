...
{
    LOG_DBG("+,cqIndex(%u),sceID(%u)",cfgData.cqIdx,cfgData.sceID);
...
MINT32 MdpMgrImp::startMdp(MDPMGR_CFG_STRUCT cfgData)
{
    ...
    LOG_INF("+,cqIdx(%u),sID(%u),cqPA(0x%x),tpVa(0x%x),tpPa(0x%x), src_crop,X(%u),FX(%u),Y(%u),FY(%u),W(%u),H(%u)", \
            ...
            cfgData.dstCropX,cfgData.dstCropFloatX,cfgData.dstCropY,cfgData.dstCropFloatY,cfgData.dstCropW,cfgData.dstCropH);
