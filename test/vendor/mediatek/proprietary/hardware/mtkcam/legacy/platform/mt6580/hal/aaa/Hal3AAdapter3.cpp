...
#define _TEST_SCENE_MODE    (1<<16)
        ...
        {
            {
                ...
                GET_PROP("debug.hal3av3.iso", "200", iso);
                MINT64 exp = 33000L;
                GET_PROP("debug.hal3av3.exp", "33000", exp);
                rParam.i8ExposureTime = exp * 1000L;
                rParam.i4Sensitivity = iso;
            }
            rParam.i8FrameDuration = 33000000L;
        }
    ...
    if (u4Flag & _TEST_TONEMAP2)
    {
        ...
        GET_PROP("debug.hal3av3.tonemap_gamma", "2.2", fGamma);
        GET_PROP("debug.hal3av3.tonemap_preset", "0", u1PresetCurve);
...
start(MINT32 i4StartNum)
{
    ...
    mpHal3aObj->sendCommand(NS3Av3::ECmd_Update, reinterpret_cast<MUINTPTR>(&_3AProf));
    MY_LOG("[%s] Update 3", __FUNCTION__);
    _3AProf.i4MagicNum = 3;
    mpHal3aObj->sendCommand(NS3Av3::ECmd_Update, reinterpret_cast<MUINTPTR>(&_3AProf));
    mu1Start = 1;
    return 0;
}
