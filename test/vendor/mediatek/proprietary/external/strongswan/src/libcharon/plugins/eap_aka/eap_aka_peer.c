									...
									identification_t *peer)
{
...
#ifdef ANDROID
	/*
	 * ID_RFC822_ADDR = 0, ID_RFC822_ADDR_MAC = 1, ID_RFC822_ADDR_MAC_EAP_NO_MAC = 2
	...
	if (get_cust_setting_int(IKE_IDI) == 2)
	{
		...
		/* ID_RFC822_ADDR_MAC format: 0260060073769156@00-01-02-03-04-05:nai.epc.mnc006.mcc260.3gppnetwork.org */
