...
/**
 * Public API for the GATT Find Me Profile(Client).
 *
 * Name: Find Me
 ...
 * Role: FindMeLocator
 */
public class FmpFindMeLocator extends ClientBase {
    private static final boolean DBG = true;
    private static final String TAG = "FmpFindMeLocator";

    /**
     * Create a FmpFindMeLocator object and init value.
     *
     * @param context App context
     */
    public FmpFindMeLocator(Context context) {
        super(context);

        if (DBG) {
            Log.d(TAG, "FmpFindMeLocator()");
        }
    }
