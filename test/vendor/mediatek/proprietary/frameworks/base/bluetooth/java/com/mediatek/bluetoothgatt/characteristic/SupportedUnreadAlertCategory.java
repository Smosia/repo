...
/**
 * Public API for the Supported Unread Alert Category Bluetooth GATT Characteristic.
 *
 * <p>This class provides Supported Unread Alert Category Bluetooth GATT Characteristic
 * value encode/decode functions. Allowing applications easy and quick to
 * read/write characteristic field value.
 *
 * <p>Name: Supported Unread Alert Category
 * Type: org.bluetooth.characteristic.supported_unread_alert_category
 * UUID: 2A48
 * Last Modified: None
 * Revision: None
 */
public class SupportedUnreadAlertCategory extends CharacteristicBase {
    /**
    ...
    /**
     * Create a SupportedUnreadAlertCategory characteristic object.
     */
    public SupportedUnreadAlertCategory() {
        setCharacteristic(null);

    }

    /**
     * Create a SupportedUnreadAlertCategory characteristic object and init value.
     *
     * @param value Initial value
     */
    public SupportedUnreadAlertCategory(byte[] value) {
        setCharacteristic(null);
        setValue(value);
    }
     ...
     */
    public SupportedUnreadAlertCategory(byte[] value, BluetoothGattCharacteristic characteristic) {
    ...
    /**
     * Get SupportedUnreadAlertCategory characteristic byte length.
     *
    ...
    /**
     * Get SupportedUnreadAlertCategory characteristic UUID.
     *
    ...
    /**
     * Get SupportedUnreadAlertCategory characteristic value.
     *
    ...
    /**
     * Set SupportedUnreadAlertCategory characteristic value.
     *
    ...
    /**
     * Return true if SupportedUnreadAlertCategory support CategoryIdBitMask field.
     *
     * @return  True, if SupportedUnreadAlertCategory support CategoryIdBitMask field.
     */
