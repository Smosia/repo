...
/**
 * Public API for the GATT Reference Time Update Service.
 *
 * <p>Name: Reference Time Update Service
 * Type: org.bluetooth.service.reference_time_update
 * UUID: 1806
 * Last Modified: None
 * Revision: None
 */
public class Rtus extends ServiceBase {
    /**
    ...
    /**
     * Get Reference Time Update Service UUID.
     *
     * @return Service UUID
     */
    @Override
    ...
    protected void loadServiceConfig() {
        addTimeUpdateControlPoint();
        addTimeUpdateState();
    }

    /**
     * Add TimeUpdateControlPoint with default settings.
     */
    void addTimeUpdateControlPoint() {

        addCharacteristic(
                true,
                GattUuid.CHAR_TIME_UPDATE_CONTROL_POINT,
                BluetoothGattCharacteristic.PROPERTY_WRITE_NO_RESPONSE,
                BluetoothGattCharacteristic.PERMISSION_WRITE,
                new TimeUpdateControlPoint().getValue()
        );

    }

    /**
     * Add TimeUpdateState with default settings.
     */
    void addTimeUpdateState() {
