...
/**
 * Public API for the GATT Next DST Change Service.
 *
 * <p>Name: Next DST Change Service
 * Type: org.bluetooth.service.next_dst_change
 * UUID: 1807
 * Last Modified: None
 * Revision: None
 */
public class Ndcs extends ServiceBase {
    /**
    ...
    /**
     * Get Next DST Change Service UUID.
     *
     * @return Service UUID
     */
    @Override
    ...
    /**
     * Add TimeWithDst with default settings.
     */
    void addTimeWithDst() {
