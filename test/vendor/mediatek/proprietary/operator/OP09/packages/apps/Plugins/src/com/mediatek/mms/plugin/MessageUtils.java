...
public class MessageUtils {
    ...
    public static void dealCTDeviceLowNotification(Context context) {
        ...
        try {
            resourceContext = context.createPackageContext("com.mediatek.op09.plugin",
                    Context.CONTEXT_IGNORE_SECURITY);
        } catch (Exception e) {
            Log.e(TAG, "dealCTDeviceLowNotification,NotFoundContext");
        }

        getStorageLowPlugin(resourceContext);
        if (getCTDeviceStorageLowStatus()) {
            ...
            Notification notification = new Notification.Builder(resourceContext)
            .setContentTitle(notificationTitle)
            .setContentText(sStorageLowPlugin.getNotificationBody())
            .setSmallIcon(R.drawable.stat_sys_no_sim)
            .build();
    ...
    private static void getStorageLowPlugin(Context context) {
        ...
        sStorageLowPlugin = Op09StorageLowExt.getIntance(context);
    }
