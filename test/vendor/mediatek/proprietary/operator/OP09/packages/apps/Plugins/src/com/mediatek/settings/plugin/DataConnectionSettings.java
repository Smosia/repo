...
public class DataConnectionSettings extends PreferenceActivity {
    ...
    public void onResume() {
        ...
        int subId1 = SubscriptionManager.getSubIdUsingPhoneId(PhoneConstants.SIM_ID_1);
        int subId2 = SubscriptionManager.getSubIdUsingPhoneId(PhoneConstants.SIM_ID_2);
        getContentResolver().registerContentObserver(
