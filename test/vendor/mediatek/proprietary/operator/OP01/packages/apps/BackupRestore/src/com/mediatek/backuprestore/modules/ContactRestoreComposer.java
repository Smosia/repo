...
public class ContactRestoreComposer extends Composer {
    ...
    private boolean deleteAllContact() {
        if (mContext != null) {
            ...
            int count = mContext.getContentResolver().delete(
                    ...
                    ContactsContract.RawContacts._ID + ">0 AND " + RawContacts.INDICATE_PHONE_SIM
                            + "= -1", null);
    ...
    private boolean readOneVCard(InputStream is, int vcardType, final VCardInterpreter interpreter,
        ...
        for (int i = 0; i < length; i++) {
            ...
            try {
                ...
                // mVCardParser.
                synchronized (this) {
                    vcardParser = (vcardVersion
                            == VCardConfig.VCARD_TYPE_V21_GENERIC) ? new VCardParser_V21(
    ...
    public void onStart() {
        ...
        try {
            String fileName = mParentFolderPath + File.separator + ModulePath.FOLDER_CONTACT
