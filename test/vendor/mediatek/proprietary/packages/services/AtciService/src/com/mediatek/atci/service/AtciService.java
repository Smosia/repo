                        ...
                        if (false == SystemProperties.get("ro.mtk_gemini_support").equals("1")) {
                            try {
                                ...
                                if (iTelephony != null) {
                                    switch (callId) {
                                    case 0:
                                        if (!iTelephony.isIdle(mContext.getOpPackageName())) {
                                            iTelephony.endCall();
                                        }
                                        break;
                                    case 1:
...
*/
        ...
        mAtParser.register("%DIAL", new AtCommandHandler() {
            ...
            // private static final int VIDEO_CALL = 0x1;
    ...
    protected void initializeAtSystemCall() {
        ...
        mAtParser.register("%DATAON", new AtCommandHandler() {
            ...
            private INetworkManagementService nwService = INetworkManagementService.Stub.
        ...
        mAtParser.register("%ENABLEDATA", new AtCommandHandler() {
            private INetworkManagementService nwService = INetworkManagementService.
