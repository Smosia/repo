...
public class ImsService extends IImsService.Stub {
    ...
    /// M: IMS Configuration
    /// Maintain ImsConfigStub instance for each phoneId
            ...
            /// @}
                ...
                synchronized (mImsConfigInstanceMap) {
                    if (mImsConfigInstanceMap.containsKey(phoneId)) {
                        ...
                        instance = new ImsConfigStub(context, mImsRILAdapter, phoneId);
    ...
    public ImsService(Context context) {
        ...
        if (sImsConfig == null) {
            sImsConfig = new ImsConfigStub(mContext,mImsRILAdapter);
        }
            ...
            try {
                ...
                if (SubscriptionManager.isValidPhoneId(mainPhoneId)) {
                    synchronized (this) {
                        ...
                        ImsConfigStub instance = new ImsConfigStub(mContext, mImsRILAdapter, mainPhoneId);
        ...
        if ((SystemProperties.getInt("persist.mtk.volte.enable", 0) == 1) ||
            ...
            if (mainPhoneId >= 0) {
                turnOnIms(mainPhoneId);
            } else {
                Rlog.d(LOG_TAG, "ImsService init ITelephonyEx not ready");
            }
        }else {
            if (mainPhoneId >= 0) {
                turnOffIms(mainPhoneId);
            } else {
                Rlog.d(LOG_TAG, "ImsService init ITelephonyEx not ready");
            }
        }
    ...
    public IImsConfig getConfigInterface(int phoneId) {
        ...
        synchronized (mImsConfigInstanceMap) {
            if (mImsConfigInstanceMap.containsKey(phoneId)) {
                ...
                Rlog.w(LOG_TAG, "B");
                instance = new ImsConfigStub(mContext, mImsRILAdapter, phoneId);
                mImsConfigInstanceMap.put(phoneId, instance);
            }
        }
        return instance;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case EVENT_IMS_ENABLING_URC:
                    ...
                    if (DBG) {
                        Rlog.d(LOG_TAG, "EVENT_IMS_ENABLING_URC: mActivePhoneId = " +
                            mActivePhoneId + " phoneId = " + phoneId);
                    }
                ...
                case EVENT_IMS_DISABLING_URC:
                    //+EIMS: 0
                    if (DBG) {
                        Rlog.d(LOG_TAG, "EVENT_IMS_DISABLING_URC: mActivePhoneId = " +
                            mActivePhoneId + " phoneId = " + phoneId);
                    }
