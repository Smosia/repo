...
public class CameraActivity extends ActivityBase implements
  ...
  //add DELSLMY-613 anxiang.xiao 20160309 end
    ...
    public void gotoGallery() {
        ...
        // gulincheng 20160217 mediatek camera use mediatek gallery start
        if ( getResources()
                .getBoolean(R.bool.mtkgallery_only)) {
            intent.setClassName("com.android.gallery3d",
                    "com.android.gallery3d.app.GalleryActivity");
        }
        // gulincheng 20160217 mediatek camera use mediatek gallery end
