...
public class PickerManager extends ViewManager implements Listener,
    ...
    public interface PickerListener {
        ...
        //cxd
        boolean onFontFlashPiceked(String fontflashMode);
    ...
    //cxd
    private PickerButton mFontFlashPicker;
    ...
    //cxd
    private static final int BUTTON_FONT_FLASH = 7;
    private PickerButton[] mPickerButtons = new PickerButton[PICKER_BUTTON_NUM];

    private static final int MAX_NUM_OF_SHOWEN = 4;
    private int[] mButtonPriority = { BUTTON_SLOW_MOTION, BUTTON_HDR, BUTTON_FLASH,  /*cxd*/BUTTON_FONT_FLASH, BUTTON_CAMERA,
    ...
    static {
        ...
        //cxd
        sShownStatusRecorder[BUTTON_FONT_FLASH] = false;
    }
    ...
    protected View getView() {
        ...
        //cxd
        mFontFlashPicker = (PickerButton) view.findViewById(R.id.onscreen_font_flash_picekr);
        ...
        //cxd
        mPickerButtons[BUTTON_FONT_FLASH] = mFontFlashPicker;
        applyListeners();
        return view;
    }
    ...
    private void applyListeners() {
        ...
        //cxd
        if (mFontFlashPicker != null) {
        	mFontFlashPicker.setListener(this);
        }
    ...
    private void clearListeners() {
        ...
        //cxd
        if (mFontFlashPicker != null) {
        	mFontFlashPicker.setListener(null);
        }
        if (mCameraPicker != null) {
        ...
        if (!mDefineOrder) {
            ...
            for (int i = 0; i < mButtonPriority.length; i++) {
                ...
                case BUTTON_FLASH:
                    ...
                    break;
                    //cxd
                case BUTTON_FONT_FLASH:
                	pref = (IconListPreference) getContext().getListPreference(
                			SettingConstants.ROW_SETTING_FONT_FLASH);
                	break;
                case BUTTON_CAMERA:
                    pref = (IconListPreference) getContext().getListPreference(
    ...
    public boolean onPicked(PickerButton button, ListPreference pref, String newValue) {
        ...
        if (mListener != null) {
            ...
            case BUTTON_FLASH:
                ...
                //cxd
            case BUTTON_FONT_FLASH:
            	picked = mListener.onFontFlashPiceked(newValue);
            	break;
            case BUTTON_CAMERA:
    ...
    public void onRefresh() {
        ...
        mFlashPicker.initialize((IconListPreference) getContext().getListPreference(
                SettingConstants.ROW_SETTING_FLASH));
        //cxd
        mFontFlashPicker.initialize((IconListPreference) getContext().getListPreference(
        		SettingConstants.ROW_SETTING_FONT_FLASH));
    ...
    public void setEnabled(boolean enabled) {
        ...
        //cxd
        if (mFontFlashPicker != null) {
        	mFontFlashPicker.setEnabled(enabled);
        	mFontFlashPicker.setClickable(enabled);
        }
        if (mCameraPicker != null) {
