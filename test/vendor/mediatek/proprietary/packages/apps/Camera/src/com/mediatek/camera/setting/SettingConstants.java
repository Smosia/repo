...
public class SettingConstants {
    ...
    //A:DELSLMY-731  wxd for contrl volume key start 20160310
     public static final String KEY_VOLUME = "pref_camera_volume_key";
    ...
    //add Touch focus sound by cxd 20160406 start
    public static final String KEY_FOCUS_SOUOND = "pref_focus_sound_key";
    //end
    
    
 // add BUG_ID:null  add mirror view (start)
    public static final String KEY_CAMERA_MIRROR_VIEW = "pref_mirror_view_key";
// add BUG_ID:null  add mirror view (end)
    
    //add by xiaodong.cheng for font flash
    public static final String KEY_FONT_FLASH = "pref_font_flash_key";
    //end
    ...
    //A:DELSLMY-731  wxd for contrl volume key start 20160310
	public static final int ROW_SETTING_VOLUME                = 61;
	//A:DELSLMY-731  wxd for contrl volume key end 20160310
    ...
    //A: DWYQLSSMY-161  anxiang.xiao  for shutter sound switch end 20160323
    //add Touch focus sound by cxd 20160406 start
    public static final int ROW_SETTING_FOCUS_SOUND               = 63;//common
    //end
    
    // BUG_ID:null  add mirror view (start)
    public static final int ROW_SETTING_CAMERA_MIRROR_VIEW = 64; //camera
    // BUG_ID:null  add mirror view (end)
    
    public static final int ROW_SETTING_FONT_FLASH = 65; //common
    ...
    static {
        ...
        SETTING_TYPE[ROW_SETTING_DNG]                       = ONLY_IN_PEFERENCE;
         //A:DELSLMY-731  wxd for contrl volume key start 20160310
        SETTING_TYPE[ROW_SETTING_VOLUME]                = ONLY_IN_PEFERENCE;
		//A:DELSLMY-731  wxd for contrl volume key end 20160310
      ...
      //A: DWYQLSSMY-161  anxiang.xiao  for shutter sound switch end 20160323
        ...
        //add Touch focus sound by cxd 20160406 start
        SETTING_TYPE[ROW_SETTING_FOCUS_SOUND]               = ONLY_IN_PEFERENCE;
        //end
        
        // BUG_ID:null  add mirror view by anxiang.xiao (start)
        SETTING_TYPE[ROW_SETTING_CAMERA_MIRROR_VIEW]       = ONLY_IN_PEFERENCE;
        // BUG_ID:null  add mirror view   by anxiang.xiao(end)
        // add BUG_ID:DWYYL-1293 weipengfei 20150610 (end)
        
        //add by xiaodong.cheng for font flash start
        SETTING_TYPE[ROW_SETTING_FONT_FLASH]               = ONLY_IN_PEFERENCE;
        //end
    ...
    static {
		...
		//A:DELSLMY-731  wxd for contrl volume key start 20160310
		KEYS_FOR_SETTING[ROW_SETTING_VOLUME]            = KEY_VOLUME;
		//A:DELSLMY-731  wxd for contrl volume key end 20160310
        ...
        //A: DWYQLSSMY-161  anxiang.xiao  for shutter sound switch end 20160323
        //add Touch focus sound by cxd 20160406 start
        KEYS_FOR_SETTING[ROW_SETTING_FOCUS_SOUND]           = KEY_FOCUS_SOUOND;
        //end
        
    	// add BUG_ID:null  add mirror view  by anxiang.xiao(start)
        KEYS_FOR_SETTING[ROW_SETTING_CAMERA_MIRROR_VIEW]   = KEY_CAMERA_MIRROR_VIEW;
        // add BUG_ID:null  add mirror view  by anxiang.xiao (end)
        //add by xiaodong.cheng for font flash
        KEYS_FOR_SETTING[ROW_SETTING_FONT_FLASH]            = KEY_FONT_FLASH;
        //end
    };
    ...
    public static final int[] SETTING_GROUP_COMMON_FOR_TAB = new int[]{
        ...
        //A: DWYQLSSMY-161  anxiang.xiao  for shutter sound switch end 20160323\
        //add Touch focus sound by cxd 20160406 start
        ROW_SETTING_FOCUS_SOUND,
        //end
        
    	// add BUG_ID:null  add mirror view  by anxiang.xiao(start)
        ROW_SETTING_CAMERA_MIRROR_VIEW,// camera
        // add BUG_ID:null  add mirror view  by anxiang.xiao (end)
        ROW_SETTING_FONT_FLASH, //common add by xiaodong.cheng for font flash
    };
    ...
    public static final int[] SETTING_GROUP_CAMERA_FOR_UI = new int[] {
		...
		//A:DELSLMY-731  wxd for contrl volume key end 20160310
        //add chengxiaodong
        ROW_SETTING_FONT_FLASH, //common
        //end
		//A: DWYQLSSMY-161  anxiang.xiao  for shutter sound switch start 20160323
        ROW_SETTING_SHUTTER_SOUND,//common
        //A: DWYQLSSMY-161  anxiang.xiao  for shutter sound switch end 20160323
        //add Touch focus sound by cxd 20160406 start
        ROW_SETTING_FOCUS_SOUND,//common
        //end
