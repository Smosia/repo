        ...
        if (mState == STATE_FOCUSING_SNAP_ON_FINISH) {
            ...
            if (focused) {
                ...
                if (!Parameters.FOCUS_MODE_CONTINUOUS_PICTURE.equals(mFocusMode)) {
                	//add touch focus sound 20160406 start
                	//mListener.playSound(MediaActionSound.FOCUS_COMPLETE);
                	String defaultFocusSoundSwitch = mContext.getResources().getString(R.string.pref_focus_sound_default);
                	if("on".equals(mPreferences.getString(SettingConstants.KEY_FOCUS_SOUOND, defaultFocusSoundSwitch))) {
                        mListener.playSound(MediaActionSound.FOCUS_COMPLETE);
                	}
                	//end
                }
