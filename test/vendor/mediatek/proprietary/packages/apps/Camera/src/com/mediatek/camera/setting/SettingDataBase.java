...
//        video   videopip   smile     gesture   refecous
 ...
 MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_SLOW_MOTION_VIDEO_QUALITY]    = new int[]{
        ...
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_CAMERA_MIRROR_VIEW]    = new int[]{
        		STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, 
        		STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, };
        // add BUG_ID:null  add mirror view  by anxiang.xiao (end)
        //cxd
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_FONT_FLASH]            = new int[]{STATE_E0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0, STATE_R0,  STATE_E0, STATE_R0, STATE_E0, STATE_R0, STATE_E0, STATE_E0, STATE_R0};//font flash
    ...
    static {
    	//cxd
    	RESET_STATE_VALUE[SettingConstants.ROW_SETTING_FONT_FLASH]       = new String[]{"off"};//off
        ...
        // add BUG_ID:null  add mirror view  by anxiang.xiao start  (start)
        RESET_STATE_VALUE[SettingConstants.ROW_SETTING_CAMERA_MIRROR_VIEW]    = new String[]{"off"};
        // add BUG_ID:null  add mirror view  by anxiang.xiao start (end)
    }
    ...
    static {
        ...
        //add BUG_ID:null  add mirror view  by anxiang.xiao start  (start)
        DEFAULT_VALUE_FOR_SETTING_ID[SettingConstants.ROW_SETTING_CAMERA_MIRROR_VIEW]    = R.string.pref_camera_mirror_view_default;
        //add BUG_ID:null  add mirror view  by anxiang.xiao start  (end)
    }
       ...
       new Restriction(SettingConstants.ROW_SETTING_DISTANCE)
        ...
        .setRestrictions(
            new Restriction(SettingConstants.ROW_SETTING_FACEBEAUTY_BIG_EYES)
                .setValues("disable-value")),
        //add by xiaodong.cheng for font flash and zsd
        new Restriction(SettingConstants.ROW_SETTING_FONT_FLASH)
        .setValues("on")
        .setRestrictions(new Restriction(SettingConstants.ROW_SETTING_ZSD)
        .setEnable(false)
        .setValues("off")),
    };
    ...
    public static String[] getPictureSizes_4_3() {
        return PICTURE_SIZE_4_3;
    }
    
    public static String[] getPictureSizes_16_9() {
        return PICTURE_SIZE_16_9;
    }
    
    public static String[] getPictureSize_5_3() {
        return PICTURE_SIZE_5_3;
    }
    
    public static String[] getPictureSize_3_2() {
        return PICTURE_SIZE_3_2;
    }
    //end
}
