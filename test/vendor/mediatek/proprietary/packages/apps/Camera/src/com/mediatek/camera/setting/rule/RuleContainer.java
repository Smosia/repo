...
public class RuleContainer {
    ...
    //add 20160321 by xiaodong.cheng for GMO picture size limit > 5m start
    //private long PICTURE_SIZE_4M = 4000000L;
    private long PICTURE_SIZE_5M = 5900000L;
    //end
    ...
    private class LowRamPictureRule implements ISettingRule {
        ...
        public void execute() {
            ...
            if (isConditionSatisfied) {
                ...
                List<String> supportedValue = removeUnsupportedSize(entryValues, PICTURE_SIZE_5M);
