...
public class SettingUtils {
    ...
    public static void setPreviewSize(Context context, Parameters parameters, String prviewRatio) {
        //add BUG:DWLEBM-490 xiaodong.cheng 20160510 start
        if(prviewRatio==null || "".equals(prviewRatio)) {
            prviewRatio = SettingUtils.PICTURE_RATIO_16_9;
        }
        //end
    ...
    public static void initialCameraPictureSize(Context context, Parameters parameters,
        ...
        if (supportedRatios != null && supportedRatios.size() > 0) {
            SharedPreferences.Editor editor = sharedPreferences.edit();
            //@{modify  huruilong pic ratio
            //ratioString = supportedRatios.get(supportedRatios.size() - 1);
            if(context.getResources().getBoolean(R.bool.camera_ratios_flag))
    ...
    public static void restorePreferences(Context context, SharedPreferences sharedPreferences,
        ...
        //add bug: DWYSLM-122 anxiang.xiao 20160329 start
      	if(context.getResources().getBoolean(R.bool.is_record_location_default_open)){
      		editor.putString(SettingConstants.KEY_RECORD_LOCATION,RecordLocationPreference.VALUE_ON);
      		editor.apply();
      	}
      //add bug: DWYSLM-122 anxiang.xiao 20160329 end
    ...
    public static void upgradeGlobalPreferences(Context context, SharedPreferences pref, int numberOfCameras) {
        upgradeOldVersion(context,pref);
        upgradeCameraId(pref, numberOfCameras);
    }
...
/*    public static int getMainColor(Context context) {
 ...
 // modify bug: DWYSLM-122 anxiang.xiao 20160329 start 
   ...
   // private static void upgradeOldVersion(SharedPreferences pref) {
    private static void upgradeOldVersion(Context context, SharedPreferences pref) {
// modify bug: DWYSLM-122 anxiang.xiao 20160329 end 
        int version;
        try {
