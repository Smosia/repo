...
import java.io.IOException;
 //bug_id:DELSLMY-758 add by wangzhenfeng make video mode stop and save when alarm start 20160311 start
import android.content.BroadcastReceiver;
import android.content.IntentFilter;
 //bug_id:DELSLMY-758 add by wangzhenfeng make video mode stop and save when alarm start 20160311 end
public class VideoMode extends CameraMode implements MediaRecorder.OnErrorListener,
    ...
    //add bug:DELSLM-443 xiaodong.cheng 20160222 start
    private TelephonyManager mTelephonyManager;
    //add bug:DELSLM-443 xiaodong.cheng 20160222 end
    ...
    //modify for memory leak 20140428 by xiaodong.cheng start
    ...
    public VideoMode(ICameraContext cameraContext) {
        ...
        //add bug:DELSLM-443 xiaodong.cheng 20160222 start
        if(mActivity.getResources().getBoolean(R.bool.auto_stop_video_when_ringing))
        {
    ...
    protected void onCameraClose() {
        ...
        //add for memory leak 20160428 by xiaodong.cheng start
    ...
    //add bug:JLLBLL-19 xiaodong.cheng 20160222 start
    ...
    //add bug:JLLBLL-19 xiaodong.cheng 20160222 end
