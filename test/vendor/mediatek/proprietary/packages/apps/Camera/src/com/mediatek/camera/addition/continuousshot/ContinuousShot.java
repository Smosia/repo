...
public class ContinuousShot extends CameraAddition implements ContinuousShotListener {
    ...
    public ContinuousShot(ICameraContext context) {
		...
		//A:DELSLMY-735  wxd for contrl  shutsound  start 20160315
		am = (AudioManager)context.getCameraActivity().getSystemService(Context.AUDIO_SERVICE);
        //A:DELSLMY-735  wxd for contrl  shutsound  end 20160315
    ...
    private final ShutterCallback mShutterCallback = new ShutterCallback() {
        public void onShutter() {
            ...
            if (getCurrentState() == State.STATE_CAPTURING) {
				...
				//M:DELSLMY-735  wxd for contrl  shutsound  start 20160315
				 //mCaptureSound.play();
                if(!am.isMusicActive()){
                  mCaptureSound.play();
				}
				//M:DELSLMY-735  wxd for contrl  shutsound  end 20160315
