            ...
            for (Iterator infoIterator = downloads.iterator(); infoIterator.hasNext(); ) {
                ...
                if (info.mState == State.RUNNING || info.mState == State.CONNECTING) {
                    ...
                    if (info.isShowNotification()) {
                        ...
                        PendingIntent resultPendingIntent = PendingIntent.getActivityAsUser(
                    ...
                    PendingIntent cancelIntent = PendingIntent.getActivityAsUser(mContext,
                            info.mId, intent, 0, null, UserHandle.CURRENT);
