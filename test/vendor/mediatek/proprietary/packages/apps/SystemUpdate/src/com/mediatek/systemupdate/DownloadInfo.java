...
final class DownloadInfo {
    ...
    private static final String PACKAGE_DOWNLOAD_PATH = "download_path";
    ...
    void setDownloadPath(String path) {
          Log.i("@M_" + TAG, "setDownloadPath, path = " + path);
        mPreference.edit().putString(PACKAGE_DOWNLOAD_PATH, path).commit();
    }

    String getDownloadPath() {
        return mPreference.getString(PACKAGE_DOWNLOAD_PATH, "");
    }
}
