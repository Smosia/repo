...
class NotifyManager {
    ...
    void showNewVersionNotification() {
        ...
        Log.i("@M_" + TAG, "showNewVersionNotification");
    ...
    void showDownloadCompletedNotification() {
        Log.i("@M_" + TAG, "showDownloadCompletedNotification");
    ...
    void showDownloadingUnknownPer() {
        Log.i("@M_" + TAG, "showDownloadingUnknownPer");
    ...
    void showDownloadingNotificaton(String version, int currentProgress, boolean isOngoing) {
        Log.i("@M_" + TAG, "showDownloadingNotificaton with ongoing " + isOngoing);
        mNotificationType = NOTIFY_DOWNLOADING;
        String contentTitle = mNotificationContext.getString(R.string.app_name);
    ...
    private void setNotificationProgress(int iconDrawableId, String contentTitle,
        ...
        if (mNotificationBuilder == null) {
            ...
            Log.i("@M_" + TAG, "set notification with " + isOngoing);
    ...
    public void clearNotification(int notificationId) {
        ...
        Log.i("@M_" + TAG, "clearNotification " + notificationId);
