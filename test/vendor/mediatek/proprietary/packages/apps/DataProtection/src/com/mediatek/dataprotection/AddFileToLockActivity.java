...
public class AddFileToLockActivity extends BaseActivity implements
    ...
    //add BUG_ID:DWYSLM-499 dushuaihui 20160414(start)
    @Override
    public void onRequestPermissionsResult(int requestCode, String[] permissions,
            int[] grantResults) {
        if(requestCode == 1){
            if(grantResults.length > 0 && permissions.length > 0 && permissions[0].equals(Manifest.permission.WRITE_EXTERNAL_STORAGE)){
    ...
    //add BUG_ID:DWYSLM-499 dushuaihui 20160414(end)
