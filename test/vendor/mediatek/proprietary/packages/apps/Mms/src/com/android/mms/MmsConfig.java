...
public class MmsConfig {
    ...
    private static final int MAX_IMAGE_HEIGHT = MmsApp.getApplication().getResources().getBoolean(R.bool.improve_picture_quality) ? 600 : 480;
    private static final int MAX_IMAGE_WIDTH  = MmsApp.getApplication().getResources().getBoolean(R.bool.improve_picture_quality) ? 800 : 640;
   ...
   /* private static void loadSimInfo(Context context) {
	...
	private static void initSmsSignature(Context context) {
        ...
        if (sp.getBoolean("pref_key_first_time", true)) {
            ...
            editor.putString("pref_key_edit_signature", context.getResources().getString(R.string.default_sms_signature));
            editor.commit();
        }
    }
	// modify  BUG_ID: JWLWKK-126  zhangyuwen  20150423(end)
