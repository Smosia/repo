...
//        }
    ...
    private void setDialogView() {
        ...
        //Modify DELSLMY-1163 chenshu 20160325 start
        //mSender.setText(getSenderString());
        mSender.setText(numberLeftToRight(getSenderString()));
        //Modify DELSLMY-1163 chenshu 20160325 end
    ...
    private void loadMmsContents() {
        ...
        try {
            ...
            if (subObj != null) {
				//Modify DLLEE-533 chenshu 20151010 start
                MmsLog.d(TAG, "sub=" + subject);
                subject =  MessageUtils.cleanseMmsSubject(this, subObj.getString());
                //subject = subObj.getString();
                //Modify DLLEE-533 chenshu 20151010 end
            }
    ...
    private void updateSendButtonState() {
        ...
        if (mSendButton != null) {
            ...
            if (enable) {
				...
				mSendButton.setImageResource(isLayoutRtl()? R.drawable.ic_send_ipmsg2 : R.drawable.ic_send_ipmsg);
				...
				mSendButton.setImageResource(isLayoutRtl()? R.drawable.ic_send_sms_unsend2 : R.drawable.ic_send_sms_unsend);
				//Modify DELSLMY-155 chenshu 20160314 end
            }
        }
