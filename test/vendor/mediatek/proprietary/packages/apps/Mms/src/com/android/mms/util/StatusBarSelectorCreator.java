...
public class StatusBarSelectorCreator {
    ...
    private void showStatusBarIndicator(boolean show) {
        //Modify DWYQLSSMY-613 chenshu 20160407 start
        if (mContext.getResources().getBoolean(R.bool.hide_StatusBar_Selector)){
            return;
        }
        //Modify DWYQLSSMY-613 chenshu 20160407 end
