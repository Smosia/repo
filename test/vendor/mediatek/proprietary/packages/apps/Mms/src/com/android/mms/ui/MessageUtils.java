...
/// @}
    ...
    private static String getTextMessageDetails(Context context, MessageItem msgItem) {
		...
		//Modify DELSLM-714 chenshu 20160308 start
        //details.append(msgItem.mAddress);
		details.append(numberLeftToRight(msgItem.mAddress));
		//android.util.Log.e("chenshu","msgItem.mAddress:"+msgItem.mAddress);
		//Modify DELSLM-714 chenshu 20160308 end
        /// @}
        ...
        if (smsType == Sms.MESSAGE_TYPE_INBOX) {
			...
			details.append(msgItem.mServiceCenter == null ? "" : numberLeftToRight(msgItem.mServiceCenter));
			//android.util.Log.e("chenshu","sgItem.mServiceCenter:"+(msgItem.mServiceCenter == null ? "" : msgItem.mServiceCenter));
			//Modify DELSLM-714 chenshu 20160308 end
        }
        /// @}
...
//        sizeLimit *= .85F;
     ...
     */
    //Modify DWLEBM-192 chenshu 20160331 start
    //public static final int IMAGE_COMPRESSION_QUALITY = 95;
    public static final int IMAGE_COMPRESSION_QUALITY = MmsApp.getApplication().getResources().getBoolean(R.bool.improve_picture_quality) ? 100 : 95;
    //Modify DWLEBM-192 chenshu 20160331 end
    /**
...
//                    launchSlideshowActivity(activity, msgUri, requestCode);
    ...
    public static void selectRingtone(Context context, int requestCode) {
        if (context instanceof Activity) {
            ...
            intent.putExtra("never_show_defalut", true);
