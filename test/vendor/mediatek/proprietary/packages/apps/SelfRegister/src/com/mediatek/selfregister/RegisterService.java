...
public class RegisterService extends Service {
    ...
    // Max times to wait for condition ready
    private static final int TIMES_MAX_WAIT = 6;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (action.equalsIgnoreCase(Const.ACTION_BOOT_COMPLETED)) {
            ...
            if (mHasBootAlready) {
                ...
                Log.i(TAG, "Receive subInfo update before boot, do nothing");
            }
    ...
    private void handleRegisterMsg() {
        ...
        if (mIsNetworkAvailable && isNetworkTypeValid() && (getCdmaBaseId() > 0)) {
            ...
            Log.i(TAG, "Network/Sim info not ready");

            if (mTimesWait < TIMES_MAX_WAIT) {
                int second = (mTimesWait % 3 + 1) * 10;
    ...
    private class CustomizedPhoneStateListener extends PhoneStateListener {
        ...
        public void onCellLocationChanged(CellLocation location) {
            ...
            Log.i(TAG, "[onCell " + mIndex + "] location: " + location);
            ...
            if (baseId <= 0) {
                Log.i(TAG, "[onCell " + mIndex + "] basedId not valid, return");
                return;
            }
        ...
        public void onServiceStateChanged(ServiceState serviceState) {
            ...
            if (serviceState.getState() != ServiceState.STATE_IN_SERVICE) {
                ...
                Log.i(TAG, "[onService " + mIndex + "] in service");
            }
