...
public class CreateEventDialogFragment extends DialogFragment implements TextWatcher {
    ...
    public CreateEventDialogFragment(Time day) {
	  //add DELSLMY-715 liujia 20160315 (start)
		if(day.year>2036){
		    day.setToNow();	
		}
		  //add DELSLMY-715 liujia 20160315 (end)
        setDay(day);
    }
    ...
    public void onResume() {
        ...
        if (mButtonAddEvent == null) {
            ...
            //M:BUG_ID:DELSLMY-400 huangerhui 20160307(start)
            ...
            mButtonAddEvent.setEnabled(mEventTitle.getText().toString().trim().length() > 0);
             //M:BUG_ID:DELSLMY-400 huangerhui 20160307(end)
        }
    }
