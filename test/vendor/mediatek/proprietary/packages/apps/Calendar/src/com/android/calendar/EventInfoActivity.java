...
//        SearchView.OnCloseListener {
    ...
    //A:DWYQLSSB-46 guoshuai 20160530(start)
    ...
    private class QueryHandler extends AsyncQueryHandler {
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            ...
            AccountManager am = AccountManager.get(EventInfoActivity.this);
                    ...
                    new AccountManagerCallback<Bundle>() {
                        ...
                        public void run(AccountManagerFuture<Bundle> future) {
                            ...
                            try {
                                ...
                                if (setupSkipped) {
                                    Utils.setSharedPreference(EventInfoActivity.this,
    ...
    public final Runnable mHomeTimeUpdater = new Runnable() {
        @Override
        public void run() {
            mTimeZone = Utils.getTimeZone(EventInfoActivity.this, mHomeTimeUpdater);
            EventInfoActivity.this.invalidateOptionsMenu();
    ...
    public final Runnable mTimeChangesUpdater = new Runnable() {
       @Override
       public void run() {
           mTimeZone = Utils.getTimeZone(EventInfoActivity.this, mHomeTimeUpdater);
           EventInfoActivity.this.invalidateOptionsMenu();
   ...
   //A:DWYQLSSB-46 guoshuai 20160530(end)
    ...
    public void ContinueOnCreateEventInfo() {
        ...
        if (bar != null) {
            ...
            //A:DWYQLSSB-46 guoshuai 20160530(start)
            if(Utils.getConfigBool(this, R.bool.config_calendar_mark_support)){
                LayerDrawable icon = (LayerDrawable)res.getDrawable(R.drawable.calendar_icon);
                mTimeZone = Utils.getTimeZone(this, mHomeTimeUpdater);
                Utils.setEventInfoTodayIcon(icon, this, mTimeZone);
                bar.setIcon(icon);
            }
            //A:DWYQLSSB-46 guoshuai 20160530(end)
        }
