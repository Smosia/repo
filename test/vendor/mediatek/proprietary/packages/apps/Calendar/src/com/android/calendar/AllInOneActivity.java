...
public class AllInOneActivity extends AbstractCalendarActivity implements EventHandler,
    ...
    protected void onCreate(Bundle icicle) {
	 ...
	 //add BUG_ID:DELSLMY-680 liujia  20160310 (start)  
   	 boolean isTimingMonth =getResources().getBoolean(R.bool.isMonthShow);
		
        if(isTimingMonth){
 		GeneralPreferences.DEFAULT_START_VIEW = getResources().getInteger(R.integer.set_time_month);
		Log.d(TAG,"mm: DEFAULT_START_VIEW"+GeneralPreferences.DEFAULT_START_VIEW); 
        }

  	//add BUG_ID:DELSLMY-680 liujia  20160310 (end) 
