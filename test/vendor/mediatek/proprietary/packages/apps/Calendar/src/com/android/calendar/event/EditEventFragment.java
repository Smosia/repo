    ...
    class Done implements EditEventHelper.EditDoneRunnable {
        ...
        public void run() {
            ...
            if ((mCode & Utils.DONE_SAVE) != 0 && mModel != null
                 ...
                 //m:DELSLMY-668 huangerhui 20160307 start {
                long currentTime =System.currentTimeMillis();
                long startTime =mModel.mStart;
                if(currentTime>startTime){
                   showIsCreateDialog();            		
                }else{
                     createSuceess();
                }
                //m:DELSLMY-668 huangerhui 20160307 end {
            ...
            if ((mCode & Utils.DONE_EXIT) != 0) {
                ...
                if ((mCode & Utils.DONE_SAVE) != 0) {
                    if (mActivity != null) {
						...
						if(isCancel) //A:DELSLMY-668 huangerhui 20160307 
...
//        }
	...
	//A:DELSLMY-668 huangerhui 20160307 start {
    private long start;
    private long end;
    private boolean isCancel=true;
    private AlertDialog gprsTipsDialog;
    private void showIsCreateDialog(){
    	isCancel=false;
            AlertDialog.Builder b = new AlertDialog.Builder(mActivity);
            b.setTitle(getResources().getString(R.string.dialog_title));
           // b.setCancelable(false);
            b.setMessage(getResources().getString(R.string.dialog_massege));
            b.setPositiveButton(getResources().getString(R.string.dialog_done), new OnClickListener() {
                ...
                b.setNegativeButton(getResources().getString(R.string.dialog_cancel), new OnClickListener() {
                public void onClick(DialogInterface arg0, int arg1) {
                    isCancel=true;
                     // Log.d("huang", "Negative");
                }
            });
                gprsTipsDialog=b.create();
                if(!gprsTipsDialog.isShowing()){
                    gprsTipsDialog.show();
                }
    }
    private void createSuceess(){
         int stringResource;
  ...
  //A:DELSLMY-668 huangerhui 20160307 end}
}
