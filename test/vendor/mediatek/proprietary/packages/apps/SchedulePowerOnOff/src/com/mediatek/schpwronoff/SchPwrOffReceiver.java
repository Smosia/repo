    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (SHUTDOWN_IPO.equals(intent.getAction())) {
            if (ShutdownActivity.sCountDownTimer != null) {
                Log.d("@M_" + TAG, "ShutdownActivity.sCountDownTimer != null");
        ...
        if (alarm.mId == 1) {
            ...
            if (isInCall || isAlarmBoot()) {
                ...
                Notification mNotification = new Notification(R.drawable.ic_settings_schpwroff,context.getString(R.string.schedule_power_on_off_settings_title),System.currentTimeMillis());
                Intent mIntent = new Intent(context,SetAlarm.class);
                mIntent.putExtra(Alarms.ALARM_ID, 2);
                ...
                mNotification.setLatestEventInfo(context,context.getString(R.string.schedule_power_on_off_settings_title),context.getString(R.string.shutdown_cancel),pi);
