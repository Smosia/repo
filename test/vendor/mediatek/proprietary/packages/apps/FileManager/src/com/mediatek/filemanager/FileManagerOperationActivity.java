...
public class FileManagerOperationActivity extends AbsBaseActivity implements
    ...
    public static final int MY_PERMISSIONS_REQUEST_WRITE_READ_PHONE_STATE = 6;
    //A:DWYSLM-576 guoshuai 20160413(end)
    ...
    protected class ActionModeCallBack implements ActionMode.Callback, OnMenuItemClickListener {
        ...
        public boolean onPrepareActionMode(ActionMode mode, Menu menu) {
            ...
            if (selectedCount == 0) {
                ...
                if((null != fileMimeType) && (fileMimeType.contains("audio/") || fileMimeType.contains("application/ogg")) && !fileInfo.isDrmFile()) {
    ...
    //M:DWYSLM-576 guoshuai 20160413(start)
    ...
    //M:DWYSLM-576 guoshuai 20160413(end)
    //A:DWYYLM-532 guoshuai 20160119(end)
}
