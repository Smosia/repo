...
public final class FileUtils {
    ...
    //A:DWYYLM-532 guoshuai 20160119(end)
    ...
    public static synchronized void setRingtoneByFilePath(Context context, String filePath,int type,int sin_id){
        ...
        Cursor cursor = query(context, MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, cols, where , whereArgs, null);
        ...
        try {
            if (cursor.getCount() == 1) {
                ...
                if(type == SET_PHONE_RINGTONE) {
                    ...
                    //modify setting Mms Ringtone 20150506 start
                    ...
                    str = context.getResources().getString(R.string.toast_mms_ringtone_l);
                        if (AudioProfileManager.isSmsDualRingtoneSupport()) {
        				    ...
        				    String activeProfileKey = profileManager1.getActiveProfileKey();
        				    profileManager1.setRingtoneUri(activeProfileKey, AudioProfileManager.TYPE_MESSAGE_NOTIFICATION, 0, ringUri);
                            profileManager1.setRingtoneUri(activeProfileKey, AudioProfileManager.TYPE_MESSAGE_NOTIFICATION, 1, ringUri);
                        }
                    //modify setting Mms Ringtone 20150506 end
                } else if(type == SET_ALARM_RINGTONE) {
