...
//        }
        ...
        if ( tab != null ) {
            ...
            //D:liuhuaizhi 20160303(start)
            if (mActivity.getResources().getBoolean(R.bool.config_remove_save_for_offline)) {
                menu.findItem(R.id.save_snapshot_menu_id).setVisible(false);
            }
            //D:liuhuaizhi 20160303(end)
            String url = tab.getUrl();
