...
public class BrowserSettings implements OnSharedPreferenceChangeListener,
    ...
    private Runnable mSetup = new Runnable() {
        ...
        public void run() {
            ...
            if (sFactoryResetUrl == null) {
				...
				//modify BUG_ID:DELSLM-134 liuhuaizhi 20160129(start)
                ...
                if(mContext.getResources().getBoolean(R.bool.config_select_default_home_page)){
				    ...
				    sFactoryResetUrl = mContext.getResources().getString(R.string.homepage_base_site_navigation);
				//modify BUG_ID:DELSLM-134 liuhuaizhi 20160129(end)
				}else {
                    sFactoryResetUrl = mContext.getResources().getString(R.string.homepage_base);
                    if (sFactoryResetUrl.indexOf("{CID}") != -1) {
    ...
    public String getSearchEngineName() {
        ...
        Log.i("lhz", "14........searchEngine =  " + searchEngine);
        ...
        Log.i("lhz", "17........searchEngineName =  " + searchEngineName);
        Log.i("lhz", "16........defaultSearchEngine =  " + defaultSearchEngine);
    ...
    public void updateSearchEngineSetting() {
        ...
        Log.i("lhz", "17........searchEngineName =  " + searchEngineName);
        Log.i("lhz", "18........searchEngineInfo =  " + searchEngineInfo);
