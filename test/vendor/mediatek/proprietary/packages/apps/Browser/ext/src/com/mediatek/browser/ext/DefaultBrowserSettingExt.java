...
public class DefaultBrowserSettingExt implements IBrowserSettingExt {
    ...
    public String getDefaultDownloadFolder() {
        ...
        //M: DWYSLM-182 liuhuaizhi 20150314(start)
        if("1".equals(android.os.SystemProperties.get("ro.rgk_default_download_path"))){
            if (null != defaultStorage) {
                defaultDownloadPath = defaultStorage + "/Download";
            }else{
                defaultDownloadPath = "/storage/sdcard0/Download";
      		}
      	}else{
      	    if (null != defaultStorage) {
        ...
        //M: DWYSLM-182 liuhuaizhi 20150314(end)
