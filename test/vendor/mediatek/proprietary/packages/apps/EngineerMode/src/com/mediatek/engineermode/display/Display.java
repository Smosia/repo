...
//        Log.v(TAG, "-->onCreate");
    ...
    public void onClick(View arg0) {
        ...
        if (arg0.equals(mBtnSet)) {
            ...
            Log.v(TAG, "-->onClick editString = " + editString);
            ...
            try {
                ...
                Log.v(TAG, "-->onClick editString = "  + e.getMessage());
            }
            ...
            try {
                ...
                Log.d(TAG, cmd.toString() + e.getMessage());
            }
            ...
            do {
                ...
                if (resultStr.mReturnString.isEmpty()) {
                    ...
                    try {
                        ...
                        Log.d(TAG, resultStr.mReturnString);
                        valueRet = RETURN_FAIL;
                    }
                }
