        ...
        if (mStkMenu != null) {
            ...
            if (!mStkMenu.titleIconSelfExplanatory) {
                ...
                if (mStkMenu.title == null) {
                    ...
                    //modify BUG_ID:DELSLM-583 dushuaihui 20160225(start)
                    List<SubscriptionInfo> infos = SubscriptionManager.from(this).getActiveSubscriptionInfoList();
                    if(infos != null){
                        for(SubscriptionInfo info : infos){
                            if(info.getSimSlotIndex() == mSlotId){
                    ...
                    //modify BUG_ID:DELSLM-583 dushuaihui 20160225(end)
