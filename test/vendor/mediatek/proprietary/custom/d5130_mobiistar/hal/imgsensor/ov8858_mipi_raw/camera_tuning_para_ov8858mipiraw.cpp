        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    220,    // PCloudyRightBound
                    45,    // PCloudyLeftBound
                    -372,    // PCloudyUpperBound
                    -470    // PCloudyLowerBound
                },
                // Shade
                {
                    320,    // PShadeRightBound
                    45,    // PShadeLeftBound
                    -372,    // PShadeUpperBound
                    -470    // PShadeLowerBound
                },
                // Twilight
                {
                    -48,    // PTwiRightBound
                ...
                // Warm fluorescent
                {
                    -215,    // PWFluoRightBound
                    -415,    // PWFluoLeftBound
                    -362,    // PWFluoUpperBound
                    -532    // PWFluoLowerBound
                },
                // Incandescent
                {
                    -215,    // PIncaRightBound
            ...
            // Preference gain for each light source
            {
                ...
                {
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {500, 512, 520}, {500, 512, 520}, {500, 512, 520}, {512, 512, 512}, 
