...
const NVRAM_LENS_PARA_STRUCT FM50AF_LENS_PARA_DEFAULT_VALUE =
{
    ...
    // AF NVRAM
    {
        ...
        {
            {
                ...
                0,   // i4MacroIdxOffset
                {
                       0,  10,  30,  60,  90, 130, 170, 220, 270, 320,
        ...
        -1, // i4MidDir;                    // 
        -1, // i4MacDir;                    // 
        40, // i4RatioInf;                  // below 16716774575f tableLength belongs to INF
        70, // i4RatioMac;                  // above 16716774575f tableLength belongs to MAC ; should be larger than i4RatioInf          
