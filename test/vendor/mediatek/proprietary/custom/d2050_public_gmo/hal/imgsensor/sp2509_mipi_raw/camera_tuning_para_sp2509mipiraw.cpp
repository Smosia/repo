...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            3827500, -1350000, 82500, -672500, 3287500, -60000, -355000, -2212500, 5135000
        },
        {  // i4P10[9]
            1169939, -1056068, -113871, -34560, -165752, 199655, 142730, 298889, -451238
        },
        {  // i4P01[9]
            493064, -650784, 157720, -104489, -293527, 393297, -75196, -202377, 277259
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    ...
                    59,    // PCloudyLeftBound
                    -179,    // PCloudyUpperBound
                    -323    // PCloudyLowerBound
                },
                // Shade
                {
                    334,    // PShadeRightBound
                    59,    // PShadeLeftBound
                    -179,    // PShadeUpperBound
                    -323    // PShadeLowerBound
                },
                // Twilight
                {
                    -103,    // PTwiRightBound
            ...
            // Preference gain for each light source
            {
                ...
                {
                    {512, 512, 542}, {512, 512, 542}, {512, 512, 542}, {512, 512, 542}, {512, 512, 542}, {512, 512, 542}, {512, 512, 542}, {512, 512, 542}, {512, 512, 542}, {512, 512, 542}, 
                    {512, 512, 542}, {512, 512, 542}, {512, 512, 542}, {512, 512, 542}, {512, 512, 542}, {512, 512, 542}, {512, 512, 542}, {512, 512, 542}, {512, 512, 542}
                }, // TUNGSTEN
                {
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, 
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
