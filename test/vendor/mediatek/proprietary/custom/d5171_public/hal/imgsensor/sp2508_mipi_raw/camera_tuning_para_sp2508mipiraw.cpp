...
{{
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            -4437500, 8972500, 260000, 9710000, -12342500, 9987500, 9857500, 8705000, -11207500
        },
        {  // i4P10[9]
            -5969288, -768534, -417256, 3374, -15780848, 446245, 142379, 367058, -15833383
        },
        {  // i4P01[9]
            -3002753, -429657, -173646, -92854, -7986536, 358016, -14529, 173290, -7872828
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
        // rDevicesInfo
        {
            ...
            38668,    // u4PreExpUnit 
            21,    // u4PreMaxFrameRate
            27620,    // u4VideoExpUnit  
            30,    // u4VideoMaxFrameRate 
            1024,    // u4Video2PreRatio, 1024 base = 1x 
            38668,    // u4CapExpUnit 
            21,    // u4CapMaxFrameRate
            1024,    // u4Cap2PreRatio, 1024 base = 1x
            27620,    // u4Video1ExpUnit
            30,    // u4Video1MaxFrameRate
            1024,    // u4Video12PreRatio, 1024 base = 1x
            27620,    // u4Video2ExpUnit
            30,    // u4Video2MaxFrameRate
            1024,    // u4Video22PreRatio, 1024 base = 1x
            38668,    // u4Custom1ExpUnit
            21,    // u4Custom1MaxFrameRate
            1024,    // u4Custom12PreRatio, 1024 base = 1x
            38668,    // u4Custom2ExpUnit
            21,    // u4Custom2MaxFrameRate
            1024,    // u4Custom22PreRatio, 1024 base = 1x
            38668,    // u4Custom3ExpUnit
            21,    // u4Custom3MaxFrameRate
            1024,    // u4Custom32PreRatio, 1024 base = 1x
            38668,    // u4Custom4ExpUnit
            21,    // u4Custom4MaxFrameRate
            1024,    // u4Custom42PreRatio, 1024 base = 1x
            38668,    // u4Custom5ExpUnit
            21,    // u4Custom5MaxFrameRate
        ...
        // AWB calibration data
        {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    ...
                    -35,    // PCloudyUpperBound
                    -130    // PCloudyLowerBound
                },
                // Shade
                {
            ...
            // CCT estimation
            {
                ...
                {
                -410,    // i4RotatedXCoordinate[0]
                -327,    // i4RotatedXCoordinate[1]
                -181,    // i4RotatedXCoordinate[2]
            ...
            // Preference gain for each light source
            {
                ...
                {
                    {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, 
                    {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}
                }, // TUNGSTEN
                {
                    {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, 
                    {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}, {512, 500, 495}
                ...
                {
                    {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, 
                    {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {502, 500, 500}, {502, 500, 500}, {502, 500, 500}, {502, 500, 500}, {502, 500, 500}
                }, // F
                {
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, 
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
                ...
                {
                    {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, 
                    {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}, {512, 500, 500}
                }, // SHADE
                {
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, 
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
