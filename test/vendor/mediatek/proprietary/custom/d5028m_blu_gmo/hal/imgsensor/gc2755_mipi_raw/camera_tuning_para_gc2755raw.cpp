...
#include "camera_AE_PLineTable_gc2755raw.h"
#include "camera_info_gc2755raw.h"
...
{{
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            4640000, -1790000, -290000, -710000, 3605000, -330000, -222500, -1560000, 4345000
        },
        {  // i4P10[9]
            1010776, -1314306, 303531, -92105, -154519, 238097, 72186, 418907, -479362
        },
        {  // i4P01[9]
            808741, -1100138, 291397, -233454, -199131, 431010, -40359, -19045, 71441
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
    ...
    {
        {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    253,    // PCloudyRightBound
                    78,    // PCloudyLeftBound
                    -285,    // PCloudyUpperBound
                    -403    // PCloudyLowerBound
                },
                // Shade
                {
                    353,    // PShadeRightBound
                    78,    // PShadeLeftBound
                    -285,    // PShadeUpperBound
                    -403    // PShadeLowerBound
                },
                // Twilight
                {
                    -74,    // PTwiRightBound
                ...
                // Warm fluorescent
                {
                    ...
                    -381,    // PWFluoLeftBound
                    -295,    // PWFluoUpperBound
                    -485    // PWFluoLowerBound
                },
                // Incandescent
                {
                    -181,    // PIncaRightBound
