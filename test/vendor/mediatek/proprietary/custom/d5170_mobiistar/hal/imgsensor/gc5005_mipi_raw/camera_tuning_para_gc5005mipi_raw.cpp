...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            4560000, -2137500, 135000, -997500, 3797500, -240000, -290000, -2540000, 5390000
        },
        {  // i4P10[9]
            1826044, -2352994, 533337, -273587, -243180, 516767, 459679, 1720847, -2180527
        },
        {  // i4P01[9]
            1597664, -2053623, 466758, -515599, -307847, 823446, 173701, 757467, -931169
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    264,    // PCloudyRightBound
                    89,    // PCloudyLeftBound
                    -247,    // PCloudyUpperBound
                    -363    // PCloudyLowerBound
                },
                // Shade
                {
                    364,    // PShadeRightBound
                    89,    // PShadeLeftBound
                    -247,    // PShadeUpperBound
                    -363    // PShadeLowerBound
                },
                // Twilight
                {
                    -45,    // PTwiRightBound
                ...
                // Warm fluorescent
                {
                    ...
                    -362,    // PWFluoLeftBound
                    -257,    // PWFluoUpperBound
                    -445    // PWFluoLowerBound
                },
                // Incandescent
                {
                    -162,    // PIncaRightBound
        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    ...
                    -234,    // PCloudyUpperBound
                    -350    // PCloudyLowerBound
                },
                // Shade
                {
                    408,    // PShadeRightBound
                    133,    // PShadeLeftBound
                    -234,    // PShadeUpperBound
                    -350    // PShadeLowerBound
                },
                // Twilight
                {
                    -55,    // PTwiRightBound
