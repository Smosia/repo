...
#include "camera_AE_PLineTable_sub_ov5648mipiraw.h"
#include "camera_info_sub_ov5648mipiraw.h"
...
{{
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            4695000, -1737500, -392500, -847500, 3040000, 362500, -2500, -2512500, 5077500
        },
        {  // i4P10[9]
            992774, -1086464, 90301, -67622, 62692, 8320, 42204, 44258, -85063
        },
        {  // i4P01[9]
            265952, -344399, 86200, -94423, -91861, 178531, -102282, -701086, 816630
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
    ...
    {
        {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    137,    // PCloudyRightBound
                    -38,    // PCloudyLeftBound
                    -146,    // PCloudyUpperBound
                    -261    // PCloudyLowerBound
                },
                // Shade
                {
                    237,    // PShadeRightBound
                    -38,    // PShadeLeftBound
                    -146,    // PShadeUpperBound
                    -261    // PShadeLowerBound
                },
                // Twilight
                {
                    -74,    // PTwiRightBound
            ...
            // CCT estimation
            {
                ...
                {
                -415,    // i4RotatedXCoordinate[0]
                -307,    // i4RotatedXCoordinate[1]
                -171,    // i4RotatedXCoordinate[2]
            ...
            // Preference gain for each light source
            {
                ...
                {
                    {512, 512, 525}, {512, 512, 525}, {512, 512, 525}, {512, 512, 525}, {512, 512, 525}, {512, 512, 525}, {512, 512, 525}, {512, 512, 525}, {512, 512, 525}, {512, 512, 525}, 
                    {512, 512, 525}, {512, 512, 525}, {512, 512, 525}, {512, 512, 525}, {512, 512, 525}, {512, 512, 525}, {512, 512, 525}, {512, 512, 525}, {512, 512, 525}
                }, // CWF
                {
                    {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, 
                    {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {502, 512, 502}, {502, 512, 502}, {502, 512, 502}, {502, 512, 502}, {502, 512, 502}
                }, // DAYLIGHT
                {
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, 
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
                ...
                {
                    {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, 
                    {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}, {512, 512, 502}
                } // DAYLIGHT F
            },
