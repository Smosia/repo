...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            3676000, -1272000, 158000, -854000, 3622000, -210000, -336000, -2924000, 5822000
        },
        {  // i4P10[9]
            747422, 525353, -1271721, -146780, 404950, -260519, 5266, 828671, -832882
        },
        {  // i4P01[9]
            1117621, 137923, -1255182, -286305, 565924, -280822, -138804, -363534, 502700
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
    ...
    // AE NVRAM
    {
        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    ...
                    52,    // PCloudyLeftBound
                    -149,    // PCloudyUpperBound
                    -312    // PCloudyLowerBound
                },
                // Shade
                {
                    327,    // PShadeRightBound
                    52,    // PShadeLeftBound
                    -149,    // PShadeUpperBound
                    -312    // PShadeLowerBound
                },
                // Twilight
                {
                    -107,    // PTwiRightBound
                ...
                // Warm fluorescent
                {
                    ...
                    -427,    // PWFluoLeftBound
                    -159,    // PWFluoUpperBound
                    -397    // PWFluoLowerBound
                },
                // Incandescent
                {
                    -227,    // PIncaRightBound
            ...
            // AWB preference color	
            {
                ...
                // Sunset Area
                {
                    -104,   // i4Sunset_BoundXr_Thr
                    -222    // i4Sunset_BoundYr_Thr
                },
                // Sunset Vertex
                {
                    -75,   // i4Sunset_BoundXr_Thr
                    -222    // i4Sunset_BoundYr_Thr
                },
                // Shade F Area
                {
        ...
        // Algorithm Tuning Paramter
        {
            ...
            // Preference gain for each light source
            {
                ...
                {
                    {522, 512, 512}, {522, 512, 512}, {522, 512, 512}, {522, 512, 512}, {522, 512, 512}, {522, 512, 512}, {522, 512, 512}, {522, 512, 512}, {522, 512, 512}, {522, 512, 512}, 
                    {522, 512, 512}, {522, 512, 512}, {522, 512, 512}, {522, 512, 512}, {522, 512, 512}, {522, 512, 512}, {522, 512, 512}, {522, 512, 512}, {522, 512, 512}
                }, // TUNGSTEN
                {
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, 
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
                ...
                {
                    {542, 512, 512}, {542, 512, 512}, {542, 512, 512}, {542, 512, 512}, {542, 512, 512}, {542, 512, 512}, {542, 512, 512}, {542, 512, 512}, {542, 512, 512}, {542, 512, 512}, 
                    {542, 512, 512}, {542, 512, 512}, {542, 512, 512}, {542, 512, 512}, {542, 512, 512}, {542, 512, 512}, {542, 512, 512}, {542, 512, 512}, {542, 512, 512}
                }, // DAYLIGHT
                {
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, 
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
