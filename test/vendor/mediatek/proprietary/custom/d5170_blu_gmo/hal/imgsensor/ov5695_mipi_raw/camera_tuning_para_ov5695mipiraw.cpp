    ...
    // AWB NVRAM
    {
        {
          {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    ...
                    -314,    // PCloudyUpperBound
                    -410    // PCloudyLowerBound
                },
                // Shade
                {
                    425,    // PShadeRightBound
                    150,    // PShadeLeftBound
                    -314,    // PShadeUpperBound
                    -410    // PShadeLowerBound
                },
                // Twilight
                {
                    2,    // PTwiRightBound
                ...
                // Warm fluorescent
                {
                    -204,    // PWFluoRightBound
                    -404,    // PWFluoLeftBound
                    -304,    // PWFluoUpperBound
                    -500    // PWFluoLowerBound
                },
                // Incandescent
                {
                    -204,    // PIncaRightBound
            ...
            // AWB preference color	
            {
                ...
                // Sunset Area
                {
                    145,   // i4Sunset_BoundXr_Thr
                    -354    // i4Sunset_BoundYr_Thr
                },
                // Sunset Vertex
                {
                    145,   // i4Sunset_BoundXr_Thr
        ...
        // Algorithm Tuning Paramter
        {
            ...
            // Preference gain for each light source
            {
                ...
                {
                    {500, 512, 540}, {500, 512, 540}, {500, 512, 540}, {500, 512, 540}, {500, 512, 540}, {500, 512, 540}, {500, 512, 540}, {500, 512, 540}, {500, 512, 540}, {500, 512, 540}, 
                    {500, 512, 540}, {500, 512, 540}, {500, 512, 540}, {500, 512, 540}, {500, 512, 540}, {500, 512, 540}, {500, 512, 540}, {500, 512, 540}, {500, 512, 540}
                }, // CWF
                {
