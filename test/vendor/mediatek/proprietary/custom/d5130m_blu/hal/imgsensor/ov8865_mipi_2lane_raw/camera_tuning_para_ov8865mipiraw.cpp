...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            4645000, -2015000, -70000, -775000, 3462500, -137500, -67500, -2157500, 4782500
        },
        {  // i4P10[9]
            947562, -1159044, 211482, -107761, -122381, 204515, -43316, 471174, -427133
        },
        {  // i4P01[9]
            498068, -673954, 175887, -254219, -225365, 447094, -131307, -52034, 180666
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    251,    // PCloudyRightBound
                    76,    // PCloudyLeftBound
                    -379,    // PCloudyUpperBound
                    -483    // PCloudyLowerBound
                },
                // Shade
                {
                    351,    // PShadeRightBound
                    76,    // PShadeLeftBound
                    -379,    // PShadeUpperBound
                    -483    // PShadeLowerBound
                },
                // Twilight
                {
                    6,    // PTwiRightBound
            ...
            // Preference gain for each light source
            {
                ...
                {
                    {410, 512, 620}, {410, 512, 620}, {410, 512, 620}, {410, 512, 620}, {410, 512, 620}, {410, 512, 620}, {410, 512, 620}, {410, 512, 620}, {410, 512, 620}, {410, 512, 620}, 
                    {410, 512, 620}, {410, 512, 620}, {410, 512, 620}, {410, 512, 620}, {410, 512, 620}, {410, 512, 620}, {410, 512, 620}, {410, 512, 620}, {410, 512, 620}
                }, // WARM F
                {
                    {490, 512, 540}, {490, 512, 540}, {490, 512, 540}, {490, 512, 540}, {490, 512, 540}, {490, 512, 540}, {490, 512, 540}, {490, 512, 540}, {490, 512, 540}, {490, 512, 540}, 
                    {490, 512, 540}, {490, 512, 540}, {490, 512, 540}, {490, 512, 540}, {490, 512, 540}, {490, 512, 540}, {490, 512, 540}, {490, 512, 540}, {490, 512, 540}
                }, // F
                {
                    {500, 512, 590}, {500, 512, 590}, {500, 512, 590}, {500, 512, 590}, {500, 512, 590}, {500, 512, 590}, {500, 512, 590}, {500, 512, 590}, {500, 512, 590}, {500, 512, 590}, 
                    {500, 512, 590}, {500, 512, 590}, {500, 512, 590}, {500, 512, 590}, {500, 512, 590}, {500, 512, 590}, {500, 512, 590}, {500, 512, 590}, {500, 512, 590}
                }, // CWF
                {
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, 
