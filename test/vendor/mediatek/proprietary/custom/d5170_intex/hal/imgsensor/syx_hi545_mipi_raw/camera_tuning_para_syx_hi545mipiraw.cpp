...
#include "camera_AE_PLineTable_syx_hi545mipiraw.h"
#include "camera_info_syx_hi545mipiraw.h"
        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    ...
                    -270,    // PCloudyUpperBound
                    -345    // PCloudyLowerBound
                },
                // Shade
                {
                    400,    // PShadeRightBound
                    125,    // PShadeLeftBound
                    -270,    // PShadeUpperBound
                    -345    // PShadeLowerBound
                },
                // Twilight
                {
                    -87,    // PTwiRightBound
            ...
            // Preference gain for each light source
            {
                ...
                {
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {485, 512, 545}, {485, 512, 545}, {485, 512, 545}, 
                    {485, 512, 545}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {508, 512, 512}, {508, 512, 512}, {508, 512, 512}, {508, 512, 512}, {508, 512, 512}
                }, // CWF
                {
