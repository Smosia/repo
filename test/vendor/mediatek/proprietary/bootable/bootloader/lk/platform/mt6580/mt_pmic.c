...
void PMIC_CUSTOM_SETTING_V1(void)
{
    ...
    //added by lijian for FCHR_ENB 20150605 start 
#ifdef MTK_PMIC_RST_KEY    
       pmic_config_interface(0x40,0x0,0x1,0); 
       pmic_config_interface(0x40,0x0,0x1,1); 
       pmic_config_interface(0x40,0x1,0x1,2); 
       pmic_config_interface(0x16c,0x1,0x1,3); 
#endif
//added by lijian for FCHR_ENB 20150605 end 
}
...
//A:DELSLM-193 yeyu 20160129 start
...
//A:DELSLM-193 yeyu 20160129 end
