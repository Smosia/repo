...
#define CMDLINE_LEN   500
char g_cmdline [CMDLINE_LEN] = COMMANDLINE_TO_KERNEL;
#else
#define CMDLINE_LEN   300
                   ...
                   void *ramdisk, unsigned ramdisk_size)
{
  ...
  #if 1//add *#*#9375#*#* info  2015-03-16 start
    sprintf(cmdline, "%s%s%s", cmdline, " rgk_memname=", g_boot_arg->rgk_mem_name);
  #endif//add *#*#9375#*#* info  2015-03-16 end     
