...
#define MIN_VOLTAGE (800)		//++++rgk bug-id:null modify by yangjuwei 20140310
#define MAX_VOLTAGE (1000)	//++++rgk bug-id:null modify by yangjuwei 20140310
...
{0x15,0x08,1,{0x18}},                 // output SDA
{0x15,0x21,1,{0x01}},                 // DE = 1 Active  Display Function Control
{0x15,0x30,1,{0x01}},                 // 480 X 854
{0x15,0x31,1,{0x00}},                 //  inversion
{0x15,0x50,1,{0x78}},                 // VGMP
{0x15,0x51,1,{0x78}},                 // VGMN
{0x15,0x60,1,{0x07}},                 // SDTI
{0x15,0x61,1,{0x00}},                // CRTI
{0x15,0x62,1,{0x07}},                 // EQTI
{0x15,0x63,1,{0x00}},                // PCTI
{0x15,0x40,1,{0x15}},                 // BT 
{0x15,0x41,1,{0x55}},                 // DDVDH/DDVDL  Clamp
{0x15,0x42,1,{0x03}},                // VGH/VGL 
{0x15,0x43,1,{0x0A}},                 // VGH Clamp 16V       
{0x15,0x44,1,{0x06}},                 // VGL Clamp -10V  
{0x15,0x46,1,{0x55}},                
//{0x15,0x52,1,{0x00}},                   //Flicker
{0x15,0x53,1,{0x10}},                   //Flicker
{0x15,0x55,1,{0x0C}},                                 
{0x15,0x57,1,{0x50}},    
//++++++++++++++++++ Gamma Setting ++++++++++++++++++//
{0x39,0xFF,5,{0xFF,0x98,0x06,0x04,0x01}},     // Change to Page 1
{0x15,0xA0,1,{0x0A}},  // Gamma 255 
{0x15,0xA1,1,{0x18}},  // Gamma 251
{0x15,0xA2,1,{0x20}},  // Gamma 247
{0x15,0xA3,1,{0x10}},  // Gamma 239
{0x15,0xA4,1,{0x08}},  // Gamma 231
{0x15,0xA5,1,{0x0E}},  // Gamma 203
{0x15,0xA6,1,{0x08}},  // Gamma 175
{0x15,0xA7,1,{0x05}},  // Gamma 147
{0x15,0xA8,1,{0x08}},  // Gamma 108
{0x15,0xA9,1,{0x0C}},  // Gamma 80
{0x15,0xAA,1,{0x0F}},  // Gamma 52
{0x15,0xAB,1,{0x08}},  // Gamma 24
{0x15,0xAC,1,{0x11}},  // Gamma 16
{0x15,0xAD,1,{0x14}}, // Gamma 8
{0x15,0xAE,1,{0x0E}},  // Gamma 4
{0x15,0xAF,1,{0x03}},  // Gamma 0
///==============Nagitive
{0x15,0xC0,1,{0x0F}},  // Gamma 0 
{0x15,0xC1,1,{0x18}},  // Gamma 4
{0x15,0xC2,1,{0x20}},  // Gamma 8
{0x15,0xC3,1,{0x10}},  // Gamma 16
{0x15,0xC4,1,{0x08}},  // Gamma 24
{0x15,0xC5,1,{0x0E}},  // Gamma 52
{0x15,0xC6,1,{0x08}},  // Gamma 80
{0x15,0xC7,1,{0x05}},  // Gamma 108
{0x15,0xC8,1,{0x08}}, // Gamma 147
{0x15,0xC9,1,{0x0C}},  // Gamma 175
{0x15,0xCA,1,{0x0F}},  // Gamma 203
{0x15,0xCB,1,{0x08}},  // Gamma 231
{0x15,0xCC,1,{0x11}},  // Gamma 239
{0x15,0xCD,1,{0x14}},  // Gamma 247
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_sync_active				= 15;// 50  2
...
LCM_DRIVER ili9806e_dsi_vdo_junda_fwvga_ivo_ips_d5132_lcm_drv = 
{
	.name		= "ili9806e_dsi_vdo_junda_fwvga_ivo_ips_d5132",
