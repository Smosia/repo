...
#include <cust_adc.h>    	
#define FOUR_POWER_MIN_VOLTAGE (1200)	
#define FOUR_POWER_MAX_VOLTAGE (1500)	

//#define THREE_POWER_MIN_VOLTAGE (0)	
//#define THREE_POWER_MAX_VOLTAGE (300)	
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	//1 Three lane or Four lane
		...
		printf("luxiaofeng the  lane is three \n");
...
static void lcm_init(void)
{
   ...
   lcm_util.set_gpio_out(GPIO_LCD_BIAS_ENP_PIN, GPIO_OUT_ONE);
	...
	SET_RESET_PIN(1);	
	MDELAY(120);
	printf("luxiaofeng bf[%s]\n",__func__);
	push_table(lcm_initialization_setting, sizeof(lcm_initialization_setting) / sizeof(struct LCM_setting_table), 1);
	printf("luxiaofeng af[%s]\n",__func__);
			printf("luxiaofeng the  lane is three \n");
...
LCM_DRIVER ili9881c_dsi_vdo_hlt_hd720_hsd_ips_d5171_lcm_drv = 
{
	.name			= "ili9881c_dsi_vdo_hlt_hd720_hsd_ips_d5171",
