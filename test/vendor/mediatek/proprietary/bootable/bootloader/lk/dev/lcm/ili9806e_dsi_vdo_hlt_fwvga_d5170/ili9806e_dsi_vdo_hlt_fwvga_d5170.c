...
static void lcm_get_params(LCM_PARAMS * params)
{
    ...
    params->dsi.horizontal_sync_active 	= 18;//8;
    params->dsi.horizontal_backporch 		= 50;//60;
    params->dsi.horizontal_frontporch 	= 50;//140;	
...
/*
    ...
    params->dsi.PLL_CLOCK = 172;//dsi clock customization: should config clock value directly
}
...
// ---------------------------------------------------------------------------
LCM_DRIVER ili9806e_dsi_vdo_hlt_fwvga_d5170_lcm_drv = {
	.name = "ili9806e_dsi_vdo_hlt_fwvga_d5170",
