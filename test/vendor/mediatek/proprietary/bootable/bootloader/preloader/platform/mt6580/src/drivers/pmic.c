...
{    
    ...
    //VCDT_HV_VTH, 7V
    ret_val=pmic_config_interface(MT6350_CHR_CON1, 0x0B, MT6350_PMIC_RG_VCDT_HV_VTH_MASK, MT6350_PMIC_RG_VCDT_HV_VTH_SHIFT); 
    //VCDT_HV_EN=1
    ret_val=pmic_config_interface(MT6350_CHR_CON0, 0x01, MT6350_PMIC_RG_VCDT_HV_EN_MASK, MT6350_PMIC_RG_VCDT_HV_EN_SHIFT); 
    //CS_EN=1
...
#endif    
#ifdef FCHR_ENABLE
       ret_val=pmic_config_interface(0x40,0x0,0x1,0); //lj 
       ret_val=pmic_config_interface(0x40,0x0,0x1,1); //lj 
       ret_val=pmic_config_interface(0x40,0x1,0x1,2); //lj 
       ret_val=pmic_config_interface(0x16c,0x1,0x1,3); //lj  
#endif
