...
__attribute__((weak))
bool MTKOpRegRegImm(CompilationUnit* const cu ATTRIBUTE_UNUSED) {
  return false;
}

__attribute__((weak))
void GetMTKOpcode(OpKind op, ArmOpcode* opcode,
                  bool thumb_form, CompilationUnit* const cu ATTRIBUTE_UNUSED) {
  if (op == kOpAdd) {
...
__attribute__((weak))
void GetMTKOpcode(OpKind op, ArmOpcode* opcode,
                  ArmOpcode* alt_opcode, CompilationUnit* const cu ATTRIBUTE_UNUSED) {
  if (op == kOpSub) {
...
__attribute__((weak))
ArmOpcode GetMTKOpcode(ArmOpcode opcode, CompilationUnit* const cu ATTRIBUTE_UNUSED) {
  return opcode;
}
#endif
