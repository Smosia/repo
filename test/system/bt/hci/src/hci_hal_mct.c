...
static bool is_chip_doing_reset(void) {
  LOG_ERROR("%s It should not go here", __func__);

/* mtk bt makes use of hci_hal_h4.c;
 * if it changes to use this file, please refer to hci_hal_h4.c for new implementation
 */
