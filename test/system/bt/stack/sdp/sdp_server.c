...
void sdp_avrcp_blacklist_check(tSDP_ATTRIBUTE *p_attr, UINT8 *p_attr_start, BD_ADDR addr)
{
    ...
    if ((p_attr->id == ATTR_ID_BT_PROFILE_DESC_LIST) && (p_attr->type == DATA_ELE_SEQ_DESC_TYPE) &&
        ...
        if (bta_dm_mtk_is_device_blacklisted(addr, stack_config_avrcp_15_back_to_13_blacklist_get_interface())){
        ...
        else if (bta_dm_mtk_is_device_blacklisted(addr, stack_config_avrcp_15_back_to_14_blacklist_get_interface())){
