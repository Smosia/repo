...
#if MTK_STACK_CONFIG_BL == TRUE
             (!bta_dm_mtk_is_device_blacklisted(peer_addr, stack_config_sniff_subrating_blacklist_get_interface())) &&
#endif
...
#if MTK_STACK_CONFIG_BL == TRUE
        (!bta_dm_mtk_is_device_blacklisted(p_peer_dev->peer_bdaddr, stack_config_sniff_subrating_blacklist_get_interface())) &&
#endif
