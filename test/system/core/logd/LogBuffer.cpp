...
int LogBuffer::log(log_id_t log_id, log_time realtime,
    ...
    if(diff_count > 5000) {
         kernel_log_print("logd timout:diff time %ld, total run time  %ld, total count %d, step 1 %d, 2 %d, 3 %d, 4 %d. child thread %d, time %ld.\n",
                  (ts_4.tv_sec-ts_diff.tv_sec)*1000000000-ts_diff.tv_nsec+ts_4.tv_nsec,total_time, diff_count, diff_time[0]/diff_count, diff_time[1]/diff_count,
                   diff_time[2]/diff_count, diff_time[3]/diff_count, reader_thread,  realtime.nsec());
         ...
         diff_time[1] = diff_time[2] = diff_time[3] = diff_time[0] = diff_count = 0;
         total_time = 0;
         reader_thread = false;
