...
public abstract class InCallService extends Service {
     ...
     * @hide
     */
    public void startVoiceRecording(int slot, String number, boolean isConference) {
        if (mPhone != null) {
            mPhone.startVoiceRecording(slot, number, isConference);
        }
    }
     ...
     * @hide
     */
    public void setSortedBackgroudCallList(List<String> backgroundCallList) {
        if (mPhone != null) {
