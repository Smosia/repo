...
public final class Call {
    ...
    public static class Details {
         ...
         * @internal
         */
        public static final int CAPABILITY_ANSWER = 0x00200000;
         ...
         * @internal
         */
        public static final int CAPABILITY_UNHOLD = 0x00400000;
         ...
         * @internal
         */
        public static final int CAPABILITY_ADD_CALL = 0x00800000;
         ...
         * @hide
         */
        public static final int PROPERTY_HELD = 0x00000040;
        /// @}

        //******************************************************************************************
        // Next PROPERTY value: 0x00000080
        //******************************************************************************************
        ...
        public static String capabilitiesToString(int capabilities) {
            ...
            /* M: CC part start */
            if (can(capabilities, CAPABILITY_ANSWER)) {
                builder.append(" CAPABILITY_ANSWER");
            }
            if (can(capabilities, CAPABILITY_UNHOLD)) {
                builder.append(" CAPABILITY_UNHOLD");
            }
            if (can(capabilities, CAPABILITY_ADD_CALL)) {
