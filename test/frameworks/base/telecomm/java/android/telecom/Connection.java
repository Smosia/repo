...
public abstract class Connection extends Conferenceable {
     ...
     * @internal
     */
    public static final int CAPABILITY_ANSWER = 0x00400000;
     ...
     * @internal
     */
    public static final int CAPABILITY_UNHOLD = 0x00800000;
     ...
     * @internal
     */
    public static final int CAPABILITY_ADD_CALL = 0x01000000;
    ...
    public void setAccountHandle(PhoneAccountHandle handle) {
        ...
        for (Listener l : mListeners) {
            l.onAccountChanged(this, mAccountHandle);
        }
    }
    /// @}
