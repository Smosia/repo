...
public class AudioProfileManager implements IAudioProfileManager {
    ...
    public static final Uri SYSTEM_NOTIFICATION_SOUND = 
	Uri.parse("content://settings/system/notification_sound"); 
    public static final Uri SYSTEM_MESSAGE_SOUND = Uri.parse("content://settings/system/message_ringtone");
    ...
    //Add, JWLW-1141, zhangzixiao, 20131118, Start
    public static final int TYPE_MESSAGE_NOTIFICATION = 33; 
    //Add, JWLW-1141, zhangzixiao, 20131118, End
    ...
    //Add, JWLW-1141, zhangzixiao, 20131118, Start
    private static final String SUFFIX_MESSAGE_NOTIFICATION_URI = "_message_notification_sound"; 
    //Add, JWLW-1141, zhangzixiao, 20131118, End
    //M {
    ...
    public static AudioProfileState getDefaultState(Context context, String profileKey) {
        if (null == sDEFAULTSTATES) {
            if (mDefaultProfileStatesGetter != null) {
                sDEFAULTSTATES = mDefaultProfileStatesGetter.getDefaultProfileStates();
            }
            if (null == sDEFAULTSTATES) {
                ...
                /** Default values of ringer volume for different audio profiles. */
                final int DEFAULT_RINGER_VOLUME_GENERAL = resources.getInteger(com.android.internal.R.integer.default_ringer_volume_general);
                final int DEFAULT_RINGER_VOLUME_SILENT = resources.getInteger(com.android.internal.R.integer.default_ringer_volume_silent);
                final int DEFAULT_RINGER_VOLUME_MEETING = resources.getInteger(com.android.internal.R.integer.default_ringer_volume_meeting);
                final int DEFAULT_RINGER_VOLUME_OUTDOOR = resources.getInteger(com.android.internal.R.integer.default_ringer_volume_outdoor);

                /** Default values of notification volume for different audio profiles. */
                final int DEFAULT_NOTIFICATION_VOLUME_GENERAL = resources.getInteger(com.android.internal.R.integer.default_notification_volume_general);
                final int DEFAULT_NOTIFICATION_VOLUME_SILENT = resources.getInteger(com.android.internal.R.integer.default_notification_volume_silent);
                final int DEFAULT_NOTIFICATION_VOLUME_MEETING = resources.getInteger(com.android.internal.R.integer.default_notification_volume_meeting);
                final int DEFAULT_NOTIFICATION_VOLUME_OUTDOOR = resources.getInteger(com.android.internal.R.integer.default_notification_volume_outdoor);

                /** Default values of alarm volume for different audio profiles. */
                final int DEFAULT_ALARM_VOLUME_GENERAL = resources.getInteger(com.android.internal.R.integer.default_alarm_volume_general);
                final int DEFAULT_ALARM_VOLUME_SILENT = resources.getInteger(com.android.internal.R.integer.default_alarm_volume_silent);
                final int DEFAULT_ALARM_VOLUME_MEETING = resources.getInteger(com.android.internal.R.integer.default_alarm_volume_meeting);
                final int DEFAULT_ALARM_VOLUME_OUTDOOR = resources.getInteger(com.android.internal.R.integer.default_alarm_volume_outdoor);

                /** Default values of vibration for different audio profiles. */
                final boolean DEFAULT_VIBRATION_GENERAL = resources.getBoolean(com.android.internal.R.bool.default_vibration_general);
                final boolean DEFAULT_VIBRATION_SILENT = resources.getBoolean(com.android.internal.R.bool.default_vibration_silent);
                final boolean DEFAULT_VIBRATION_MEETING = resources.getBoolean(com.android.internal.R.bool.default_vibration_meeting);
                final boolean DEFAULT_VIBRATION_OUTDOOR = resources.getBoolean(com.android.internal.R.bool.default_vibration_outdoor);

                /**
                 * Default values that indicate whether the audible DTMF tone should be
                 * played by the dialer when dialing.
                 */
                final boolean DEFAULT_DTMFTONE_GENERAL = resources.getBoolean(com.android.internal.R.bool.default_dtmftone_general);
                final boolean DEFAULT_DTMFTONE_SILENT = resources.getBoolean(com.android.internal.R.bool.default_dtmftone_silent);
                final boolean DEFAULT_DTMFTONE_MEETING = resources.getBoolean(com.android.internal.R.bool.default_dtmftone_meeting);
                final boolean DEFAULT_DTMFTONE_OUTDOOR = resources.getBoolean(com.android.internal.R.bool.default_dtmftone_outdoor);

                /**
                 * Default values of sound effect(Key clicks, lid open/close...) for
                 * different audio profiles.
                 */
                final boolean DEFAULT_SOUNDEFFECT_GENERAL = resources.getBoolean(com.android.internal.R.bool.default_soundeffect_general);
                final boolean DEFAULT_SOUNDEFFECT_SILENT = resources.getBoolean(com.android.internal.R.bool.default_soundeffect_silent);
                final boolean DEFAULT_SOUNDEFFECT_MEETING = resources.getBoolean(com.android.internal.R.bool.default_soundeffect_meeting);
                final boolean DEFAULT_SOUNDEFFECT_OUTDOOR = resources.getBoolean(com.android.internal.R.bool.default_soundeffect_outdoor);

                /** Default values that indicate whether the lock screen sound are enabled. */
                final boolean DEFAULT_LOCK_SCREEN_GENERAL = resources.getBoolean(com.android.internal.R.bool.default_lock_screen_general);
                final boolean DEFAULT_LOCK_SCREEN_SILENT = resources.getBoolean(com.android.internal.R.bool.default_lock_screen_silent);
                final boolean DEFAULT_LOCK_SCREEN_MEETING = resources.getBoolean(com.android.internal.R.bool.default_lock_screen_meeting);
                final boolean DEFAULT_LOCK_SCREEN_OUTDOOR = resources.getBoolean(com.android.internal.R.bool.default_lock_screen_outdoor);

                /** Default values that indicate whether the haptic feedback are enabled. */
                final boolean DEFAULT_HAPTIC_FEEDBACK_GENERAL = resources.getBoolean(com.android.internal.R.bool.default_haptic_feedback_general);
                final boolean DEFAULT_HAPTIC_FEEDBACK_SILENT = resources.getBoolean(com.android.internal.R.bool.default_haptic_feedback_silent);
                final boolean DEFAULT_HAPTIC_FEEDBACK_MEETING = resources.getBoolean(com.android.internal.R.bool.default_haptic_feedback_meeting);
                final boolean DEFAULT_HAPTIC_FEEDBACK_OUTDOOR = resources.getBoolean(com.android.internal.R.bool.default_haptic_feedback_outdoor);
    ...
    public static String getStreamUriKey(String profileKey, int type, long simId) {
		...
		uriKey = profileKey + SUFFIX_MESSAGE_NOTIFICATION_URI;
		if(simId != -1) {
		    uriKey = uriKey + SUFFIX_SIM_ID + simId;
		}
            	break;
    ...
    public Uri getRingtoneUri(String profileKey, int type, long simId) {
	 ...
	 //Modify, JWLW-1141, zhangzixiao, 20131118, Start
		...
		if ((type == TYPE_RINGTONE) || (type == TYPE_NOTIFICATION)
                || (type == TYPE_VIDEO_CALL) || (type == TYPE_SIP_CALL) || (type == TYPE_MESSAGE_NOTIFICATION)) {
    ...
    //Add, JWLW-1141, zhangzixiao, 20131118, Start
    public static String[] defMsgRingtones = new String[] {
    	"/system/media/audio/notifications/NGM_Sax_Melody.ogg",
	"/system/media/audio/notifications/NGM_CarTone.ogg"
    };

    public static String getDefaultMessageRingtone(Context context, int slotId) {
        String defMsgRingtone = null;
        if (isSmsCustomRingtoneSupport()) {
            //defMsgRingtone = RingtoneManager.getActualDefaultRingtoneUri(context, RingtoneManager.TYPE_MESSAGE_RINGTONE).toString();
            defMsgRingtone = SYSTEM_MESSAGE_SOUND.toString();
            Log.e(TAG, "defMsgRingtone==SYSTEM_MESSAGE_SOUND");
        } else {
            defMsgRingtone = SYSTEM_NOTIFICATION_SOUND.toString();
            Log.e(TAG, "defMsgRingtone==SYSTEM_NOTIFICATION_SOUND");
        }
	/*
	if(slotId<0 || slotId>=defMsgRingtones.length) {
    		Log.e(TAG, "getDefaultMessageRingtone error : slotId="+slotId);
    		return defMsgRingtone;
    	}
	return getAudioUriByData(context, defMsgRingtones[slotId]);
	*/
	return defMsgRingtone;
    }

    public static String getAudioUriByData(Context context, String _data) {
    	String defMsgRingtone = SYSTEM_NOTIFICATION_SOUND.toString();
    	Cursor cursor = null;
    	try {
    		String[] projection = new String[] {MediaStore.Audio.AudioColumns._ID};
    		String selection = MediaStore.Audio.AudioColumns.DATA + "=?";
		String[] selectionArgs = new String[] { _data };
    		cursor = SqliteWrapper.query(context, context.getContentResolver(), 
        			MediaStore.Audio.Media.INTERNAL_CONTENT_URI, projection, selection, selectionArgs, null);
    		if(cursor!=null && cursor.getCount()==1 && cursor.moveToFirst()) {
    			String id = cursor.getString(0);
    			defMsgRingtone = Uri.withAppendedPath(MediaStore.Audio.Media.INTERNAL_CONTENT_URI, id).toString();
    		}
    	} catch(Exception e) {
    		Log.e(TAG, "getDefaultMessageRingtone", e);
    	} finally {
	 	if(cursor != null)
			cursor.close();
	}
    	Log.e(TAG, "getDefaultMessageRingtone : defMsgRingtone="+defMsgRingtone+",_data="+_data);
    	return defMsgRingtone;
    }

    public static boolean isSmsDualRingtoneSupport() {
	return android.os.SystemProperties.getBoolean("ro.sms.dual.ringtones.support", false);
    }

    public static boolean isSmsSingleRingtoneSupport() {
	return android.os.SystemProperties.getBoolean("ro.sms.ringle.ringtone.support", false);
    }

    public static boolean isSmsRingtoneSupport() {
	return isSmsDualRingtoneSupport() || isSmsSingleRingtoneSupport();
    }
