...
public class MediaScanner
{
    ...
    private String mDefaultMessageRingtoneFilename;
    private boolean mDefaultMessageRingtoneSet;
    ...
    //add DWYBL-2652 chenshu 20151019 start
    private static final String MESSAGE_RINGTONE_SET = "message_ringtone_set";
    //add DWYBL-2652 chenshu 20151019 end
    ...
    private void setDefaultRingtoneFileNames() {
        ...
        //add DWYBL-2652 chenshu 20151019 start
        mDefaultMessageRingtoneFilename = SystemProperties.get(DEFAULT_RINGTONE_PROPERTY_PREFIX
                + Settings.System.MESSAGE_RINGTONE);
        if (TextUtils.isEmpty(mDefaultMessageRingtoneFilename)) {
            mDefaultMessageRingtoneFilename = mDefaultNotificationFilename;
        }
        //add DWYBL-2652 chenshu 20151019 end
        ...
        Log.v(TAG, "setDefaultRingtoneFileNames: ringtone=" + mDefaultRingtoneFilename
                ...
                + ",message_ringtone=" + mDefaultMessageRingtoneFilename);
    }
...
//            Log.v(TAG, "scanFile: " + path + " took " + (t2-t1));
        ...
        private Uri endFile(FileEntry entry, boolean ringtones, boolean notifications,
            ...
            if (rowId == 0) {
                ...
                if (notifications && ((mWasEmptyPriorToScan && (!mDefaultNotificationSet || !mDefaultMessageRingtoneSet)) ||
                        doesSettingEmpty(NOTIFICATION_SET) || doesSettingEmpty(MESSAGE_RINGTONE_SET))) {
                //Modify DWYBL-2652 chenshu 20151019 end
                    if (TextUtils.isEmpty(mDefaultNotificationFilename) ||
                        ...
                        /// M: Adds log to debug setting ringtones.
                        Log.v(TAG, "mDefaultNotificationFilename: "+TextUtils.isEmpty(mDefaultNotificationFilename));
                        Log.v(TAG, "doesPathHaveFilename: "+doesPathHaveFilename(entry.mPath, mDefaultNotificationFilename));
                        Log.v(TAG, "endFile: needToSetNotification=true.");
                    }

                    //add DWYBL-2652 chenshu 20151019 start
                    if (TextUtils.isEmpty(mDefaultMessageRingtoneFilename) ||
                            doesPathHaveFilename(entry.mPath, mDefaultMessageRingtoneFilename)) {
                        needToSetSettings = true;
                        setMessage = true;
                        /// M: Adds log to debug setting ringtones.
                        Log.v(TAG, "endFile: needToSetMessageRingtone=true.");
                    }
                    //add DWYBL-2652 chenshu 20151019 end
            ...
            if(needToSetSettings) {
                ...
                if (notifications && (doesSettingEmpty(NOTIFICATION_SET) || doesSettingEmpty(MESSAGE_RINGTONE_SET))) {
                //Modify DWYBL-2652 chenshu 20151019 end
                    if (setNotification) {////add DWYBL-2652 chenshu 20151019
                    ...
                    }//add DWYBL-2652 chenshu 20151019
                    //add DWYBL-2652 chenshu 20151019 start
                    if (setMessage && isSmsCustomRingtoneSupport()) {
						Log.v(TAG, "isSmsCustomRingtoneSupport--true");
                        setSettingIfNotSet(Settings.System.MESSAGE_RINGTONE, tableUri, rowId);
                        setProfileSettings(RingtoneManager.TYPE_MESSAGE_RINGTONE, tableUri, rowId);
                        mDefaultMessageRingtoneSet = true;
                        setSettingFlag(MESSAGE_RINGTONE_SET);
                        Log.v(TAG, "endFile: set messageRingtone. setMessage" +setMessage);
                        Log.v(TAG, "endFile: set messageRingtone. uri=" + tableUri + ", rowId=" + rowId);
                    } else {
                        Log.v(TAG, "isSmsCustomRingtoneSupport--false");
                    }
                    //add DWYBL-2652 chenshu 20151019 end 
        ...
        private void setProfileSettings(int type, Uri uri, long rowId) {
            ...
            //add DWYBL-2652 chenshu 20151019 start
            else if (type == RingtoneManager.TYPE_MESSAGE_RINGTONE) {
                setSettingIfNotSet(RingtoneManager.KEY_DEFAULT_MESSAGE_RINGTONE, uri, rowId);
            }
            //add DWYBL-2652 chenshu 20151019 end
        }
