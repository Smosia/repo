...
public class Ringtone {
    ...
    public static String getTitle(
        ...
        if (uri != null) {
            //add DELSLMY-827 guowen 20160311 start
            if(Uri.parse("com.mediatek.uri.silent_notificaton").equals(uri)){
                return context.getString(com.android.internal.R.string.ringtone_silent);
            }
            //add DELSLMY-827 guowen 20160311 end
        ...
        //add DELSLMY-827 guowen 20160315 start
        } else {
            return context.getString(com.android.internal.R.string.ringtone_silent);
        //add DELSLMY-827 guowen 20160315 end
        }
