...
public class RingtoneManager {
    ...
    /**
     * Type that refers to sounds that are used for message ringtone.
     */
    public static final int TYPE_MESSAGE_RINGTONE = 32;
    ...
    //add DWYBL-2652 chenshu 20151019 start
    /**
     * M:The key used to store the default message sound.
     * @hide
     */
    public static final String KEY_DEFAULT_MESSAGE_RINGTONE = "mtk_audioprofile_default_message_ringtone";
    /// @}
    //add DWYBL-2652 chenshu 20151019 end
...
*/
    ...
    private static Ringtone getRingtone(final Context context, Uri ringtoneUri, int streamType) {
        try {
            ...
            if (ringtoneType != -1) {
                ...
                //add DELSLMY-558 guowen 20160311 start
                if(Uri.parse("com.mediatek.uri.silent_notificaton").equals(ringtoneUri)){
                    ringtoneUri = null;
                }
                //add DELSLMY-558 guowen 20160311 end
                if (ringtoneUri != null
            ...
            //delete DELSLMY-558 guowen 20160315 start
            /*else {
            ...
            //delete DELSLMY-558 guowen 20160315 end
            /// @}
    ...
    private static String getSettingForType(int type) {
        ...
        //add DWYBL-2652 chenshu 20151019 start
        } else if ((type & TYPE_MESSAGE_RINGTONE) != 0) {
            return Settings.System.MESSAGE_RINGTONE;
        //add DWYBL-2652 chenshu 20151019 end
        } else {
            return null;
        }
    ...
    public static Uri getDefaultRingtoneUri(Context context, int type) {
        ...
        switch (type) {
			...
			case TYPE_MESSAGE_RINGTONE:
                uriString = Settings.System.getString(resolver, KEY_DEFAULT_MESSAGE_RINGTONE);
                break;
    ...
    public static boolean isRingtoneExist(Context context, Uri uri) {
        ...
        //add DELSLMY-558 guowen 20160311 start
        if(Uri.parse("com.mediatek.uri.silent_notificaton").equals(uri)){
            return true;
        }
        //add DELSLMY-558 guowen 20160311 end
        boolean exist = false;
