...
/************************************************************************
History:
1. chuiguo.zeng@ragentek.com 2013.06.03 BUG_ID:JELY-614
   Description: Show model name when connect to PC as MTP/PTP
************************************************************************/
            ...
            case MtpConstants.DEVICE_PROPERTY_DEVICE_FRIENDLY_NAME:
                ...
                else if(SystemProperties.get("ro.sys.usb.mtp.whql.enable").equals("0"))
                {
                    ...
                    if(property == MtpConstants.DEVICE_PROPERTY_DEVICE_FRIENDLY_NAME) {
                        // Return the device name for the PC display if the FriendlyName is empty!!
                        String deviceName;
			//modify BUG_ID:JELY-614 zengchuiguo 20140512 (start)
                        //deviceName = SystemProperties.get("ro.product.name");  
                        deviceName = SystemProperties.get("ro.mtp.label");
                        if (deviceName == null || "".equals(deviceName)) {
                            deviceName = SystemProperties.get("ro.product.model");
                        }                 
			//modify BUG_ID:JELY-614 zengchuiguo 20140512 (end)
