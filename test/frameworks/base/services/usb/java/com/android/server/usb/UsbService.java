    ...
    public static class Lifecycle extends SystemService {
        ...
        public void onBootPhase(int phase) {
            if (phase == SystemService.PHASE_ACTIVITY_MANAGER_READY) {
				...
				String function = "";
				 try {
					function = SystemProperties.get("persist.sys.default.usb");
            
				} catch (IllegalArgumentException e) {
           
					}
				if(function.equals("")){
					mUsbService.setCurrentFunction("mtp"); 
					mUsbService.setUsbDataUnlocked(true); 
				}else if (function.equals("charging")){
					mUsbService.setCurrentFunction(null); 
					mUsbService.setUsbDataUnlocked(false); 
				}else{
					mUsbService.setCurrentFunction(function); 
					mUsbService.setUsbDataUnlocked(true); 
				}
				//}
            }
