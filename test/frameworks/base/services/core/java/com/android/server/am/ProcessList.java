...
final class ProcessList {
    ...
    // process limit.
    static final int MAX_CACHED_APPS = 8;
    ...
    ProcessList() {
        ...
        if (SystemProperties.get("ro.mtk_gmo_ram_optimize").equals("1")) {
            ...
            if (mTotalMemMb <= LOW_LEVEL_SIZE) {
                ...
                if (SystemProperties.get("ro.build.product").equals("k80tlc_gmo")) {
                    mOomAdj = new int[] {
                        FOREGROUND_APP_ADJ,
                        VISIBLE_APP_ADJ,
                        PERCEPTIBLE_APP_ADJ,
                    ...
                    mOomMinFree = new int[] {
                        ...
                        122880, // 120 * 1024 (ADJ 7 -> 120MB)
                        153600, // 150 * 1024 (ADJ 9 -> 150MB)
                        163840  // 160 * 1024 (ADJ 15 -> 160MB)
                    };
                } else {
                    mOomAdj = new int[] {
                        FOREGROUND_APP_ADJ,
