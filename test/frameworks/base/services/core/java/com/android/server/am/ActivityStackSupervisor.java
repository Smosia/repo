...
public final class ActivityStackSupervisor implements DisplayListener {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case LOCK_TASK_START_MSG: {
                    ...
                    Intent screenPinningIntent = new Intent();
                    screenPinningIntent.putExtra("inSCREENPINNING", true);
                    screenPinningIntent.setAction("SCREENPINNING_SHOW_NAVIGATION_BAR");
                    mService.mContext.sendBroadcast(screenPinningIntent);
                ...
                case LOCK_TASK_END_MSG: {
                    ...
                    //A:DWYBL-2948 guoshuai 20151127(start)
                    Intent screenPinningIntent = new Intent();
                    screenPinningIntent.putExtra("inSCREENPINNING", false);
                    screenPinningIntent.setAction("SCREENPINNING_SHOW_NAVIGATION_BAR");
                    mService.mContext.sendBroadcast(screenPinningIntent);
                    //A:DWYBL-2948 guoshuai 20151127(end)
                    try {
    ...
    */
    ...
    void moveFloatingStackToBackLocked(ActivityStack stack) {
        ...
        /// [ALPS02523277] Should update focused activity when moving floating stack to back. @{
        ActivityRecord r = null;
        for (int stackNdx = stacks.size() - 1; stackNdx >= 0; --stackNdx) {
            final ActivityStack tmpStack = stacks.get(stackNdx);
            if (isFrontStack(tmpStack)) {
                r = tmpStack.topRunningActivityLocked(null);
                if (r != null) {
                    mService.setFocusedActivityLocked(r, "moveFloatingStackToBackLocked");
                    break;
                }
            }
        }
