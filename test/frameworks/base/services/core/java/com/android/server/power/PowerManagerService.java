...
public final class PowerManagerService extends SystemService
    ...
    private boolean mUltraPower = false;
    // A }
    ...
    public void systemReady(IAppOpsService appOps) {
        synchronized (mLock) {
            ...
            // A BUG:DWYLL-491 by zyn 20150525 {
            filter.addAction(Intent.ACTION_ULTRA_POWER_MODE);
            // A }
    ...
    private void updateSettingsLocked() {
        ...
        mDreamsEnabledSetting = (Settings.Secure.getIntForUser(resolver,
            ...
            // A BUG:DWYLL-491 by zyn 20150525 {
        mUltraPower = Settings.Global.getInt(mContext.getContentResolver(),
              Settings.Global.ULTRA_POWER_MODE, 0) == 1;
        mDreamsEnabledSetting = (mDreamsEnabledSetting && !mUltraPower);
        // A }
    ...
    void updateLowPowerModeLocked() {
        ...
        if (mLowPowerModeEnabled != lowPowerModeEnabled) {
           ...
           // M BUG:DWYLL-491 by zyn 20150525 {
            //powerHintInternal(POWER_HINT_LOW_POWER, lowPowerModeEnabled ? 1 : 0);
            powerHintInternal(POWER_HINT_LOW_POWER, (lowPowerModeEnabled || mUltraPower) ? 1 : 0);
            // M }
    ...
    private void updateUserActivitySummaryLocked(long now, int dirty) {
        ...
        if ((dirty & (DIRTY_WAKE_LOCKS | DIRTY_USER_ACTIVITY
            ...
            if (mWakefulness == WAKEFULNESS_AWAKE
                ...
                if(mScreenOffTimeoutSetting != 0){ //Add by zhaopenglin for never sleep 20160229
                if (mUserActivitySummary != 0 && nextTimeout >= 0) {
                    Message msg = mHandler.obtainMessage(MSG_USER_ACTIVITY_TIMEOUT);
                    msg.setAsynchronous(true);
                    mHandler.sendMessageAtTime(msg, nextTimeout);
                }
               //Add by zhaopenglin for never sleep 20160229 start
               }else {
                    mUserActivitySummary |= USER_ACTIVITY_SCREEN_BRIGHT;
               }
               //Add by zhaopenglin for never sleep 20160229 end
            } else {
                mUserActivitySummary = 0;
            }
    ...
    private final class BatteryReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            */
            ...
            if (action != null && Intent.ACTION_ULTRA_POWER_MODE.equals(action)) {
                mUltraPower = intent.getBooleanExtra(Intent.ACTION_ULTRA_POWER_MODE,false);
                Slog.d("pms","receive:ACTION_ULTRA_POWER_MODE->powerHintInternal");
                powerHintInternal(POWER_HINT_LOW_POWER, (mLowPowerModeEnabled || mUltraPower) ? 1 : 0);
            } else {
                synchronized (mLock) {
                    handleBatteryStateChangedLocked();
                }
