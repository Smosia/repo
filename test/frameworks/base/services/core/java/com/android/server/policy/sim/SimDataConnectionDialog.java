...
package com.android.internal.policy.impl.sim;
...
// /       mController = controller;
    ...
    private void updateSimInfoList(Context context) {
        ...
        //modify BUG_ID:DWLJE-1217 dushuaihui 20151016(start)
        //SubscriptionManager.INVALID_SUBSCRIPTION_ID, context.getResources().getString(R.string.data_closed), "", null);
        ...
        final DialogInterface.OnClickListener selectionListener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int value) {
                ...
                if ((mSimInfoList.size()==3 && value==2) || 
                    ...
                    ISimManagementExt mExt = getSimManagmentExtPlugin(context);
                    if (!mExt.switchDefaultDataSub(context, si.mSubId)) {
                        ...
                        setMobileDataEnabled(si.mSubId, true);
     ...
     */
    private ISimManagementExt getSimManagmentExtPlugin(Context context) {
