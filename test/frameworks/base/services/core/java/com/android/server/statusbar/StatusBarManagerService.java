...
public class StatusBarManagerService extends IStatusBarService.Stub {
    ...
    /**
     * Show default account status icon on StatusBar.
     * @param subId
     */
    public void showDefaultAccountStatus(int subId) {
        if (mBar != null) {
            try {
                mBar.showDefaultAccountStatus(subId);
            } catch (RemoteException ex) {
                Slog.e(TAG, "unable to showSimIndicator, Exception:", ex);
            }
        }
    }
    /**
