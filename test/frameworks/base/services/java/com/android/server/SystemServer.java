...
public final class SystemServer {
    ...
    private void startOtherServices() {
		...
		//add   by  xieshanlin   JWLWEL-123  20140203
        TpGestureService  tpGestureService=null;
		//add   by  xieshanlin   JWLWEL-123  20140203
        ...
        try {
            ...
            tpGestureService=new TpGestureService(context);
            ServiceManager.addService("tpgesture", tpGestureService);
			}
			//add   by  xieshanlin   JWLWEL-123  20140203
