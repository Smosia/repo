    ...
    public List<AccessPoint> getAccessPoints() {
        synchronized (mAccessPoints) {
            ...
            for (AccessPoint accessPoint : mAccessPoints) {
                // A : remove "NVRAM WARNING: Err" msg when no mac addr, kui.li, 2016-05-10,start {
                if((accessPoint.getConfigName() != null && accessPoint.getConfigName().startsWith("NVRAM WARNING: Err")) ||
                    (accessPoint.getSsid() != null && accessPoint.getSsid().toString().startsWith("NVRAM WARNING: Err")))
                    continue;
                // A : end}
