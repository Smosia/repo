...
/****************************************
History:
1.gangzhou@ragentek 20160317 BUG_ID:DELSLMY-947
	Description: add continue GMT+00:00
****************************************/
...
public class ZoneGetter {
    ...
    public static List<Map<String, Object>> getZonesList(Context context) {
		...
		//add BUG_ID:DELSLMY-947 gang.zhou 20160317(start)
		if("GMT+00:00".equals(displayName)){
			continue;
		}
		//add BUG_ID:DELSLMY-947 gang.zhou 20160317(end)
		
		//add BUG_ID:DWYQLSSMY-151 liupeng 20160328(start)
		if(displayName.equals("Shanghai")){
                displayName = "Beijing";
		}
		//add BUG_ID:DWYQLSSMY-151 liupeng 20160328(end)
