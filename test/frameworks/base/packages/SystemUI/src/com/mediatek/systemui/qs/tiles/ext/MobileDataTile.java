...
//add BUG_ID:DWYQLSS-97 dushuaihui 20160307(start)
import java.util.List;
import android.os.Handler;
import android.telephony.SubscriptionInfo;
import com.mediatek.systemui.statusbar.util.SimDataConnectionDialog;
//add BUG_ID:DWYQLSS-97 dushuaihui 20160307(end)

//add BUG_ID:xxx dushuaihui 2016040414(start)
import android.telephony.TelephonyManager;
import android.content.Context;
//add BUG_ID:xxx dushuaihui 2016040414(end)
...
public class MobileDataTile extends QSTile<QSTile.SignalState> {
    ...
    //add BUG_ID:DWYQLSS-97 dushuaihui 20160307(start)
    private SimDataConnectionDialog mDialog;
    private static final int MSG_DIMISS_DIALOG = 1;
    private static final int TIME_DIMISS_DIALOG = 5000;
	//add BUG_ID:DWYQLSS-97 dushuaihui 20160307(end)
    ...
    public MobileDataTile(Host host) {
        ...
        //add BUG_ID:DWYQLSS-97 dushuaihui 20160307(start)
        mDialog = new SimDataConnectionDialog(mContext);
        mDialog.setMobileDataController(mDataController);
		//add BUG_ID:DWYQLSS-97 dushuaihui 20160307(end)
    }
    ...
    protected void handleClick() {
        //modify BUG_ID:DWYQLSS-97 dushuaihui 20160307(start)
        ...
        List<SubscriptionInfo> subList = mDialog.getSubInfoList();
        ...
        mHandler.removeMessages(MSG_DIMISS_DIALOG);
        mHandler.sendEmptyMessageDelayed(MSG_DIMISS_DIALOG, TIME_DIMISS_DIALOG);
        //modify BUG_ID:DWYQLSS-97 dushuaihui 20160307(end)
    }
