        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
        	...
        	//add BUG_ID:DELSLMY-856 by zhoulei 20160318 (start)
			    private void postStartSample() {
			        ...
			        ringHandler.sendMessageDelayed(ringHandler.obtainMessage(MSG_SAMPLE_START),
			    ...
			    void postStopSample() {
			        ...
			        ringHandler.removeMessages(MSG_SAMPLE_START);
			        ringHandler.removeMessages(MSG_SAMPLE_STOP);
			        ringHandler.sendMessageDelayed(ringHandler.obtainMessage(MSG_SAMPLE_STOP),2000);
			    }
