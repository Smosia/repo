...
// A BUG:DELSLMY-697 by wxd 20160308 {
...
class SaveImageInBackgroundTask extends AsyncTask<SaveImageInBackgroundData, Void,
    ...
    SaveImageInBackgroundTask(Context context, SaveImageInBackgroundData data,
	  ...
	  // M BUG:DELSLMY-697 by wxd 20160308 {
        //mScreenshotDir = new File(Environment.getExternalStoragePublicDirectory(
                //Environment.DIRECTORY_PICTURES), SCREENSHOTS_DIR_NAME);
        String defaultStorageDir = StorageManagerEx.getDefaultPath();
		Log.i("wxd","defaultStorageDir==="+defaultStorageDir);
	    mScreenshotDir = new File(defaultStorageDir+"/"+Environment.DIRECTORY_PICTURES, SCREENSHOTS_DIR_NAME);
	 //M: }
