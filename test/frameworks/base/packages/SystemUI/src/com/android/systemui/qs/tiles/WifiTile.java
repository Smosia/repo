...
public class WifiTile extends QSTile<QSTile.SignalState> {
    ...
    protected void handleUpdateState(SignalState state, Object arg) {
        ...
        if (!state.enabled) {
            ...
            //M:DWYSLM-491 guoshuai 20160412(start)
            //state.label = r.getString(R.string.quick_settings_wifi_label);
            boolean showWifiOff = r.getBoolean(R.bool.config_showWifiOff);
            int resOffId = showWifiOff ? R.string.quick_settings_wifi_off_label
                    : R.string.quick_settings_wifi_label;
            state.label = r.getString(resOffId);
            //M:DWYSLM-491 guoshuai 20160412(end)
            ...
            //M:DWYSLM-173 guoshuai 20160321(start)
            boolean showWifiNotConnected = r.getBoolean(R.bool.config_showWifiNotConnected);
            int resId = showWifiNotConnected ? R.string.quick_settings_wifi_not_connected
                    : R.string.quick_settings_wifi_label;
            state.label = r.getString(resId);
            //M:DWYSLM-173 guoshuai 20160321(end)
