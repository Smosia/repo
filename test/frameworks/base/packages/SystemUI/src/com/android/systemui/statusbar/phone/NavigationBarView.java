...
public class NavigationBarView extends LinearLayout {
    ...
    private boolean mIsNavibarEnabled; //A:JWBLB-2271 guoshuai 20160222
    ...
    public View getRecentsButton() {
        //M:JWBLB-2271 guoshuai 20160222(start)
        ...
        return view;*/
        return mCurrentView.findViewById(isNormalDirection() ? R.id.recent_apps : R.id.recent_apps_1);
        //M:JWBLB-2271 guoshuai 20160222(end)
    }
    ...
    public View getBackButton() {
        ...
        return view;*/
        return mCurrentView.findViewById(isNormalDirection() ? R.id.back : R.id.back_1);
        //M:JWBLB-2271 guoshuai 20160222(end)
    }
    //A:JWBLB-2271 guoshuai 20160222(start)
    private boolean isNormalDirection(){
        return Settings.Secure.getInt(getContext().getContentResolver(), "accessibility_navibar_direction", 0) == 0;
    }

    public void setButtonVisible(){
        mCurrentView.findViewById(!isNormalDirection() ? R.id.back : R.id.back_1).setVisibility(View.GONE);
    	mCurrentView.findViewById(!isNormalDirection() ? R.id.recent_apps : R.id.recent_apps_1).setVisibility(View.GONE);
    ...
    //A:JWBLB-2271 guoshuai 20160222(start)
    public View getNavigationBarButton() {
        return mCurrentView.findViewById(R.id.navigationbar);
    }
    //A:JWBLB-2271 guoshuai 20160222(end)
    ...
    public void setDisabledFlags(int disabledFlags, boolean force) {
        ...
        setButtonVisible();//A:JWBLB-2271 guoshuai 20160222
        ...
        if (mIsNavibarEnabled) {
            getNavigationBarButton().setVisibility(disableBack     ? View.INVISIBLE : View.VISIBLE);
        } else {
            getNavigationBarButton().setVisibility(View.INVISIBLE);
        }
        //A:JWBLB-2271 guoshuai 20160222(end)
        /// M: add for multi window @{
        if(MultiWindowProxy.isSupported()){
    ...
    */
    ...
    //A:JWBLB-2271 guoshuai 20160222(start)
    public void setNavibarEnabled(boolean enabled) {
        mIsNavibarEnabled = enabled;
    }
    //A:JWBLB-2271 guoshuai 20160222(end)
    ...
    public void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        ...
        dumpButton(pw, "navigationbar", getNavigationBarButton());//A:JWBLB-2271 guoshuai 20160222
        pw.println("    }");
    }
