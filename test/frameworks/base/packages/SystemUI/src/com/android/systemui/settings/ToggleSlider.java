...
public class ToggleSlider extends RelativeLayout {
    public interface Listener {
        ...
        public void onModeChanged(ToggleSlider v, boolean tracking, boolean checked, int value);
    ...
    public void updateResources(){
        if(mLabel != null){
            mLabel.setText(R.string.status_bar_settings_auto_brightness_label);
        }
    }
    //A:DWYQLSSMY-94 wanglin 20160329(end)
    @Override
    ...
    private final OnCheckedChangeListener mCheckListener = new OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(CompoundButton toggle, boolean checked) {
            ...
            mListener.onModeChanged(ToggleSlider.this, mTracking, checked, mSlider.getProgress());
            // A:DWYQLSSMY-94 wanglin 20160329(start)           
            }
