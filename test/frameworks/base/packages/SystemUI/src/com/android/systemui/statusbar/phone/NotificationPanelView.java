...
public class NotificationPanelView extends PanelView implements
    ...
    private boolean handleQsTouch(MotionEvent event) {
        ...
        //M:DWYSLM-176 guoshuai 20160418(start)
        if (getContext().getResources().getBoolean(R.bool.config_locked_hanset_not_drag_down)) {
            if (!mQsExpandImmediate && mQsTracking && !mKeyguardShowing) {
                onQsTouch(event);
        ...
        //M:DWYSLM-176 guoshuai 20160418(end)
    ...
    private void setQsExpanded(boolean expanded) {
        //A:DWYSLM-176 guoshuai 20160418(start)
        if(getContext().getResources().getBoolean(R.bool.config_locked_hanset_not_drag_down)){
            if(mKeyguardShowing) return;
        }
        //A:DWYSLM-176 guoshuai 20160418(end)
    ...
    private boolean shouldQuickSettingsIntercept(float x, float y, float yDiff) {
        ...
        if(getContext().getResources().getBoolean(R.bool.config_locked_hanset_not_drag_down)){    
		    ...
		    header = mKeyguardShowing ? mKeyguardStatusBar : mHeader;
        }
        //M:DWYSLM-176 guoshuai 20160418(end)
