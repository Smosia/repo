...
public class FlashlightController {
    ...
    //A: DWYLL-344 liuhao 20150505{
    private static final int DISPATCH_STATE_CHANGED = 3;
    //A:}
    ...
    //A: DWYLL-344 liuhao 20150505{
    private void dispatchStateChanged(boolean enabled){
        dispatchListeners(DISPATCH_STATE_CHANGED, enabled);
    }
    //A:}
    ...
    public interface FlashlightListener {
        ...
        //A: DWYLL-344 liuhao 20150505{
        /**
         * Called when flashlight's state is changed.
         * @param flashlight's state
         */
        void onFlashlightStateChanged(boolean enabled);
        //A:}
    }
    ...
    private void initializeReceiver(Context context) {
        ...
        filter.addAction("com.android.camera_led");//add for camera
