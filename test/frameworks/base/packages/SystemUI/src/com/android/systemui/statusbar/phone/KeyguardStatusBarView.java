...
public class KeyguardStatusBarView extends RelativeLayout
    ...
    protected void onFinishInflate() {
        ...
        updateUserSwitcher();
	//A DWLEBM-467 yeyu 20160425 start
	final boolean enable = Settings.System.getInt(getContext().getContentResolver(), BATTERY_PERCENTAGE_ENABLE, 0) != 0;
        mBatteryLevel.setVisibility(mBatteryCharging || enable ? View.VISIBLE : View.GONE);
	//A DWLEBM-467 yeyu 20160425 end
    }
