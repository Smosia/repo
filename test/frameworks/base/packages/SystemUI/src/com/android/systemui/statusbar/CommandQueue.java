...
public class CommandQueue extends IStatusBar.Stub {
    ...
    private static final int MSG_RELOAD_NAVIGATIONBAR = 26 << MSG_SHIFT;
    private static final int MSG_REMOVE_NAVIGATIONBAR = 27 << MSG_SHIFT;
    ...
    private final class H extends Handler {
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                /// @}
                 //add BUG_ID:JBLW-93 daizhiyi 20131123 (start)
                case MSG_RELOAD_NAVIGATIONBAR:
                    mCallbacks.reloadNavigationBar();
                    break;
                case MSG_REMOVE_NAVIGATIONBAR:
                    mCallbacks.removeNavigationBar();
                    break;
                //add BUG_ID:JBLW-93 daizhiyi 20131123 (end)
            }
        }
    ...
    public void reloadNavigationBar() {
        synchronized (mList) {
            mHandler.obtainMessage(MSG_RELOAD_NAVIGATIONBAR, 0, 0, null).sendToTarget();
        }
    }

    public void removeNavigationBar() {
        synchronized (mList) {
            mHandler.obtainMessage(MSG_REMOVE_NAVIGATIONBAR, 0, 0, null).sendToTarget();
        }
    }
    //add BUG_ID:JBLW-93 daizhiyi 20131123 (end)
}
