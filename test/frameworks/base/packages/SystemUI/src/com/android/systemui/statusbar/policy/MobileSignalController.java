...
public class MobileSignalController extends SignalController<
    ...
    private void mapIconSets() {
       ...
       //add BUG_ID:DWLEBM-68 dushuaihui 20160314(start)
        MobileIconGroup hGroup = TelephonyIcons.THREE_G;
		
        boolean show4gImplementation = mContext.getResources().getBoolean(R.bool.config_4g_implementation_support);
        if(show4gImplementation){
            hGroup = TelephonyIcons.FOUR_G;
        }

        mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_EVDO_0, hGroup);
        mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_EVDO_A, hGroup);
        mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_EVDO_B, hGroup);
        mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_EHRPD, hGroup);
        mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_UMTS, hGroup);
        ...
        if (!mConfig.showAtLeast3G) {
            ...
            mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_1xRTT,
                    hGroup);
            mDefaultIcons = hGroup;
        }

        //MobileIconGroup hGroup = TelephonyIcons.THREE_G;//delete BUG_ID:DWLEBM-68 dushuaihui 20160314
        ...
        if (mConfig.show4gForLte) {
            if(show4gImplementation){
                mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_LTE, TelephonyIcons.LTE_BLU);
            }else{
