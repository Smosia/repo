...
class TelephonyIcons {
    ...
    static final int[][] DATA_LTE_BLU = {
            { R.drawable.stat_sys_data_fully_connected_lte_blu,
              R.drawable.stat_sys_data_fully_connected_lte_blu,
              R.drawable.stat_sys_data_fully_connected_lte_blu,
              R.drawable.stat_sys_data_fully_connected_lte_blu },
            { R.drawable.stat_sys_data_fully_connected_lte_blu,
    ...
    static final int QS_DATA_LTE_BLU = R.drawable.ic_qs_signal_lte_blu;
    //add BUG_ID:DWLEBM-68 dushuaihui 20160314(end)
    ...
    static final int ICON_H_PLUS = R.drawable.stat_sys_data_fully_connected_h_plus;//add BUG_ID:DWLEBM-68 dushuaihui 20160314
    static final int ICON_LTE_BLU = R.drawable.stat_sys_data_fully_connected_lte_blu;//add BUG_ID:DWLEBM-68 dushuaihui 20160314
    ...
    static final MobileIconGroup LTE_BLU = new MobileIconGroup(
            ...
            false,
            TelephonyIcons.QS_DATA_LTE_BLU
            );
    //add BUG_ID:DWLEBM-68 dushuaihui 20160314(end)
