...
public class KeyguardIndicationController {
    ...
    public KeyguardIndicationController(Context context, KeyguardIndicationTextView textView,
        ...
        //A: DWYSLM-99 xiangkezhu 20160330 (start)
        if(mContext.getResources().getBoolean(R.bool.config_disablePercentInLockScreen)){
            context.registerReceiver(mBroadcastReceiver, new IntentFilter(Intent.ACTION_BATTERY_CHANGED));
        }
        //A: DWYSLM-99 xiangkezhu 20160330 (end)
    }
    ...
    private String computeIndication() {
        ...
        //Modify DWYSLM-99 xiangkezhu 20160330 (start)
        if(mContext.getResources().getBoolean(R.bool.config_disablePercentInLockScreen)){
            String keyguardBattery = mContext.getResources().getString(R.string.keyguard_battery);
            return keyguardBattery + ":" + mBatteryValue;
        }else{
            return mRestingIndication;
        }
        //Modify DWYSLM-99 xiangkezhu 20160330 (end)
    }
    ...
    private String computePowerIndication() {
        ...
        //Modify DWYSLM-99 xiangkezhu 20160330(start)
        if(mContext.getResources().getBoolean(R.bool.config_disablePercentInLockScreen)){
            String keyguardCharging = mContext.getResources().getString(R.string.keyguard_plugged_in);
            return keyguardCharging + ":" + mBatteryValue;
        }else{
    ...
    //Add DWYSLM-99 xiangkezhu 20160330(start)
    ...
    BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
		    ...
		    if (Intent.ACTION_BATTERY_CHANGED.equals(action)) {
		        ...
		        mBatteryValue = NumberFormat.getPercentInstance().format((double) level / 100.0);
            }
        }
    };//Add DWYSLM-99 xiangkezhu 20160330(end)
