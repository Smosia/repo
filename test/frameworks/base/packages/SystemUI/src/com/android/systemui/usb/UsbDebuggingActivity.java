...
import android.provider.Settings;//add erhui
...
public class UsbDebuggingActivity extends AlertActivity
    ...
    private String mKey;
    //A:DWYQLSSMY-1066 xiangkezhu 20160513 start
    private int isOpened=0;
    //A:DWYQLSSMY-1066 xiangkezhu 20160513 end
    ...
    public void onCreate(Bundle icicle) {
        ...
        //A:DWYQLSSMY-1066 xiangkezhu 20160513 start
        isOpened = Settings.Global.getInt(this.getContentResolver(),
        "android_adb_open", 0);
        Log.d("huang", "isOpened="+isOpened);
        if(isOpened==1){
            try {
    ...
    protected void onStop() {
        //M:DWYQLSSMY-1066 xiangkezhu 20160513 start
        if (mDisconnectedReceiver != null && isOpened == 0) {
        //A:DWYQLSSMY-1066 xiangkezhu 20160513 end
