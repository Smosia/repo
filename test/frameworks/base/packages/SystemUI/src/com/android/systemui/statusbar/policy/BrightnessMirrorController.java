...
public class BrightnessMirrorController {
    ...
    public void showMirror() {
        updateMirror();//A:DWYQLSSMY-94 wanglin 20160329(start)
    ...
    private void updateMirror() {
        if(mBrightnessMirror != null){
            ToggleSlider slider = (ToggleSlider) mBrightnessMirror.findViewById(R.id.brightness_slider);
            slider.updateResources();
        }
    }
