...
public class SignalClusterView
    ...
    //add BUG_ID:DWYQA-105 dushuaihui20160330(start)
    View mNoSimsCombo, mNoSimsCombo2;
    ImageView mVpn, mEthernet, mWifi, mAirplane, mNoSims, mEthernetDark, mWifiDark, mNoSimsDark, mNoSims2, mNoSimsDark2;
    //add BUG_ID:DWYQA-105 dushuaihui20160330(start)
    ...
    protected void onAttachedToWindow() {
        ...
        //add BUG_ID:DWYQA-105 dushuaihui20160330(end)
        ...
        mSignalClusterExt.onAttachedToWindow(mMobileSignalGroup, mNoSims2);//add BUG_ID:DWYQA-105 dushuaihui20160330
        /// M: Support "Operator plugin's ISignalClusterExt". @}
    ...
    private void apply() {
        ...
        //modify BUG_ID:DWLEBM-56 dushuaihui 20160314(start)
        if(this.getContext().getResources().getBoolean(R.bool.config_remove_no_sim_icon)){
            ...
            //add BUG_ID:DWYQA-105 dushuaihui20160330(start)
            if(getContext().getResources().getBoolean(R.bool.config_show_two_no_sim_icon)){
                ...
                mNoSimsCombo2.setVisibility((simCount >= 2 && subInfoList != null && subInfoList.size() >= 2) ? View.GONE : View.VISIBLE);
            }else{
                mNoSimsCombo2.setVisibility(View.GONE);
            }
            //add BUG_ID:DWYQA-105 dushuaihui20160330(end)
            ...
            if (FeatureOptionUtils.isMTK_CT6M_SUPPORT()) {
                if (mIsAirplaneMode) {
                    mNoSimsCombo.setVisibility(View.GONE);
                    mNoSimsCombo2.setVisibility(View.GONE);//add BUG_ID:DWYQA-105 dushuaihui20160330
                }
            }
        }
        /// @}
        //modify BUG_ID:DWLEBM-56 dushuaihui 20160314(end)
    ...
    private void applyIconTint() {
        ...
        applyDarkIntensity(mDarkIntensity, mNoSims2, mNoSimsDark2);//add BUG_ID:DWYQA-105 dushuaihui20160330
    ...
    private class PhoneState {
        ...
        private Context mContext;//add BUG_ID:DWLEBM-56 dushuaihui 20160314
        ...
        public PhoneState(int subId, Context context) {
            ...
            setViews(root);
            mSubId = subId;
            mContext = context;//add BUG_ID:DWLEBM-56 dushuaihui 20160314
        }
        ...
        private void setCustomizeViewProperty() {
            ...
            //modify BUG_ID:DWLEBM-56 dushuaihui 20160314(start)
            if(!mContext.getResources().getBoolean(R.bool.config_remove_network_type)){
			    setNetworkIcon();
            }
            //modify BUG_ID:DWLEBM-56 dushuaihui 20160314(end)
