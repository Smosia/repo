    ...
    private MultiChoiceModeListener mMultiListener = new MultiChoiceModeListener() {
        ...
        public boolean onActionItemClicked(final ActionMode mode, MenuItem item) {
            ...
            if (id == R.id.menu_open) {
            	...
            	//A: DELSLMY-605 liuhuaizhi 20160302(start)
//              /// M: remove state @{
//              final State state = getDisplayState(DirectoryFragment.this);
...
//              return true;
              ...
              builder.setTitle(R.string.delete).setIcon(android.R.drawable.ic_dialog_alert).setMessage(
                      alertMsg).setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
              			@Override
              ...
              builder.create().show();
              return true;
          	//A: DELSLMY-605 liuhuaizhi 20160302(end) 
                ...
                updateDisplayState();
                return true;
            //A: DELSLMY-606 liuhuaizhi 20160302(start)
                    ...
                    updateDisplayState();
                    return true;
            //A: DELSLMY-606 liuhuaizhi 20160302(end)
            } else {
                return false;
            }
        }
    ...
    private class DocumentsAdapter extends BaseAdapter {
        ...
        private View getDocumentView(int position, View convertView, ViewGroup parent) {
            ...
            //M:DWLEBM-124 liuhuaizhi 20160317(start)
//            final boolean showThumbnail = supportsThumbnail && allowThumbnail && !mSvelteRecents
//                    && showDrmThumbnail;
            final boolean showThumbnail;
            if (getResources().getBoolean(R.bool.show_recent_image)) {
                showThumbnail = supportsThumbnail && allowThumbnail && !mSvelteRecents
                        && showDrmThumbnail;
            } else {
            	showThumbnail = supportsThumbnail && allowThumbnail && showDrmThumbnail;
            }
            //M:DWLEBM-124 liuhuaizhi 20160317(start)            
