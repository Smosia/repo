...
public class FlashlightTile extends QSTile<QSTile.BooleanState> implements
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
		...
		//add by chenshuyue DELSLMY-670 start
		if(state.value){
			Settings.System.putString(mContext.getContentResolver(),"synledflash", "1");
		}else{
			Settings.System.putString(mContext.getContentResolver(),"synledflash", "0");
		}
		//add by chenshuyue DELSLMY-670 end
