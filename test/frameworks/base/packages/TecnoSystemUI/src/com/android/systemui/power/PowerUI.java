...
public class PowerUI extends SystemUI {
    ...
    AlertDialog mBatteryFullDialog;
    boolean mIsShownBatteryFullDialog;
    //A: }

    public void start() {
	    //A: DELSLM-160 huangerhui 20160129 {
        mIsShownBatteryFullDialog = mContext.getResources().getBoolean(
                R.bool.config_isShownBatteryFullDialog);
        //A: }
    ...
    private final class Receiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_BATTERY_CHANGED)) {
                ...
                //A: DELSLM-160 huangerhui 20160129 {
                if (mIsShownBatteryFullDialog) {
                    if (plugged && oldBatteryLevel == 99 && mBatteryLevel == 100) {
                        showBatteryFullDialog();
                    }
                    else if (!plugged || mBatteryLevel < 100) {
                        dismissBatteryFullDialog();
                    }
                }
                //A : }
    ...
    //A: DELSLM-160 huangerhui 20160129 {
    void dismissBatteryFullDialog() {
        if (mBatteryFullDialog != null) {
            mBatteryFullDialog.dismiss();
        }
    }

    void showBatteryFullDialog() {
        Slog.i(TAG, "showBatteryFullDialog");

        if (mBatteryFullDialog == null) {
            //M: DELSLM-160 huangerhui 20160129 {
            //AlertDialog.Builder b = new AlertDialog.Builder(mContext);
            AlertDialog.Builder b = new AlertDialog.Builder(
                    mContext, com.android.internal.R.style.Theme_DeviceDefault_Light_Dialog_Alert);
            //M: }
                b.setCancelable(true);
                b.setTitle(R.string.battery_charged_title);
                b.setMessage(R.string.battery_charged);
