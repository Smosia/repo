...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    public void start() {
        ...
        //A:DWYBL-2948 guoshuai 20151127(start)
        final IntentFilter filter = new IntentFilter();
        filter.addAction("SCREENPINNING_SHOW_NAVIGATION_BAR");
        mContext.registerReceiver(new BroadcastReceiver() {
            public void onReceive(Context context, Intent intent) {
                boolean isInScreenPinning = intent.getBooleanExtra("inSCREENPINNING", false);
                Log.v(TAG, "inSCREENPINNING:" + isInScreenPinning);
        ...
        //A:DWYBL-2948 guoshuai 20151127(end)
    }
