        ...
        switch (event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (isFullyCollapsed() && !mHeadsUpManager.hasPinnedHeadsUp()) {
                 ...
                 if((Settings.Global.getInt(getContext().getContentResolver(),Settings.Global.BLACK_GESTURE_WAKE_F, 1) == 1)&&
                           (Settings.Global.getInt(getContext().getContentResolver(),Settings.Global.BLACK_GESTURE_WAKE, 0) == 1)&&
