...
public class SignalClusterView
    ...
    public void setMobileDataIndicators(IconState statusIcon, IconState qsIcon, int statusType,
        ...
        //modify BUG_ID:DELSLM-55 dushuaihui 20160127(start)
        state.showActivityIn = activityIn;
        state.showActivityout = activityOut;
        //modify BUG_ID:DELSLM-55 dushuaihui 20160127(end)
    ...
    private class PhoneState {
        ...
        //modify BUG_ID:DELSLM-55 dushuaihui 20160127(start)
		private boolean showActivityIn = false;
		private boolean showActivityout = false;
        //modify BUG_ID:DELSLM-55 dushuaihui 20160127(end)

        private ImageView mMobile, mMobileDark, mMobileType, mMobileSignalIn, mMobileSignalOut;//modify BUG_ID:DELSLM-55 dushuaihui 20160127
        ...
        public void setViews(ViewGroup root) {
            ...
            //modify BUG_ID:DELSLM-55 dushuaihui 20160127(start)
			mMobileSignalIn = (ImageView) root.findViewById(R.id.mobile_signal_in);
			mMobileSignalOut = (ImageView) root.findViewById(R.id.mobile_signal_out);
            //modify BUG_ID:DELSLM-55 dushuaihui 20160127(end)
        ...
        public boolean apply(boolean isSecondaryIcon) {
            ...
            //modify BUG_ID:DELSLM-55 dushuaihui 20160127(start)
            mMobileSignalIn.setVisibility((showActivityIn && mMobileTypeId != 0 && mMobileTypeId != R.drawable.stat_sys_data_fully_connected_roam) ? View.VISIBLE : View.GONE);

            mMobileSignalOut.setVisibility((showActivityout && mMobileTypeId != 0 && mMobileTypeId != R.drawable.stat_sys_data_fully_connected_roam) ? View.VISIBLE : View.GONE);
            //modify BUG_ID:DELSLM-55 dushuaihui 20160127(end)
        ...
        private void setCustomizeViewProperty() {
            ...
            //setNetworkIcon();//BUG_ID:DELSLM-404 dushuaihui 20160217
