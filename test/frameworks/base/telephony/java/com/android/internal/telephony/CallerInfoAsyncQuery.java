...
public class CallerInfoAsyncQuery {
    ...
    public static CallerInfoAsyncQuery startQuery(int token, Context context, String number,
        ...
        if (!isCustomEcc(number) && PhoneNumberUtils.isEmergencyNumberExt(number, phoneType)) {
    ...
    private static boolean isCustomEcc(String number) {
        android.util.Log.d("sqm", "[isCustomEcc] framework==> number: " + number);
        if (!"1".equals(SystemProperties.get("ro.qmobile_ecc_config"))) {
            return false;
        }
