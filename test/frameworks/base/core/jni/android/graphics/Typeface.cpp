...
//========================lovelyfonts start========================
#ifdef LOVELYFONTS_SUPPORT
static void Typeface_updateLovelyfonts(JNIEnv *env) {
    return TypefaceImpl_updateLovelyfonts();
}
static void Typeface_setCanReplace(JNIEnv* env,jlong faceHandle,jboolean can) {
    TypefaceImpl* face = reinterpret_cast<TypefaceImpl*>(faceHandle);
    TypefaceImpl_setCanReplace(face,can);
}
static jboolean Typeface_getCanReplace(JNIEnv* env,jlong faceHandle) {
    TypefaceImpl* face = reinterpret_cast<TypefaceImpl*>(faceHandle);
    return TypefaceImpl_getCanReplace(face);
}
#endif
//========================lovelyfonts end  ========================
