...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
         ...
         * @hide
         */
        public static final String FLOAT_WINDOW_WHEN_CALLING =
            "float_window_when_calling";
        ...
        //add DWYBL-2652 chenshu 20151019 start
        /**
         * Persistent store for the system-wide default message sound.
         *
         * @see #RINGTONE
         * @see #DEFAULT_MESSAGE_RINGTONE_URI
         */
        public static final String MESSAGE_RINGTONE = "message_ringtone";

        /**
         * A {@link Uri} that will point to the current default message
         * ringtone at any given time.
         *
         * @see #DEFAULT_MESSAGE_RINGTONE_URI
         */
        public static final Uri DEFAULT_MESSAGE_RINGTONE_URI = getUriFor(MESSAGE_RINGTONE);
        //add DWYBL-2652 chenshu 20151019 end
       ...
       /**
        ...
        //add DELSLMY-58 huangerhui 20160303
         public static final String LOCKSCREEN_FLASH_LIGHT_ON = "lockscreen_show_torch";
        ...
        //A: kuangyunfeng 20160504(start)
        public static final String OTA_SERVER_URL = "ota_server_url";
        //A: kuangyunfeng 20160504(end)
        ...
        static {
            ...
            //A: kuangyunfeng 20160504(start)
            PUBLIC_SETTINGS.add(OTA_SERVER_URL);
            //A: kuangyunfeng 20160504(end)
        }
    ...
    public static final class Secure extends NameValueTable {
        ...
        static {
            ...
            MOVED_TO_GLOBAL.add(Settings.Global.ULTRA_POWER_MODE);
            MOVED_TO_GLOBAL.add(Settings.Global.POWERSAVE_ON);
            MOVED_TO_GLOBAL.add(Settings.Global.LOWER_SAVE_MODE);
            // A }
        }
    ...
    public static final class Global extends NameValueTable {
	   ...
	   public static final String EMERGENCY_ASSISTANT_STATE = "emergency_assistant_state";
	   public static final String EMERGENCY_ASSISTANT_INTERVAL = "emergency_assistant_interval";
       ...
       public static final String OVERLAY_DISPLAY_DEVICES = "overlay_display_devices";
        ...
        // A BUG:DWYLL-491 by zyn 20150525 {
        public static final String ULTRA_POWER_MODE = "ultra_power_mode";
        public static final String POWERSAVE_ON = "powersave_enabled";
        public static final String LOWER_SAVE_MODE = "lower_save_mode";
        // A }
      ...
      public static final String RNS_WIFI_ROVE_OUT_RSSI = "rns_wifi_rove_out_rssi";
        ...
        /**
         * For auto call record switch on or off
         *
         * @hide
         */
        public static final String TELEPHONY_AUTO_CALL_RECORD_CONFIG =
                "telephony_auto_call_record_config";

        /**
         * @hide
         */
        public static final String AUTO_CALL_RECORD_DEFAULT_STORAGE =
                "auto_call_record_default_storage";
		...
		public static final String  BLACK_GESTURE_WAKE= "black_gesture_wake";        
		public static final String  BLACK_GESTURE_WAKE_KEYEVENT= "black_gesture_wake_event";				
		  
		public static final String  BLACK_GESTURE_WAKE_C= "black_gesture_wake_c";		
		public static final String  BLACK_GESTURE_WAKE_E= "black_gesture_wake_e";		
		public static final String  BLACK_GESTURE_WAKE_M= "black_gesture_wake_m";		
		public static final String  BLACK_GESTURE_WAKE_O= "black_gesture_wake_o";		
		public static final String  BLACK_GESTURE_WAKE_W= "black_gesture_wake_w";		
		       
		public static final String  BLACK_GESTURE_WAKE_F= "black_gesture_wake_f";		
		public static final String  BLACK_GESTURE_WAKE_DPAD_UP= "black_gesture_wake_dpad_up";		
		public static final String  BLACK_GESTURE_WAKE_DPAD_DOWN= "black_gesture_wake_dpad_down";		
		public static final String  BLACK_GESTURE_WAKE_DPAD_LEFT= "black_gesture_wake_dpad_left";		
		public static final String  BLACK_GESTURE_WAKE_DPAD_RIGHT= "black_gesture_wake_dpad_right";		
