...
public class RecoverySystem {
    ...
    private static boolean isRecoverying = false; // add by kui.li ,2016-05-06, for factory reset enter into factory mode.
    ...
    public static void installPackage(Context context, File packageFile)
        throws IOException {
        //M: DELSLMY-1161 kuangyunfeng 20160325(start)
        //String filename = packageFile.getCanonicalPath();
        String filename = packageFile.getAbsolutePath();
        Log.w(TAG, "CanonicalPath = " + packageFile.getCanonicalPath() + ", AbsolutePath = " + filename);
        //M: DELSLMY-1161 kuangyunfeng 20160325(end)
        ...
        //D: DELSLMY-1161 kuangyunfeng 20160325(start)
        if (filename.startsWith("/data/")) {
            filename = "@/cache/recovery/block.map";
        }
        //D: DELSLMY-1161 kuangyunfeng 20160325(end)

        final String filenameArg = "--update_package=" + filename;
        final String localeArg = "--locale=" + Locale.getDefault().toString();
        Log.w(TAG, "filenameArg = " + filenameArg + ", localeArg = " + localeArg);
...
//        MoveFile(fhandle);
    ...
    private static void bootCommand(Context context, String... args) throws IOException {
        ...
        SystemProperties.set("persist.sys.freset","cmdwriting"); // add by kui.li ,2016-05-06, for factory reset enter into factory mode.

        WriteByFdSync(COMMAND_FILE, args);

        SystemProperties.set("persist.sys.freset","cmdwritedone");// add by kui.li ,2016-05-06, for factory reset enter into factory mode.
        isRecoverying = true; // add by kui.li ,2016-05-06, for factory reset enter into factory mode.
    ...
    public static String handleAftermath() {
        ...
        for (int i = 0; names != null && i < names.length; i++) {
            ...
            if(isRecoverying && "command".equals(names[i])) continue; // add by kui.li ,2016-05-06, for factory reset enter into factory mode.
