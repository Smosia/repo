		 ...
		 // A BUG:DWYLL-491 by zyn 20150525 {
    	  ...
    	  if (ultraPowerOn) {
    	      if (notification.extras == null) {
    	          Log.d("psm","NotificationManager in ultraPowerMode,the notification extras is null,so return"
    	          + "notification is: "+notification);
    	          return;
    	      }
              //M:DELSLMY-599 huangerhui 20160308 start{
    	     // ApplicationInfo applicationinfo = notification.extras.getParcelable("android.rebuild.applicationinfo");
              ApplicationInfo applicationinfo = notification.extras.getParcelable("android.rebuild.applicationInfo");
             //end}
    	      Log.d("psm","NotificationManager notify applicationinfo is: "+applicationinfo);
    	      if (applicationinfo == null) {
    	          return;
    	      }
    	      String pkgName = applicationinfo.packageName;
    	      boolean isWhiteApp = "com.android.dialer".equals(pkgName)
    	          || "com.android.mms".equals(pkgName)
    	          || "com.rlk.powersavemanagement".equals(pkgName)
    	          ||  "com.android.calculator2".equals(pkgName)
    	          ||  "com.android.deskclock".equals(pkgName)
    	          ||  "com.android.soundrecorder".equals(pkgName);
    	      if (!isWhiteApp) {
    	          return;
    	      }
    	  }
