...
public class Dialog implements DialogInterface, Window.Callback,
    ...
    public void show() {
        ...
        /// just modify the parameters as MATCH_PARENT  @{
        if (MultiWindowProxy.isSupported()) {
            if (MultiWindowProxy.getInstance().isFloating(l.token, l.type)) {
                Log.w(TAG, "[BMW] show-setLayout(MATCH_PARENT, WRAP_CONTENT) l.token = "
                        + l.token);
