...
public class StatusBarManager {
    ...
    /**
     * Show default status icon on StatusBar, there are two types:
     * 1. >=0 subId, stands for a sim card, draw an line under signal icon.
     * 2. <0 subId, stands for special case, such as ALWAYS_ASK, SMS_AUTO, or SMS_ASK_FIRST.
     *
     * @param subId SIM card's subId or <0 for special case.
     * @hide
     * @internal
     */
    ...
    /**
    * Hide default account icon from StatusBar.
    *
    * @hide
    * @internal
    */
    public void hideDefaultAccountStatus() {
        ...
        try {
            ...
            final IStatusBarService svc = getService();
            if (svc != null) {
                mService.hideDefaultAccountStatus();
            }
        } catch (RemoteException ex) {
