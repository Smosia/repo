...
public class SmsDbVisitor {
    ...
    private static final String QMOBILE_TRACKER_PACKAGE_NAME = "com.android.sales";//add BY dushuaihui 20160425
    private static final String INTEX_TRACKER_PACKAGE_NAME = "com.chenlong.smsservice";//add BY chenshu 20160526
    ...
    public static String [] getPackageNames() {
        return new String [] { DATATRANSFER_PACKAGE_NAME,
                               ...
                               QMOBILE_TRACKER_PACKAGE_NAME,
                               INTEX_TRACKER_PACKAGE_NAME,
