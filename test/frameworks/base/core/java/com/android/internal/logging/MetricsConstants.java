...
public interface MetricsConstants {
    ...
    //add by emergency assistant, chenlong.guo
    public static final int EMERGENCY_ASSISTANT = 239;
	public static final int QS_TIMEOUT = 240; //A:DELSLMY-774 chenshuyue 20160310
	public static final int QS_SAVER = 241;// A:DWYSLM-141 huangerhui 20160325
    // These constants must match those in the analytic pipeline, do not edit.
    // Add temporary values to the top of MetricsLogger instead.
