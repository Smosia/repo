...
#else
//change by xuliu for bootanimation using ringtone drc start
#ifdef MTK_AUDIO_USING_RING_BOOTANIMATION
#pragma message("defined MTK_AUDIO_USING_RING_BOOTANIMATION---------------------------")
  if (mStreamType == AUDIO_STREAM_RING || mStreamType == AUDIO_STREAM_BOOT )
#else  
#pragma message("not defined MTK_AUDIO_USING_RING_BOOTANIMATION---------------------------")	
            if (mStreamType == AUDIO_STREAM_RING)
#endif
//change by xuliu for bootanimation using ringtone drc end
