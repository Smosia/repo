...
public class ImsConfig {
    ...
    */
     ...
     * @return void.
     */
    public void setImsCapability(boolean volte, boolean vilte, boolean wfc) throws ImsException {
        try {
            miConfig.setImsCapability(volte, vilte, wfc);
        } catch (RemoteException e) {
            throw new ImsException("setImsCapability()", e,
                    ImsReasonInfo.CODE_LOCAL_SERVICE_UNAVAILABLE);
        }
    }
     ...
     * @return boolean
     */
    public boolean getImsCapability(int feature) throws ImsException {
        boolean capability = false;
        try {
            capability = miConfig.getImsCapability(feature);
        } catch (RemoteException e) {
            throw new ImsException("getImsCapability()", e,
                    ImsReasonInfo.CODE_LOCAL_SERVICE_UNAVAILABLE);
        }
        return capability;
    }
