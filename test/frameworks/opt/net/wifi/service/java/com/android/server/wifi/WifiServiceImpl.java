...
///M: MTK add parameter
        ...
        mContext.registerReceiver(
                new BroadcastReceiver() {
                    ...
                    public void onReceive(Context context, Intent intent) {
                        ...
                        Slog.i(TAG, "ACTION_AIRPLANE_MODE_CHANGED isAirplaneModeOn=" + isAirplaneModeOn);
    ...
    public boolean enableNetwork(int netId, boolean disableOthers) {
        Slog.d(TAG, "enableNetwork, pid:" + Binder.getCallingPid() + ", uid:" + Binder.getCallingUid()
    ...
    public boolean disableNetwork(int netId) {
        Slog.d(TAG, "disableNetwork, pid:" + Binder.getCallingPid() + ", uid:" + Binder.getCallingUid()
                + ", netId:" + netId);
        enforceChangePermission();
        if (mWifiStateMachineChannel != null) {
    ...
    public void startWifi() {
        ...
        if (mWifiStateMachine.shouldStartWifi()) {
            ...
            Slog.d(TAG, "Shouldn't start wifi!");
        }
        ///@}
    }
    ...
    public void acquireMulticastLock(IBinder binder, String tag) {
        Slog.d(TAG, "acquireMulticastLock, pid:" + Binder.getCallingPid()
                + ", uid:" + Binder.getCallingUid());
    ...
    public void factoryReset() {
        ...
        if (!mUserManager.hasUserRestriction(UserManager.DISALLOW_CONFIG_WIFI)) {
            ...
            mWifiStateMachine.factoryReset();
            /*
  ...
  private void autoConnectEnableAllNetworks() {
      ...
      Slog.d(TAG, "autoConnectEnableAllNetworks, isConnecting:" + isConnecting);
  ...
  public double getPoorLinkThreshold(boolean isGood) {
      enforceAccessPermission();
      Slog.d(TAG, "getPoorLinkThreshold, isGood:" + isGood);
  ...
  public boolean setPoorLinkThreshold(String key, double value) {
      enforceAccessPermission();
      Slog.d(TAG, "setPoorLinkThreshold, key:" + key + " value= " + value);
  ...
  public void setPoorLinkProfilingOn(boolean enable) {
      enforceAccessPermission();
      Slog.d(TAG, "setPoorLinkProfilingOn:" + enable);
