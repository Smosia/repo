...
public final class WifiP2pServiceImpl extends IWifiP2pManager.Stub {
    ...
    /*M: Used for received intive response with info unavailable */
    private static final int M_P2P_CONN_FOR_INVITE_RES_INFO_UNAVAILABLE  =   BASE + 22;
    ///@}
    ...
    private String getPersistedDeviceName() {
        ...
        if (deviceName == null) {
            ...
            //M:DELSLMY-535 xiangkezhu 20160304(start)
            if (mContext.getResources().getBoolean(R.bool.wifi_directs_rename)) {
                return SystemProperties.get("ro.product.model");
            } else {
                return "Android_" + id.substring(0,4);
            }
            //M:DELSLMY-535 xiangkezhu 20160304(end)
        }
        return deviceName;
    }
    ...
    private void handleGroupRemoved() {
        ...
        if (mGroup.isGroupOwner()) {
            logd("handleGroupRemoved, isGroupOwner = true");
