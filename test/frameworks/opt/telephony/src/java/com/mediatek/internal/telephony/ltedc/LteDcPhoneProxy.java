...
public class LteDcPhoneProxy extends PhoneProxy {
    ...
    protected SvlteSstProxy mSvlteSstProxy;
    ...
    public LteDcPhoneProxy(PhoneBase ltePhone, PhoneBase nltePhone,  int radioTechMode) {
        ...
        mSvlteSstProxy = new SvlteSstProxy(this);
    ...
    /**
     * Return the SvlteSstProxy.
     * @return SvlteSstProxy
     */
    public SvlteSstProxy getSvlteSstProxy() {
        return mSvlteSstProxy;
    }
