 ...
 */
    ...
    public int getUpdateSvlteSpnPhoneId(int sstType) {
        ...
        if (mCDMASS.getVoiceRegState() == ServiceState.STATE_POWER_OFF
            ...
            updateSvlteSpnPhoneId = mPhone.getPhoneId();
                ...
                && (mGSMSS.getVoiceRegState() == ServiceState.STATE_IN_SERVICE
                || mGSMSS.getDataRegState() == ServiceState.STATE_IN_SERVICE)) {
    ...
    /**
     * Get previous UpdateSvlteSpnPhoneId.
     *
     * @return the previous UpdateSvlteSpnPhoneId.
     */
    ...
    private void combineGsmCdmaServiceState() {
        ...
        if (mGSMSS.getDataRegState() == ServiceState.STATE_IN_SERVICE) {
            ...
            mCombinedSS.updateProprietaryDataRadioTechnology(mGSMSS
                    .getProprietaryDataRadioTechnology());
        } else {
            ...
            mCombinedSS.updateProprietaryDataRadioTechnology(mCDMASS
                    .getProprietaryDataRadioTechnology());
        }
