...
public class DataSubSelector {
    ...
    private static final String CUSTOM_PROPERTY_ICCID = "ril.iccid.sim";//add BUG_ID:DWYQLSSMY-84 dushuaihui(20160321)
    ...
    //moidfy BUG_ID: dushuaihui 20160321(start)
//    private void subSelectorForOm(Intent intent) {
//        //A:DWYQLSSMY-84 guoshuai 20160316(start)
//        int insertedSimCount = 0;
//        int insertedStatus = 0;
//        //A:DWYQLSSMY-84 guoshuai 20160316(end)
...
//        boolean setDefautMobileData = "true".equalsIgnoreCase(SystemProperties.get("ro.com.android.mobiledata", "false"));
//        //A:DELSLM-116 liuhuaizhi 20160203 (end)         
//        if (!CdmaFeatureOptionUtils.isCdmaLteDcSupport() && !setDefautMobileData) {
//            turnOffNewSimData(intent);
//        }
//
...
//                return;
//            }
//            //M:DWYQLSSMY-84 guoshuai 20160316(start)
...
//                break;
//            }*/
//            //M:DWYQLSSMY-84 guoshuai 20160316(end)
//            if (NO_SIM_VALUE.equals(currIccId[i])) {
//                log("clear mcc.mnc:" + i);
//                String propStr;
//                if (i == 0) {
...
//        //D:DWYQLSSMY-84 guoshuai 20160316(start)
//        /*if (phoneId != SubscriptionManager.INVALID_PHONE_INDEX) {
//            // always set capability to this phone
//            setCapability(phoneId);
//        }*/
//        //D:DWYQLSSMY-84 guoshuai 20160316(end)
...
//    }
    ...
    private void subSelectorForOm(Intent intent) {
        ...
        for (int i = 0; i < mPhoneNum; i++) {
            currIccId[i] = SystemProperties.get(CUSTOM_PROPERTY_ICCID + (i + 1));
            if (currIccId[i] == null || "".equals(currIccId[i])) {
                log("error: iccid not found, wait for next sub ready");
                return;
            }
    ...
    private void subSelectorForOp18(Intent intent) {
        ...
        switch(capability_switch_policy) {
            case POLICY_NO_AUTO:
                ...
                return;
            case POLICY_DEFAULT:
                // keep run default op18 policy
                break;
            case POLICY_POLICY1:
                // policy 1 of op18 is to follow OM.
                subSelectorForOm(intent);
                return;
            default:
    ...
    private boolean checkOp18CapSwitch() {
        ...
        if (capability_switch_policy != POLICY_DEFAULT) {
