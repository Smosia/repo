...
public final class MccTable {
    ...
    //add BUG_ID:DWYYLM-506 dushuaihui 20160106(start)
    ...
    //add BUG_ID:DWYYLM-506 dushuaihui 20160106(end)
    ...
    public static void updateMccMncConfiguration(Context context, String mccmnc,
        ...
        //add BUG_ID:DWYYLM-506 dushuaihui 20160106(start)
        boolean mChinaSimCardConfig = android.os.SystemProperties.getInt("ro.rgk_China_sim_config", 0) == 1;
		
        boolean updateLaguageBySim = SystemProperties.getInt("ro.rgk_update_language_by_sim", 0) == 1;

        if (updateLaguageBySim && !TextUtils.isEmpty(mccmnc) && !(!mChinaSimCardConfig && mccmnc.startsWith("460"))) {
        //add BUG_ID:DWYYLM-506 dushuaihui 20160106(end)
            int mcc, mnc;
...
//            }
    ...
    public static Locale getLocaleFromMcc(Context context, int mcc, String simLanguage) {
        ...
        if (!isDeviceProvisioned(context) && ((mcc == 460) || (!updateLaguageBySim))) {
            Slog.d(LOG_TAG, "Device is not Provisioned");
            return null;
        }
        //add BUG_ID:DWYYLM-506 dushuaihui 20160106(end)
