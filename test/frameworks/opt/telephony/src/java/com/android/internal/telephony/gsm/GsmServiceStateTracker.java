...
final class GsmServiceStateTracker extends ServiceStateTracker {
    ...
    public static final String[][] customEhplmn = {{"46000", "46002", "46007", "46008"},
                                       ...
                                       {"72432", "72433", "72434"},
                                       {"63601","0"},//DELSLMY-62 add by dushuaihui 20160303
    ...
    protected void updateSpnDisplay(boolean forceUpdate) {
       ...
       /*
        ...
        if (mSubId != subId ||
            ...
            //modify liuhuaizhi  20160315(start)
            log("zyw showSpn:" + showSpn +
                    " spn:" + spn +
                    " showPlmn:" + showPlmn +
                    " plmn:" + plmn +
                    " rule:" + rule );
            if(plmn != null){
                ...
                spn = null;
                rule = SIMRecords.SPN_RULE_SHOW_PLMN;
                log("zyw showSpn:" + showSpn + " showPlmn:" + showPlmn + " rule:" + rule);
            }else{
                showSpn = true;
                showPlmn = false;
                plmn = null;
			...
			//modify liuhuaizhi  20160315(end)
