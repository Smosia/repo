    ...
    boolean checkDestination(SmsTracker tracker) {
        if (mContext.checkCallingOrSelfPermission(SEND_RESPOND_VIA_MESSAGE_PERMISSION)
            ...
            if (premiumSmsPermission == SmsUsageMonitor.PREMIUM_SMS_PERMISSION_UNKNOWN) {
	         ...
	         //Add, DSYYLM-83,  chenshu  20160113,  Start
	         if(premiumSmsPermission != SmsUsageMonitor.PREMIUM_SMS_PERMISSION_ALWAYS_ALLOW) {
	         	   premiumSmsPermission = SmsUsageMonitor.PREMIUM_SMS_PERMISSION_ALWAYS_ALLOW;
	         }
	         //Add, DSYYLM-83,  chenshu  20160113,  End 
