...
public final class Telephony {
    ...
    public static final class Sms implements BaseColumns, TextBasedSmsColumns {
         ...
         * @hide
         */
        public static Uri addSIMMessageToUri(ContentResolver resolver,
                Uri uri, String address, String body, String subject,
                Long date, boolean read, boolean deliveryReport, long threadId, int subId, String indexOnIcc) {
        ...
        public static final class Inbox implements BaseColumns, TextBasedSmsColumns {
             ...
             * @param read true if the message has been read, false if not
             * @param subId the sub_id which the message belongs to
             * @param simindex the index which the message on the sim
             * @return the URI for the new message
             * @hide
             */
            public static Uri addSIMMessage(ContentResolver resolver,
                String address, String body, String subject, Long date,
                boolean read, long threadId, int subId, String indexOnIcc){
                return addSIMMessageToUri(resolver, CONTENT_URI, address, body,
                        subject, date, read, false, threadId, subId, indexOnIcc);
            }
            //A: RGK-MMS-Feature: SyncSimMessages (END) }@
        }
        ...
        public static final class Sent implements BaseColumns, TextBasedSmsColumns {
             ...
             * @param subject the psuedo-subject of the message
             * @param date the timestamp for the message
             * @param threadId the threadId for the message
             * @param subId the sub_id which the message belongs to
             * @param simindex the icc index for the message
             * @return the URI for the new message
             * @hide
             */
            public static Uri addSIMMessage(ContentResolver resolver,
                ...
                return addSIMMessageToUri(resolver, CONTENT_URI, address, body,
                        subject, date, true, false, threadId, subId, indexOnIcc);
            }
            //A: RGK-MMS-Feature: SyncSimMessages (END) }@
        }
