...
public class SmsMessage {
     ...
     * @hide
     */
    public static int[] calculateLength(CharSequence msgBody, boolean use7bitOnly, int encodingType, String encondingMode) {
        // this function is for MO SMS
        TextEncodingDetails ted = (useCdmaFormatForMoSms()) ?
            com.android.internal.telephony.cdma.SmsMessage.calculateLength(msgBody, use7bitOnly, encodingType) :
            com.android.internal.telephony.gsm.SmsMessage.calculateLength(msgBody, use7bitOnly, encondingMode);
        int ret[] = new int[4];
        ret[0] = ted.msgCount;
        ret[1] = ted.codeUnitCount;
        ret[2] = ted.codeUnitsRemaining;
