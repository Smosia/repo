...
//add JWBLB-293 (start)
    private static  boolean gesture_browse = false;
//add JWBLB-293 (end)
...
//add JWBLB-293 (start)
    public static boolean isGestureBrowseSupported(){
          return gesture_browse;
         }
    public static void setGestureBrowse(boolean support){
          gesture_browse = support;
        }
//add JWBLB-293 (end)
    static {
