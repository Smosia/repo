...
public class LocalAlbum extends MediaSet {
    ...
    public static String getLocalizedName(Resources res, int bucketId,
		...
		boolean needPhoneStorage = res.getBoolean(R.bool.phone_storage_album);
		...
		// add Bug_id:JLLBLS-270 liupeng 20150925  (start)
		else if(needPhoneStorage && !GalleryUtils.isHaveExternalSDCard() && "sdcard0".equals(name)) {
			return res.getString(R.string.phone_storage);
		} else if(needPhoneStorage && GalleryUtils.isHaveExternalSDCard() && "sdcard1".equals(name)){
			return res.getString(R.string.phone_storage);
		} else if(needPhoneStorage && GalleryUtils.isHaveExternalSDCard() && "sdcard0".equals(name)){
