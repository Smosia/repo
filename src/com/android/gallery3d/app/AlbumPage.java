...
/// @}
    ...
    private final GLView mRootPane = new GLView() {
        ...
        protected void onLayout(
            ...
            //add BUG_ID:EWLLL-751 gulincheng 20151105  (start)
        	Rect frame = new Rect();
        	mActivity.getWindow().getDecorView().getWindowVisibleDisplayFrame(frame);
        	

            int slotViewTop = mActivity.getGalleryActionBar().getHeight() + frame.top;
			//add BUG_ID:EWLLL-751 gulincheng 20151105  (end)
